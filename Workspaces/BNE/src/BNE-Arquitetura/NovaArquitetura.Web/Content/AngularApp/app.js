(function(){
    ...
    var app = angular.module('FacaCaveira', []);
    ...
    app.controller("CadastroEscola", ['$scope', '$http', function ($scope, $http, $location) {
        ...
        $scope.abrirCadastroDisciplina = function () {
            if (store.alunos_cadastrados.length > 0)
                store.cadastro_aluno_concluido = true;
        }

        $scope.voltarCadastroALuno = function () {
            store.cadastro_aluno_concluido = false;
        }

        $scope.abrirCadastroAlunoDisciplina = function () {
            if (store.disciplinas_cadastradas.length > 0)
                store.cadastro_disciplina_concluido = true;
        }

        $scope.voltarCadastroDisciplina = function () {
            store.cadastro_disciplina_concluido = false;
        }
