...
{
    public class CampanhasEmpresaController : Controller
    {
        private Model db = new Model();

        // GET: CampanhasEmpresa
        ...
        // GET: CampanhasEmpresa/Details/5
        public async Task<ActionResult> Details(decimal id)
        {
            ...
            reportViewer.ServerReport.ReportPath = "/TfsReports/BNE/CIA/Campanhas2";
        ...
        // POST: CampanhasEmpresa/Delete/5
