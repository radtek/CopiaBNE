...
namespace AdminLTE_Application.Controllers
{
    ...
    public class EmpresaController : Controller
    {
       ...
       [HttpPost]
        ...
        [HttpPost]
        public async Task<ActionResult> EnviarReserva(ReservaTecnicaDTO dto)
        {
            using (var context  = new Model())
            {
                var Num_CNPJ = new SqlParameter("@num_cnpj", dto.Num_CNPJ);
                var FlagReserva = new SqlParameter("@FlgReserva", !dto.Flg_Reserva_Tecnica);
                context.Database.ExecuteSqlCommand("update dbo.CRM_Empresa set  flg_reserva_tecnica = @FlgReserva where num_cnpj = @Num_CNPJ", FlagReserva, Num_CNPJ);
            }
            return Redirect("../Empresa/Details/" + dto.Num_CNPJ);
