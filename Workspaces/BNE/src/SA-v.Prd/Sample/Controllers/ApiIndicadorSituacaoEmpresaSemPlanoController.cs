...
{
    public class ApiIndicadorSituacaoEmpresaSemPlanoController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetVWEmpresas()
        {
            using (var context = new Model())
            {
                ...
                var result = context.Database
                    .SqlQuery<Indicadores>("dbo.getIndicadoresSituacaoEmpresaSemPlano")
                    .ToList();
        ...
        public async Task<IHttpActionResult> Indices(decimal id)
       {
           ...
           using (var context = new Model())
           {
               ...
               var result = context.Database
                   .SqlQuery<Indicadores>("dbo.getIndicadoresSituacaoEmpresaSemPlano @cpf", filial)
                   .ToList();
