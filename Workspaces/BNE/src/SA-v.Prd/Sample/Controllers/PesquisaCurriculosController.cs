...
{
    public class PesquisaCurriculosController : Controller
    {
        private Model db = new Model();

        // GET: PesquisaCurriculos
        ...
        // GET: PesquisaCurriculos/Details/5
        public async Task<ActionResult> Details(decimal id)
        {
            ...
            reportViewer.ServerReport.ReportPath = "/TfsReports/BNE/CIA/Pesquisas";
        ...
        // POST: PesquisaCurriculos/Create
        ...
        // POST: PesquisaCurriculos/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: PesquisaCurriculos/Delete/5
        ...
        // POST: PesquisaCurriculos/Delete/5
