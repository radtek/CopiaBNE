...
{
    public class SMSEmpresaController : Controller
    {
        ...
        public async Task<ActionResult> Details(decimal id)
        {
            ...
            reportViewer.ServerReport.ReportPath = "/TfsReports/BNE/CIA/SMS2";
