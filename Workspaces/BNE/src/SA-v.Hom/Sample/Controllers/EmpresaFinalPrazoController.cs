...
{
    [Authorize]
    public class EmpresaFinalPrazoController : Controller
    {
        private Model db = new Model();

        // GET: EmpresaFinalPrazo
        public async Task<ActionResult> Index()
        {
            ...
            {
                var cRM_Vendedor = db.CRM_Vendedor_Empresa.Where(c => c.Idf_Situacao_Atendimento == 6 
        ...
        // GET: EmpresaFinalPrazo/Details/5
        ...
        // GET: EmpresaFinalPrazo/Delete/5
        ...
        // POST: EmpresaFinalPrazo/Delete/5
