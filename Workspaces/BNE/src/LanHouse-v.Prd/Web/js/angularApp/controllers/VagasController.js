...
VagasController.controller('VagasController', ['$scope', '$http', '$location', '$route', '$rootScope', '$filter', '$analytics', function ($scope, $http, $location, $route, $rootScope, $filter, $analytics) {
    ...
    $scope.MaisDadosVaga = function (element) {
        ...
        //Track para visualizacao de vaga
        $analytics.pageTrack('/VisualizarVagaModal');
    ...
    $scope.AtualizarListaVagas = function () {
        ...
        //Registro do Evento da busca no analytics
        $analytics.eventTrack('Busca de Vaga', { category: 'Vaga', label: filtro });
