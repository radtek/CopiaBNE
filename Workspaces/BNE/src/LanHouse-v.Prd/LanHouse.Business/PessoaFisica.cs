    ...
    public class PessoaFisica
    {
        ...
        public static int ValidarCPFeDataNascimento(decimal cpf, DateTime dataNascimento, out TAB_Pessoa_Fisica objPessoaFisica)
        {
            ...
            using (var entity = new LanEntities())
            {
                ...
                objPessoaFisica = entity.TAB_Pessoa_Fisica.Include("TAB_Endereco.TAB_Cidade").FirstOrDefault(p => p.Num_CPF == cpf);

               
                if (objPessoaFisica != null)
                {
                    objPessoaFisica = entity.TAB_Pessoa_Fisica.Include("TAB_Endereco.TAB_Cidade").FirstOrDefault(p => p.Num_CPF == cpf && p.Dta_Nascimento == dataNascimento);
                    if (objPessoaFisica != null)
                    {
