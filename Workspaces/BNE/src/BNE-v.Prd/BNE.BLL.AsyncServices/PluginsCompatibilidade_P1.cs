...
namespace BNE.BLL.AsyncServices
{
    public partial class PluginsCompatibilidade // Tabela: TAB_Plugins_Compatibilidade
    {
        ...
        {
            get { return this._idPluginsCompatibilidade; }
        }
        #endregion
        ...
        {
            get { return this._pluginEntrada; }
            set
            {
        ...
        {
            get { return this._tipoAtividade; }
            set
            {
        ...
        #region Consultas
        private const string SPINSERT = "INSERT INTO TAB_Plugins_Compatibilidade (Idf_Plugin_Entrada, Idf_Plugin_Saida, Idf_Tipo_Atividade, Flg_Inativo, Dta_Cadastro) VALUES (@Idf_Plugin_Entrada, @Idf_Plugin_Saida, @Idf_Tipo_Atividade, @Flg_Inativo, @Dta_Cadastro);SET @Idf_Plugins_Compatibilidade = SCOPE_IDENTITY();";
        private const string SPUPDATE = "UPDATE TAB_Plugins_Compatibilidade SET Idf_Plugin_Entrada = @Idf_Plugin_Entrada, Idf_Plugin_Saida = @Idf_Plugin_Saida, Idf_Tipo_Atividade = @Idf_Tipo_Atividade, Flg_Inativo = @Flg_Inativo, Dta_Cadastro = @Dta_Cadastro WHERE Idf_Plugins_Compatibilidade = @Idf_Plugins_Compatibilidade";
        private const string SPDELETE = "DELETE FROM TAB_Plugins_Compatibilidade WHERE Idf_Plugins_Compatibilidade = @Idf_Plugins_Compatibilidade";
        private const string SPSELECTID = "SELECT * FROM TAB_Plugins_Compatibilidade WHERE Idf_Plugins_Compatibilidade = @Idf_Plugins_Compatibilidade";
        #endregion
        ...
        {
            List<SqlParameter> parms = new List<SqlParameter>();
            string query = "delete from TAB_Plugins_Compatibilidade where Idf_Plugins_Compatibilidade in (";
        ...
        public static IDataReader LoadDataReader(string colunaOrdenacao, string direcaoOrdenacao, int paginaCorrente, int tamanhoPagina, out int totalRegistros)
        {
            ...
            string SPSELECTPAG = "SELECT ROW_NUMBER() OVER (ORDER BY " + colunaOrdenacao + " " + direcaoOrdenacao + ") AS RowID, Plu.Idf_Plugins_Compatibilidade, Plu.Idf_Plugin_Entrada, Plu.Idf_Plugin_Saida, Plu.Flg_Inativo, Plu.Dta_Cadastro FROM TAB_Plugins_Compatibilidade Plu";
        ...
        private static bool SetInstance(IDataReader dr, PluginsCompatibilidade objPluginsCompatibilidade)
        {
            try
            {
                if (dr.Read())
                {
                    ...
                    objPluginsCompatibilidade._tipoAtividade = new TipoAtividade(Convert.ToInt32(dr["Idf_Tipo_Atividade"]));
