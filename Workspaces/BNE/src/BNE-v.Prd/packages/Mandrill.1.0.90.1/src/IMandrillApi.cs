...
namespace Mandrill
{
  public interface IMandrillApi
  {
    ...
    Task<List<EmailResult>> SendMessageTemplate(SendMessageTemplateRequest request);
      ...
      ///   The request.
      /// </param>
      /// <param name="withHttpWebRequest">Is to send with httpwebrequest intead of httpclient</param>
      /// <returns>
      ///   The <see cref="Task" />.
      /// </returns>
      Task<List<EmailResult>> SendMessage(SendMessageRequest request, bool withHttpWebRequest = false);
