...
Employer.Componentes.UI.Web.ControlCNPJ = function (element) {
    Employer.Componentes.UI.Web.ControlCNPJ.initializeBase(this, [element]);
    ...
    this.find_Validador = function () {
     ...
     this.initialize = function () {
         Employer.Componentes.UI.Web.ControlCNPJ.callBaseMethod(this, 'initialize');
    ...
    this.dispose = function () {
        ...
        Employer.Componentes.UI.Web.ControlCNPJ.callBaseMethod(this, 'dispose');
    },
...
//Simula herança
Employer.Componentes.UI.Web.ControlCNPJ.prototype = new Employer.Componentes.UI.Web.ControlBaseValidator;

Employer.Componentes.UI.Web.ControlCNPJ.prototype.Focus = function (ev) {
    ev.preventDefault();
    ev.stopPropagation();
...
Employer.Componentes.UI.Web.ControlCNPJ.prototype.Blur = function (ev) {
    ev.preventDefault();
    ev.stopPropagation();
...
Employer.Componentes.UI.Web.ControlCNPJ.prototype.KeyPress = function (e) {
...
Employer.Componentes.UI.Web.ControlCNPJ.registerClass('Employer.Componentes.UI.Web.ControlCNPJ', Sys.UI.Behavior);

/*if (typeof (Sys) !== 'undefined') Sys.Application.notifyScriptLoaded();*/

Employer.Componentes.UI.Web.ControlCNPJ.prototype.Validar = function (arg) {    
...
Employer.Componentes.UI.Web.ControlCNPJ.prototype.MostrarErros = function () {
...
Employer.Componentes.UI.Web.ControlCNPJ.ValidarTextBox = function (sender, args) {
    var espGrid = RegExp("(_[0-9]+)$");
