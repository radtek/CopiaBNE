...
//Insere o texto na posição do cursor em um div editavel
//Função util para manipular no keypress
AjaxClientControlBase.InsertTextAtCursorDiv = function (text) {
...
AjaxClientControlBase.offsetToRangeCharacterMove = function (el, offset) {
    return offset - (el.value.slice(0, offset).split("\r\n").length - 1);
}

//Seta a posição do cursor em um campo input e textarea
//Função util para manipular no keypress
AjaxClientControlBase.SetInputSelection = function(el, startOffset, endOffset) {
    el.focus();
    if (typeof el.selectionStart == "number" && typeof el.selectionEnd == "number") {
        ...
        var startCharMove = AjaxClientControlBase.offsetToRangeCharacterMove(el, startOffset);
        range.collapse(true);
        if (startOffset == endOffset) {
            range.move("character", startCharMove);
        } else {
            range.moveEnd("character", AjaxClientControlBase.offsetToRangeCharacterMove(el, endOffset));
...
//Pega a posição do cursor em um campo input e textarea
//Função util para manipular no keypress
AjaxClientControlBase.GetInputSelection = function(el) {
...
AjaxClientControlBase.DetectBrowser = function () {
    _browser = {};
...
AjaxClientControlBase.Mascara = function (e, id) {
}