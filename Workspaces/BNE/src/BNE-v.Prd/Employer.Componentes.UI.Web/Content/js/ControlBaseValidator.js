...
Employer.Componentes.UI.Web.ControlBaseValidator = function () {
...
Employer.Componentes.UI.Web.ControlBaseValidator.prototype = {
    ...
    has_selected_text: function (element) {
        ...
        if (document.selection) {
            ...
            if (startPos == endPos) { value = false; }
        }
        return value;
    },
