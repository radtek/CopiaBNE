...
SWFUpload.completeURL = function (a) {
    if (typeof (a) !== "string" || a.match(/^https?:\/\//i) || a.match(/^\//)) { return a } var c = window.location.protocol + "//" + window.location.hostname + (window.location.port ? ":" + window.location.port : "");
...
//        this.settings.flash_url = this.settings.flash_url + ".swf";
//    }
...
SWFUpload.prototype.getFlashHTML = function () {
    //changed by  darlan
    var navegador = AjaxClientControlBase.DetectBrowser();
    if (navegador.msie && navegador.version < 11) {        
        return ['<object id="', this.movieName, '" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" data="', this.settings.flash_url, '" width="', this.settings.button_width, '" height="', this.settings.button_height, '" class="swfupload">', '<param name="wmode" value="', this.settings.button_window_mode, '" />', '<param name="movie" value="', this.settings.flash_url, '" />', '<param name="quality" value="high" />', '<param name="menu" value="false" />', '<param name="allowScriptAccess" value="always" />', '<param name="flashvars" value="' + this.getFlashVars() + '" />', "</object>"].join("")
    }
    else
	...
	var methods = {
		...
		init : function(options, swfUploadOptions) {
			...
			return this.each(function() {
				...
				if (flashInstalled) {
                    ...
                    //change by darlan
                    var swf = $('#' + swfuploadify.movieName);

                    var navegador = AjaxClientControlBase.DetectBrowser();
                    if (navegador.msie){
                        var htmlSwf = swf[0];
                        if (htmlSwf.getElementsByTagName == null)
                            htmlSwf.getElementsByTagName = undefined;
                        if (htmlSwf.querySelectorAll == null)
                            htmlSwf.querySelectorAll = undefined;
                    }
		...
		destroy : function() {
			...
			this.each(function() {
                ...
                if (swfuploadify == null || swfuploadify == undefined)
                    return;
	...
	var handlers = {
		...
		onDialogClose :  function(filesSelected, filesQueued, queueLength) {
			...
			if ($.inArray('onDialogClose', settings.overrideEvents) < 0) {
                ...
                this.queueData.errorMsg != null && this.queueData.errorMsg != "") {
