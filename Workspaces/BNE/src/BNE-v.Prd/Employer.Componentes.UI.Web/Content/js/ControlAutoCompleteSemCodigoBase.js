...
Employer.Componentes.UI.Web.ControlAutoCompleteSemCodigoBase = function (element) {
    Employer.Componentes.UI.Web.ControlAutoCompleteSemCodigoBase.initializeBase(this, [element]);
    ...
    this.initialize = function () {
        Employer.Componentes.UI.Web.ControlAutoCompleteSemCodigoBase.callBaseMethod(this, 'initialize');
     ...
     this.dispose = function () {
         ...
         Employer.Componentes.UI.Web.ControlAutoCompleteSemCodigoBase.callBaseMethod(this, 'dispose');
     }
...
//Simula herança
Employer.Componentes.UI.Web.ControlAutoCompleteSemCodigoBase.prototype = new Employer.Componentes.UI.Web.ControlBaseValidator;

Employer.Componentes.UI.Web.ControlAutoCompleteSemCodigoBase.prototype.get_AutoComplete = function () {
    return this.get_Controle("_AutoComplete");
}

Employer.Componentes.UI.Web.ControlAutoCompleteSemCodigoBase.prototype.Focus = function (ev) {
    ev.preventDefault();
    ev.stopPropagation();
...
Employer.Componentes.UI.Web.ControlAutoCompleteSemCodigoBase.prototype.Validar = function (arg) {
    arg.IsValid = true;
    ...
    if (AjaxClientControlBase.IsNullOrEmpty(this.get_CustomClientValidate())) {
        ...
        if (this.get_Obrigatorio() == true && this.get_TextBox().value == "") {
            ...
            if (this.get_ValidarTextChanging() == false && !AjaxClientControlBase.IsNullOrEmpty(this.get_TextBox().value)) {
                arg.IsValid = false;
...
Employer.Componentes.UI.Web.ControlAutoCompleteSemCodigoBase.prototype.MostrarErros = function () {
    IsValid = true;
...
Employer.Componentes.UI.Web.ControlAutoCompleteSemCodigoBase.prototype.SetFocus = function () {
...
Employer.Componentes.UI.Web.ControlAutoCompleteSemCodigoBase.prototype.Post = function (forcaPost) {
    if (forcaPost || !AjaxClientControlBase.EqualsIsNullOrEmpty(this.get_TextBox().value, this.get_TextoAntesFocus())) {
        //if (this.get_TextBox().value != this.get_TextoAntesFocus()) {
...
Employer.Componentes.UI.Web.ControlAutoCompleteSemCodigoBase.prototype.Carregar = function (valor) {
...
Employer.Componentes.UI.Web.ControlAutoCompleteSemCodigoBase.prototype.Blur2 = function () {
...
Employer.Componentes.UI.Web.ControlAutoCompleteSemCodigoBase.prototype.Blur = function (ev) {
    ev.preventDefault();
    ev.stopPropagation();
    ...
    !AjaxClientControlBase.EqualsIsNullOrEmpty(this.get_TextBox().value, this.get_TextoAntesFocus())) {
        ...
        function (result, eventArgs) { //OnSucceeded
            if (!AjaxClientControlBase.IsNullOrEmpty(result)) {
                ...
                controle._TextoAntesFocus = result;
                controle.set_TextBox(result);
...
Employer.Componentes.UI.Web.ControlAutoCompleteSemCodigoBase.prototype.KeyUP = function () {
...
Employer.Componentes.UI.Web.ControlAutoCompleteSemCodigoBase.prototype.KeyPress = function (e) {
...
Employer.Componentes.UI.Web.ControlAutoCompleteSemCodigoBase.ValidarTextBox = function (sender, args) {
...
Employer.Componentes.UI.Web.ControlAutoCompleteSemCodigoBase.descriptor = {
    properties: [
...
Employer.Componentes.UI.Web.ControlAutoCompleteSemCodigoBase.registerClass('Employer.Componentes.UI.Web.ControlAutoCompleteSemCodigoBase', Sys.UI.Behavior);
