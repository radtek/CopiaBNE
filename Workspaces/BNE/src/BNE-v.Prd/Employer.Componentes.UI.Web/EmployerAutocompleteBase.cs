...
{
    /// <summary>
    /// Componente base para usar autocomplete sem código e modal de busca.
    /// <note type="note">
    /// A diferença entre EmployerAutoCompleteBase e LocalizarBase é que o componente EmployerAutoCompleteBase não possui código.
    /// </note>
    /// </summary>
    public abstract class EmployerAutoCompleteBase : CompositeControl, IRequiredField, IMensagemErro // AjaxClientControlBase
    {
        #region Eventos
        /// <summary>
        ...
        #region Atritudos
        ControlAutoCompleteSemCodigoBase _AutoComplete = new ControlAutoCompleteSemCodigoBase { ID = "AutoComplete" };
        ...
        /// </summary>
        public ControlAutoCompleteSemCodigoBase AutoComplete
        {
            get 
            {
                EnsureChildControls();
        ...
        #region Construtor
        /// <inheritdoc/>
        public EmployerAutoCompleteBase()
        {
        ...
        void _ModalBusca_AtualizaLinhasGrid(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    c.Attributes["onclick"] = string.Format("javascript:$find('{0}').Carregar('{1}')",
