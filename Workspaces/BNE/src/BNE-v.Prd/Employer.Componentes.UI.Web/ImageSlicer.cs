...
using Employer.Componentes.UI.Web.EL;
...
namespace Employer.Componentes.UI.Web
{
    ...
    public class ImageSlicer : WebControl, IScriptControl
    {
        ...
        public string ImageUrl
        {
            ...
            set
            {
                ...
                if (!String.IsNullOrEmpty(value))
                {
                    ...
                    if (!Convert.ToString(this.ViewState["ImageUrl"])
                        .Equals(value, StringComparison.OrdinalIgnoreCase))
                    {
                        ...
                        {
                            // Limpar a ImageUrl
                            this.ViewState["ImageUrl"] = String.Empty;
                            throw;
                        }
                    }
                }
        ...
        {
            set { this.ViewState["ThumbUrl"] = value; }
            get { return Convert.ToString(this.ViewState["ThumbUrl"]); }
        }
        #endregion
        ...
        public String ThumbDir
        {
            get
            {
                String td = Convert.ToString(this.ViewState["ThumbDir"]);
                if (String.IsNullOrEmpty(td))
                    return "~/thumbs/";
                return td;
            }
            set { this.ViewState["ThumbDir"] = value; }
        }
        #endregion
        ...
        public int MaxWidth
        {
            get
            {
                if (this.ViewState["MaxWidth"] == null)
                    return 150;
                return Convert.ToInt32(this.ViewState["MaxWidth"]);
            }
            set { this.ViewState["MaxWidth"] = value; }
        }
        #endregion
        ...
        public int MaxHeight
        {
            get
            {
                if (this.ViewState["MaxHeight"] == null)
                    return 200;

                return Convert.ToInt32(this.ViewState["MaxHeight"]);
            }
            set { this.ViewState["MaxHeight"] = value; }
        }
        #endregion
        ...
        {
            get { return Convert.ToString(this.ViewState["AspectRatio"]); }
        ...
        private string InvalidAspectRatioMessage
        {
            ...
            get
            {
                if (String.IsNullOrEmpty(Convert.ToString(this.ViewState["InvalidAspectRatio"])))
                    return Resources.ImageSlicerInvalidAspectRatio;
                return Convert.ToString(this.ViewState["InvalidAspectRatio"]);
            }
            set
            {
                this.ViewState["InvalidAspectRatio"] = value;
            }
        }
        #endregion
        ...
        public string InvalidInitialSelectionMessage
        {
            get
            {
                if (String.IsNullOrEmpty(Convert.ToString(this.ViewState["InvalidInitialSelection"])))
                    return Resources.ImageSlicerInvalidInitialSelection;
                return Convert.ToString(this.ViewState["InvalidInitialSelection"]);
            }
            set
            {
                this.ViewState["InvalidInitialSelection"] = value;
            }
        }
        #endregion
        ...
        public string InvalidImageMinimumSizeMessage
        {
            get
            {
                if (String.IsNullOrEmpty(Convert.ToString(this.ViewState["InvalidMinimumImageSizeMessage"])))
                    return Resources.InvalidMinSizeImage;
                return Convert.ToString(this.ViewState["InvalidMinimumImageSizeMessage"]);
            }
            set
            {
                this.ViewState["InvalidMinimumImageSizeMessage"] = value;
            }
        ...
        protected Unit ImageWidth
        {
            get
            {
                if (this.ViewState["ImageWidth"] == null)
                    ...
                    return (Unit)this.ViewState["ImageWidth"];
            }
            set
            {
        ...
        protected Unit ImageHeight
        {
            get
            {
                if (this.ViewState["ImageHeight"] == null)
                    ...
                    return (Unit)this.ViewState["ImageHeight"];
            }
            set
            {
        ...
        public Unit MinAcceptedWidth
        {
            get
            {
                if (this.ViewState["MinAcceptedWidth"] == null)
                    return Unit.Empty;
                return (Unit)this.ViewState["MinAcceptedWidth"];

            }
            set
            {
                this.ViewState["MinAcceptedWidth"] = value;
            }
        }
        #endregion
        ...
        public Unit MinAcceptedHeight
        {
            get
            {
                if (this.ViewState["MinAcceptedHeight"] == null)
                    return Unit.Empty;
                return (Unit)this.ViewState["MinAcceptedHeight"];
            }
            set
            {
                this.ViewState["MinAcceptedHeight"] = value;
            }
        }
        #endregion
        ...
        public IEnumerable<ScriptReference> GetScriptReferences()
        {
            ...
            reference.Name = "Employer.Componentes.UI.Web.Content.js.ImgResizer.js";
        ...
        public String CreateThumbnail(int x1, int x2, int y1, int y2, int w, int h, String imgUrl)
        {
            ...
            try
            {
                ...
                {
                    double iW = this.ImageWidth.Value;
                    double iH = this.ImageHeight.Value;
                    double ratio = 1;
                    ...
                    if (iW > this.ImageWidth.Value)
                        iW = this.ImageWidth.Value;
                    if (iH > this.Height.Value)
                        iH = this.Height.Value;
                ...
                String nm = string.Format("Thumb{0}_{1}.png", 
