...
{
    /// <summary>
    /// Delegate usado para passar erros para aplicação.
    /// </summary>
    /// <param name="ex"></param>
    public delegate void DelegateError(Exception ex);

    /// <summary>
    /// Componente para relizar upload de fotos. Possui uma modal que redimencional e recorta a foto.
    /// </summary>
    ...
    public class SelecionarFoto : CompositeControl
    {
        ...
        private class ModalFoto : ControlModal
        {
            ...
            public event EventHandler TrocouFoto;
            #endregion 
            ...
            protected override void OnLoad(EventArgs e)
            {
                ...
                base.OnLoad(e);
                this._btnConfirmar.OnClientClick = "btnConfirmar_OnClientClick('" + this._imgSlicer.ClientID + "'); return false;";
            ...
            {                
                ...
                ScriptManager.RegisterClientScriptResource(this, typeof(SelecionarFoto),
                    "Employer.Componentes.UI.Web.Content.js.SelecionarFoto.js");
            }
            #endregion 
            ...
            private void _imgSlicer_ThumbnailCreated(object sender, ThumbnailCreatedArgs e)
            {
                try
                {
                    ...
                    using(var fs = File.Open(caminhoArquivo, FileMode.Open))
                    {
        ...
        private HtmlGenericControl _pnlFotoLogo = new HtmlGenericControl("div") { ID = "pnlFotoLogo" };
        ...
        private LinkButton _lbtRemoverFoto = new LinkButton() { ID = "lbtRemoverFoto", Text = "Remover", CausesValidation = false };
        ...
        #region Event Handlers
        /// <summary>
        /// Evento para informar erros ocorridos para aplicação.
        /// </summary>
        public event DelegateError Error;

        /// <summary>
        /// Evento dispara quando o usuário trocou a foto
        /// </summary>
        public event EventHandler TrocouFoto
        {
            add { _mdlFoto.TrocouFoto += value; }
            remove { _mdlFoto.TrocouFoto -= value; }
        }
        #endregion 
        ...
        /// <summary>
        /// Classe css do painel da imagem da foto.
        /// </summary>
        ...
        /// <summary>
        /// TagName no painel da foto
        /// </summary>
        public string TagFotoLogo
        {
            get { EnsureChildControls(); return _pnlFotoLogo.TagName; }
            set { EnsureChildControls(); _pnlFotoLogo.TagName = value; }
        }

        #region PainelFileUploadCssClass
        /// <summary>
        /// Classe css do painel de upload da foto.
        /// </summary>
        ...
        /// <summary>
        /// Imagem usada quando não tem foto definida.
        /// </summary>
        ...
        #region PainelBotoesModalFotoCssClass
        /// <summary>
        /// Classe css da painel de botões
        /// </summary>
        public String PainelBotoesModalFotoCssClass
        {
        ...
        /// <summary>
        /// Classe css do painel no link para remover a foto.
        /// </summary>
        ...
        public Boolean PermitirAlterarFoto
        {
            ...
            set
            {
                this._fupFotoLogo.Enabled = value;
            }
        ...
        #region NomeArquivoCliente
        public string NomeArquivoCliente
        {
            get { EnsureChildControls(); return ViewState["NomeArquivoCliente"] as string; }
            set { EnsureChildControls(); ViewState["NomeArquivoCliente"]  = value; }
        }
        #endregion
        ...
        protected override void CreateChildControls()
        {
            ...
            _pnlRemoverImagem.Controls.Add(_lbtRemoverFoto);
        ...
        void _btnEnviarFoto_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (_fupFotoLogo.HasFile)
                {
                    ...
                    NomeArquivoCliente = _fupFotoLogo.FileName;
                    ...
                    string caminhoNomeArquivo = string.Format("{0}{1}_{2}{3}",
                        this.ThumbDir,
                        this.Page.Session.SessionID ,
                        Guid.NewGuid(),
                        extensao);
                    ...
                    {
                        porcentagem = (370 * 100) / _imgOriginalWidth;
                    ...
                    {
                        porcentagem = (300 * 100) / _imgOriginalHeight;
        ...
        {
            this._lbtRemoverFoto.Click += new EventHandler(_lbtRemoverFoto_Click);
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            this._fupFotoLogo.Attributes.Add("OnChange",
                string.Format("window.setTimeout(function() {1} $get('{0}').click() {2}, 500);", _btnEnviarFoto.ClientID, "{", "}"));            
        }
        #endregion 
        ...
        {
            if (this.DesignMode)
                writer.Write("Componente SelecionarFoto");
            else
                base.Render(writer);
        }
        #endregion
        ...
        #region _lbtRemoverFoto_Click
        void _lbtRemoverFoto_Click(object sender, EventArgs e)
        {
            this.LimparFoto();
        }
        #endregion
