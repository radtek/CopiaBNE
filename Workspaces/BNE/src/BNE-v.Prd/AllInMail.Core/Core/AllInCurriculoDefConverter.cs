...
namespace AllInMail.Core
{
    ...
    public class AllInCurriculoDefConverter : AllInDefConverterStd<AllInCurriculoTemplateModel>
    {
        ...
        private readonly string paramDefinied = "id_cadastro;Tipo_Curriculo;cpf;nome;dt_nascimento;dt_cadastro;dt_atualizacao;Dt_Modificacao;Flag_Vip;Dt_Fim_Vip;nm_email;cidade;uf;sexo;Experiencia_Dta_Demissao;Qtd_Qm_Me_Viu";
