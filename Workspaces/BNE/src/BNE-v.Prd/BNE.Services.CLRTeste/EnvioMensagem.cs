...
public partial class StoredProcedures
{
    ...
    public static void EnvioEmailMailingNovo(SqlInt32 idMensagem, SqlString de, SqlString para, SqlString assunto, [SqlFacet(MaxSize = -1)] SqlString mensagem, SqlString tags)
    {
