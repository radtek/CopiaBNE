...
{
    /// <summary>
    /// Classe base para trabalhar com a biblioteca de Client Script do ScriptManager.
    /// Ele registra também uma biblioteca javascript base.
    /// </summary>
    public abstract class AjaxClientControlBase : CompositeControl , IScriptControl
    {
        ...
        protected virtual void SetScriptReferences(IList<ScriptReference> references)
        {
            ...
            reference.Name = "BNE.Componentes.Content.js.AjaxClientControlBase.js";
