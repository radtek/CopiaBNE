...
namespace BNE.Componentes.Validadores
{
    public class CheckBoxListValidator : BaseValidator
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if (this.RenderUplevel 
                && this.Page != null 
                && !this.Page.ClientScript.IsClientScriptIncludeRegistered("skmValidators"))
            {
                var script = this.Page.ClientScript.GetWebResourceUrl(typeof(BNE.Componentes.Validadores.CheckBoxListValidator), "BNE.Componentes.Content.js.skmValidators.js");
                this.Page.ClientScript.RegisterClientScriptInclude("skmValidators", script);
                //ScriptManager.RegisterStartupScript(this, typeof(BNE.Componentes.Validadores.CheckBoxListValidator), "skmValidators", script, true);
            }
