...
namespace BNE.BLL.DAL
{
    ...
    public class DataAccessLayer
    {
        ...
        /// <param name="data">Objeto de classe. A classe tem que ter os métodos GetParameters e  SetParameters</param>
        public static void AddBulkTable(ref DataTable tbMsg, object data)
        {
            var parms = (List<SqlParameter>)
                data.GetType().GetMethod("GetParameters", BindingFlags.NonPublic | BindingFlags.Instance).
                    Invoke(data, null);
            data.GetType().GetMethod("SetParameters", BindingFlags.NonPublic | BindingFlags.Instance).
                Invoke(data, new object[] {parms});
        ...
        /// <param name="tran">Transação</param>
