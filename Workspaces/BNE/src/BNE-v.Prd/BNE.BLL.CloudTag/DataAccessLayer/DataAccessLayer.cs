...
namespace BNE.BLL.CloudTag
{
    public class DataAccessLayer : Employer.BNE.DAL.DataAccessLayer
    {
        ...
        public static string CONN_STRING
        {
            get
            {
                return ConfigurationManager.ConnectionStrings["CONN_CLOUDTAG"].ToString();
            }
        }
        #endregion

        static readonly ConfigAccessLayer _dal = new ConfigAccessLayer();
        ...
        /// </summary>
        /// <param name="dt"></param>
        /// <param name="obj">Objeto de classe. A classe tem que ter os métodos GetParameters e  SetParameters</param>
