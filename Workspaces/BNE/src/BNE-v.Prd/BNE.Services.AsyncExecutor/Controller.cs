...
namespace BNE.Services.AsyncExecutor
{
    ...
    public static class Controller
    {
        ...
        /// </summary>
        public static PluginFactory<IInputPlugin> InputPlugins { get; private set; }
        #endregion
        ...
        /// </summary>
        public static PluginFactory<IOutputPlugin> OutputPlugins { get; private set; }
        #endregion
        ...
        /// </summary>
        public static CoreCapabilities Capabilities { get; private set; }
        #endregion
        ...
        public static void StartController()
        {
            try
            {
                ...
                foreach (var q in ColListener)
                {
                    q.Dispose();
                }
                ColListener.Clear();

                var objRelacaoTipoAtividade = BLL.AsyncServices.TipoAtividade.ListarTiposAtividade();

                foreach (var rel in objRelacaoTipoAtividade)
                {
                    ReiniciarFila(rel.TipoAtividade);
                    var objListener = StartListener(rel.TipoAtividade);
        ...
        public static TaskWorker StartTask(QueueListener objListener, MensagemAtividade objMensagem, TipoAtividade tipoAtividade)
        {
            try
            {
                return new TaskWorker(objListener, ProcessoAssincrono.RecuperarAtividade(objMensagem.IdfAtividade));
            }
            catch (Exception ex)
            {
        ...
        public static QueueListener StartListener(TipoAtividade tipoAtividade)
        {
            return new QueueListener(tipoAtividade);
        }
        #endregion
        ...
        public static void CleanFiles()
        {
            try
            {
                var dtArquivos = Atividade.RecuperarArquivosAExcluir();
        ...
        public static void ReiniciarFila(TipoAtividade tipoAtividade)
        {
            try
            {
                var itens = Atividade.RecuperarAtividadesParadas(tipoAtividade);
                ...
                Atividade.ReiniciarAtividades(tipoAtividade);
            }
            catch (Exception ex)
            {
                Capabilities.LogError(ex, "Tipo Atividade: " + tipoAtividade);
            }
        }
        #endregion
