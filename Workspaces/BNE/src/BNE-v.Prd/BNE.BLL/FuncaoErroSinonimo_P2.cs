...
namespace BNE.BLL
{
    public partial class FuncaoErroSinonimo // Tabela: BNE_Funcao_Erro_Sinonimo
    {
        ...
        public static bool CarregarPorDescricao(string descricaoFuncao, out FuncaoErroSinonimo objFuncaoErroSinonimo, SqlTransaction trans = null)
        {
            ...
            using (IDataReader dr = DataAccessLayer.ExecuteReader(trans, CommandType.Text, SPSELECTDESCRICAO, parms))
            {
