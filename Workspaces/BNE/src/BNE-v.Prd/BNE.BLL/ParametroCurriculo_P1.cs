...
namespace BNE.BLL
{
    public partial class ParametroCurriculo // Tabela: TAB_Parametro_Curriculo
    {
        ...
        #region Consultas
        private const string SPINSERT = "INSERT INTO TAB_Parametro_Curriculo (Idf_Parametro, Idf_Curriculo, Dta_Cadastro, Vlr_Parametro, Flg_Inativo, Dta_Alteracao) VALUES (@Idf_Parametro, @Idf_Curriculo, @Dta_Cadastro, @Vlr_Parametro, @Flg_Inativo, @Dta_Alteracao);";
        private const string SPUPDATE = "UPDATE TAB_Parametro_Curriculo SET Dta_Cadastro = @Dta_Cadastro, Vlr_Parametro = @Vlr_Parametro, Flg_Inativo = @Flg_Inativo, Dta_Alteracao = @Dta_Alteracao WHERE Idf_Parametro = @Idf_Parametro AND Idf_Curriculo = @Idf_Curriculo";
        ...
        private List<SqlParameter> GetParameters()
        {
            ...
            parms.Add(new SqlParameter("@Dta_Alteracao", SqlDbType.Date));
            return (parms);
        }
        #endregion
        ...
        private void SetParameters(List<SqlParameter> parms)
        {
            ...
            this._dataAlteracao = DateTime.Now.Date;
        ...
        public static IDataReader LoadDataReader(string colunaOrdenacao, string direcaoOrdenacao, int paginaCorrente, int tamanhoPagina, out int totalRegistros)
        {
            ...
            string SPSELECTPAG = "SELECT ROW_NUMBER() OVER (ORDER BY " + colunaOrdenacao + " " + direcaoOrdenacao + ") AS RowID, Par.Idf_Parametro, Par.Idf_Curriculo, Par.Dta_Cadastro, Par.Vlr_Parametro, Par.Flg_Inativo, Par.Dta_Alteracao FROM TAB_Parametro_Curriculo Par";
        ...
        /// <returns>Verdadeiro ou falso informando se a operação foi executada com sucesso.</returns>
        /// <remarks>Mailson</remarks>
        private static bool SetInstance(IDataReader dr, ParametroCurriculo objParametroCurriculo, bool dispose = true)
        {
            try
            {
                if (dr.Read())
                {
                    ...
                    if (dr["Dta_Alteracao"] != DBNull.Value)
                        objParametroCurriculo._dataAlteracao = Convert.ToDateTime(dr["Dta_Alteracao"]);
