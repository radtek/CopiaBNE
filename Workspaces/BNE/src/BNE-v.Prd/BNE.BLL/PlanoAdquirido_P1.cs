...
namespace BNE.BLL
{
    public partial class PlanoAdquirido // Tabela: BNE_Plano_Adquirido
    {
        ...
        /// Campo obrigatório.
        /// </summary>
        [Display(Name = "Data de Inicio do Plano")]
        ...
        /// Campo obrigatório.
        /// </summary>
        [Display(Name = "Data Fim do Plano")]
        ...
        [Display(Name = "Valor Base do Plano Adquirido")]
        ...
        private List<SqlParameter> GetParameters()
        {
            ...
            parms.Add(new SqlParameter("@Qtd_Parcela", SqlDbType.Int, 2));
           return (parms);
        }
        #endregion
        ...
        private void SetParameters(List<SqlParameter> parms)
        {
            ...
            parms[13].Value = this._flagRecorrente;

            if (this._dataCancelamento.HasValue)
                parms[14].Value = this._dataCancelamento;
            else
                parms[14].Value = DBNull.Value;

            if (this._qtdParcela.HasValue)
            {
                parms[15].Value = this._qtdParcela;
            }
            else
            {
        ...
        public static IDataReader LoadDataReader(string colunaOrdenacao, string direcaoOrdenacao, int paginaCorrente, int tamanhoPagina, out int totalRegistros)
        {
            ...
            string SPSELECTPAG = "SELECT ROW_NUMBER() OVER (ORDER BY " + colunaOrdenacao + " " + direcaoOrdenacao + ") AS RowID, Pla.Idf_Plano_Adquirido, Pla.Idf_Plano, Pla.Idf_Usuario_Filial_Perfil, Pla.Dta_Cadastro, Pla.Dta_Inicio_Plano, Pla.Dta_Fim_Plano, Pla.Idf_Plano_Situacao, Pla.Idf_Filial, Pla.Qtd_SMS, Pla.Vlr_Base, Pla.Qtd_Prazo_Boleto, Pla.Flg_Boleto_Registrado, Pla.Flg_Recorrente, Pla.Dta_Cancelamento FROM BNE_Plano_Adquirido Pla";
            ...
            try
            {
                if (dr.Read())
                {
                    ...
                    if (dr["Qtd_Parcela"] != DBNull.Value)
                        objPlanoAdquirido.QtdParcela = Convert.ToInt32(dr["Qtd_Parcela"]);
