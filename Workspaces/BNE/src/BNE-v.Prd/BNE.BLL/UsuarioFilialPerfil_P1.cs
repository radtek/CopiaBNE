...
namespace BNE.BLL
{
    public partial class UsuarioFilialPerfil // Tabela: TAB_Usuario_Filial_Perfil
    {
        ...
        private bool _flagUsuarioResponsavel;
        ...
        #region FlagUsuarioResponsavel
        /// <summary>
        /// Campo obrigatório.
        /// </summary>
        public bool FlagUsuarioResponsavel
        {
            get
            {
                return this._flagUsuarioResponsavel;
            }
            set
            {
                this._flagUsuarioResponsavel = value;
                this._modified = true;
            }
        }
        #endregion
        ...
        #region Consultas
        private const string SPINSERT = "INSERT INTO TAB_Usuario_Filial_Perfil (Idf_Filial, Des_IP, Dta_Cadastro, Flg_Inativo, Idf_Pessoa_Fisica, Idf_Perfil, Sen_Usuario_Filial_Perfil, Dta_Alteracao, Flg_Usuario_Responsavel) VALUES (@Idf_Filial, @Des_IP, @Dta_Cadastro, @Flg_Inativo, @Idf_Pessoa_Fisica, @Idf_Perfil, @Sen_Usuario_Filial_Perfil, @Dta_Alteracao, @Flg_Usuario_Responsavel);SET @Idf_Usuario_Filial_Perfil = SCOPE_IDENTITY();";
        private const string SPUPDATE = "UPDATE TAB_Usuario_Filial_Perfil SET Idf_Filial = @Idf_Filial, Des_IP = @Des_IP, Dta_Cadastro = @Dta_Cadastro, Flg_Inativo = @Flg_Inativo, Idf_Pessoa_Fisica = @Idf_Pessoa_Fisica, Idf_Perfil = @Idf_Perfil, Sen_Usuario_Filial_Perfil = @Sen_Usuario_Filial_Perfil, Dta_Alteracao = @Dta_Alteracao, Flg_Usuario_Responsavel = @Flg_Usuario_Responsavel WHERE Idf_Usuario_Filial_Perfil = @Idf_Usuario_Filial_Perfil";
        ...
        private const string SPSELECTID = "SELECT * FROM TAB_Usuario_Filial_Perfil WITH(NOLOCK) WHERE Idf_Usuario_Filial_Perfil = @Idf_Usuario_Filial_Perfil";
        #endregion
        ...
        private List<SqlParameter> GetParameters()
        {
            ...
            parms.Add(new SqlParameter("@Flg_Usuario_Responsavel", SqlDbType.Bit, 1));
            return (parms);
        }
        #endregion
        ...
        private static bool SetInstance(IDataReader dr, UsuarioFilialPerfil objUsuarioFilialPerfil)
        {
            try
            {
                if (dr.Read())
                {
                    ...
                    objUsuarioFilialPerfil._flagUsuarioResponsavel = Convert.ToBoolean(dr["Flg_Usuario_Responsavel"]);
