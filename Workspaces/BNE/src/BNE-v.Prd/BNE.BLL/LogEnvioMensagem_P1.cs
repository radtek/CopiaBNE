...
namespace BNE.BLL
{
    public partial class LogEnvioMensagem
    {
        ...
        private Curriculo _curriculo;//Quem recebe
        private string _obsMensagem;
        private CartaEmail _cartaEmail;
        ...
        #region Consultas
        private const string SPINSERT = @"INSERT INTO BNE.BNE_Log_Envio_Mensagem 
        ...
        private void SetParameters(List<SqlParameter> parms)
        {
            ...
            if (!String.IsNullOrEmpty(this._desAssunto))
            ...
            if (this._cartaEmail != null)
                parms[6].Value = this._cartaEmail.IdCartaEmail;
            else
