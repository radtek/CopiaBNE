...
namespace BNE.BLL
{
    public partial class Plano // Tabela: BNE_Plano
    {
        ...
        private bool _flgCustomizaParcela;
        private bool _flgRecorrenteAposTermPagamento;
        private TemplateContrato _template_Contrato;
        ...
        public bool FlagCustomizaParcela
        {
            get { return _flgCustomizaParcela; }
            set
            {
                _flgCustomizaParcela = value;
                _modified = true;
            }
        }

        public bool FlagRecorrenteAposTermPagamento
        {
            get { return _flgRecorrenteAposTermPagamento; }
            set
            {
                _flgRecorrenteAposTermPagamento = value;
                _modified = true;
            }
        }
        ...
        {
            get { return _template_Contrato; }
            set
            {
                _template_Contrato = value;
                _modified = true;
            }
        }
        ...
        private List<SqlParameter> GetParameters()
        {
            ...
            parms.Add(new SqlParameter("@Flg_CustomizaParcela", SqlDbType.Bit, 1));
            parms.Add(new SqlParameter("@Flg_RecorrenteAposTermPagamento", SqlDbType.Bit, 1));
            parms.Add(new SqlParameter("@idf_TemplateContrato", SqlDbType.Int, 4));
            return (parms);
        }
        #endregion
        ...
        private void SetParameters(List<SqlParameter> parms)
        {
            ...
            parms[26].Value = this._flgCustomizaParcela;
            parms[27].Value = this._flgRecorrenteAposTermPagamento;

            if (_template_Contrato != null)
                parms[28].Value = this._template_Contrato.IdTemplateContrato;
            else
        ...
        public static bool SetInstance(IDataReader dr, Plano objPlano, bool dispose = true)
        {
            try
            {
                if (dr.Read())
                {
                    ...
                    if (dr["Flg_CustomizaParcela"] != DBNull.Value)
                        objPlano._flgCustomizaParcela = Convert.ToBoolean(dr["Flg_CustomizaParcela"]);
                    
                    if (dr["Flg_RecorrenteAposTermPagamento"] != DBNull.Value)
                        objPlano.FlagRecorrenteAposTermPagamento = Convert.ToBoolean(dr["Flg_RecorrenteAposTermPagamento"]);
                    if(dr["idf_TemplateContrato"] != DBNull.Value)
                        objPlano._template_Contrato = new TemplateContrato(Convert.ToInt16(dr["idf_TemplateContrato"]));
