                    ...
                    try
                    {
                        ...
                        if (objUsuarioFilialPerfil != null)
                        {
                            ...
                            if (objUsuarioFilialPerfil.Filial != null)
                            {
                                ...
                                objVendedor = objUsuarioFilialPerfil.Filial.Vendedor();
                        ...
                        EmailSenderFactory.Create(TipoEnviadorEmail.Fila).Enviar(assunto, mensagem,Enumeradores.CartaEmail.SolicitacaoR1, emailRemetente, emailDestinatario, trans);

                        if (objVendedor != null && !string.IsNullOrWhiteSpace(objVendedor.EmailVendedor))
                            EmailSenderFactory.Create(TipoEnviadorEmail.Fila).Enviar(assunto, mensagem,Enumeradores.CartaEmail.SolicitacaoR1, emailRemetente, objVendedor.EmailVendedor, trans);
