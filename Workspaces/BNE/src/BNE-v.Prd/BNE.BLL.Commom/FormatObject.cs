...
namespace BNE.BLL.Common
{
    public static class FormatObject
    {
        public static string ToString(this ExpandoObject anObject, string aFormat, IFormatProvider formatProvider = null)
        {
            ...
            var reg = new Regex(@"({)([^:}]+)(})", RegexOptions.IgnoreCase); //Tirando o : nos casos onde o html tem css ({width:100%})
        ...
        public static string Format(this string targetString, object anObject)
        {
            return targetString.FormatWith(anObject, MissingKeyBehaviour.Ignore);
        }
    }
}
