...
namespace BNE.WebServices.API.Client.Models
{
    ...
    /// </summary>
    public partial class ResultadoCandidatosDTOResultadoPesquisaCurriculoCompleto
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ResultadoCandidatosDTOResultadoPesquisaCurriculoCompleto class.
        /// </summary>
        public ResultadoCandidatosDTOResultadoPesquisaCurriculoCompleto() { }
        ...
        /// atual.</param>
        public ResultadoCandidatosDTOResultadoPesquisaCurriculoCompleto(int? totalRegistros = default(int?), int? totalPaginas = default(int?), int? pagina = default(int?), System.Collections.Generic.IList<ResultadoPesquisaCurriculoCompleto> curriculos = default(System.Collections.Generic.IList<ResultadoPesquisaCurriculoCompleto>))
        {
        ...
        public System.Collections.Generic.IList<ResultadoPesquisaCurriculoCompleto> Curriculos { get; set; }
