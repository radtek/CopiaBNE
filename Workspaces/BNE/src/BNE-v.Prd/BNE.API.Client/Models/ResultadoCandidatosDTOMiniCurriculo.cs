...
namespace BNE.WebServices.API.Client.Models
{
    ...
    /// </summary>
    public partial class ResultadoCandidatosDTOMiniCurriculo
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ResultadoCandidatosDTOMiniCurriculo class.
        /// </summary>
        public ResultadoCandidatosDTOMiniCurriculo() { }
        ...
        /// atual.</param>
        public ResultadoCandidatosDTOMiniCurriculo(int? totalRegistros = default(int?), int? totalPaginas = default(int?), int? pagina = default(int?), System.Collections.Generic.IList<MiniCurriculo> curriculos = default(System.Collections.Generic.IList<MiniCurriculo>))
        {
