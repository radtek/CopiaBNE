...
namespace BNE.BLL.Mensagem
{
    ...
    public class DataAccessLayer
    {
        ...
        {
            get { return ConfigurationManager.ConnectionStrings["CONN_MENSAGEM"].ToString(); }
        }
        ...
        public static void SaveBulkTable(DataTable tbMsg, string destinationTableName, SqlTransaction trans = null)
        {
            if (tbMsg == null)
                return;
            ...
            if (trans == null)
                bulkCopy = new SqlBulkCopy(ConnString, SqlBulkCopyOptions.KeepIdentity & SqlBulkCopyOptions.KeepNulls & SqlBulkCopyOptions.TableLock);
            else
                bulkCopy = new SqlBulkCopy(trans.Connection, SqlBulkCopyOptions.KeepIdentity & SqlBulkCopyOptions.KeepNulls & SqlBulkCopyOptions.TableLock, trans);
