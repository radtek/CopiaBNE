...
namespace BNE.BLL.Mensagem
{
    public class CampanhaTanque
    {
        ...
        #region Parametros
        private static readonly string UrlApiCampanhaTanque = ConfigurationManager.AppSettings["ApiCampanhaTanque"] != null ? ConfigurationManager.AppSettings["ApiCampanhaTanque"].ToString() : "http://wstg.apprh.com.br/ApiCampanha/";
        HttpClient client;
        Uri campanhaUri;
        #endregion
        ...
        /// <returns></returns>
        public CampanhaTanqueMensagemDTO GetTextoCampanha(Enumeradores.CampanhaTanque campanha)
        {
            try
            {
