...
{
    internal partial class AtualizarPlano : BaseService
    {
        #region Construtor
        ...
        public void IniciarAtualizarPlano()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    try
                    {
                        PlanoAdquirido.AtualizarPlanoPJBoletosNaoRecorrente();
                        PlanoAdquirido.AtualizarPlanosPJCartaoRecorrente();
                        PlanoAdquirido.AtualizarPlanosPJCartao();
                        PlanoAdquirido.AtualizarPlanosComDataEncerramento();
                        PlanoAdquirido.VerificaPlanoQuantidade();
                    ...
                    try
                    {
                        PlanoAdquirido.AtualizaPlanosDeLiberacaoAutomatica();
                    }
                    catch (Exception ex)
                    {
                        GerenciadorException.GravarExcecao(ex);
