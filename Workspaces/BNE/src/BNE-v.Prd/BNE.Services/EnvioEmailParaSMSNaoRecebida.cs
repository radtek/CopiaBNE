        ...
        public void IniciarEnvio()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    {
#if !DEBUG
                        EventLogWriter.LogEvent(String.Format("Iniciou agora o envio da carta para candidatos que não teve retorno as sms do dia {0}.", DateTime.Now), EventLogEntryType.Information, Event.InicioExecucao);
#endif
