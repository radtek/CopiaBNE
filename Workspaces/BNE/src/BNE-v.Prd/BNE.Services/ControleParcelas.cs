            ...
            foreach (var objPlanoAdquirido in listPlanoAdquirido)
            {
                try
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        string messagemErro = "Erro criar parcelas e pagamento. IdParcela:" + (objPlanoParcela != null ? objPlanoParcela.IdPlanoParcela.ToString() : "0");
                        messagemErro = messagemErro + " IdPagamento:" + objPagamento != null ? objPagamento.IdPagamento.ToString() : "0";
                        var id = GerenciadorException.GravarExcecao(ex, out message, messagemErro);
                        message = string.Format("{0} - {1}", id, message);
                        EventLogWriter.LogEvent(message, EventLogEntryType.Error, Event.ErroExecucao);
                    }
                    ...
                    catch (Exception ex)
                    {
                        ...
                        string messagemErro = "Tipos de Pagamento. IdParcela:" + (objPlanoParcela != null ? objPlanoParcela.IdPlanoParcela.ToString() : "0");
                        messagemErro = messagemErro + " IdPagamento:" + objPagamento != null ? objPagamento.IdPagamento.ToString() : "0";
                        var id = GerenciadorException.GravarExcecao(ex, out message, messagemErro);
                        message = string.Format("{0} - {1}", id, message);
                        EventLogWriter.LogEvent(message, EventLogEntryType.Error, Event.ErroExecucao);
                    ...
                    catch (Exception ex)
                    {
                        ...
                        string messagemErro = "Tipos de Pagamento. IdPlanoAdquirido:" + (objPlanoAdquirido.IdPlanoAdquirido.ToString());
                        var id = GerenciadorException.GravarExcecao(ex, out message, messagemErro);
                        message = string.Format("{0} - {1}", id, message);
                        EventLogWriter.LogEvent(message, EventLogEntryType.Error, Event.ErroExecucao);
                    }
                    ...
                    if (objPlanoAdquirido.ParaPessoaJuridica() && objPlanoAdquirido.Filial.CompleteObject())
                    {
                        ...
                        catch (Exception ex)
                        {
                            ...
                            string messagemErro = "Email. IdPlanoAdquirido:" + (objPlanoAdquirido.IdPlanoAdquirido.ToString());
                            var id = GerenciadorException.GravarExcecao(ex, out message, messagemErro);
                            message = string.Format("{0} - {1}", id, message);
                            EventLogWriter.LogEvent(message, EventLogEntryType.Error, Event.ErroExecucao);
                        }
                    ...
                    else if (objPlanoAdquirido.ParaPessoaFisica() && objPlanoAdquirido.UsuarioFilialPerfil.CompleteObject() && objPlanoAdquirido.UsuarioFilialPerfil.PessoaFisica.CompleteObject())
                    {
                        ...
                        catch (Exception ex)
                        {
                            ...
                            string messagemErro = "Salvar CRM. IdPlanoAdquirido:" + (objPlanoAdquirido.IdPlanoAdquirido.ToString());
                            var id = GerenciadorException.GravarExcecao(ex, out message, messagemErro);
                            message = string.Format("{0} - {1}", id, message);
                            EventLogWriter.LogEvent(message, EventLogEntryType.Error, Event.ErroExecucao);
                        }
                ...
                {
                    string message = "Erro ao executar o processo Recorrência. PlanoAdquirido:" + objPlanoAdquirido.IdPlanoAdquirido.ToString();
