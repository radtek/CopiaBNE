        ...
        <ContentTemplate>
            <div class="titulo_modal">
                ...
                <asp:LinkButton CssClass="botao_fechar_modal" ID="btiFechar" OnClick="btiFechar_Click"
                    CausesValidation="false" runat="server"><span aria-hidden="true">×</span></asp:LinkButton>
            </div>
                    ...
                    <ContentTemplate>
                        ...
                        <div class="linha">
                            ...
                            <div class="container_campo_modal">
                                ...
                                <asp:HiddenField ID="hdfEmailEnviar" runat="server" />
                                <asp:HiddenField ID="hdfIdUfp" runat="server" />

                                <asp:TextBox ID="txtEnvioPara" runat="server" onkeyup="ajusteTxt(event)" onkeydown="autocompleteEmail()" ClientIDMode="Static" MaxLength="100" CssClass="textbox_padrao envio_curriculo campo_obrigatorio"></asp:TextBox>
                ...
                <asp:UpdatePanel ID="upCheckBox" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <div class="container_checkbox">
                            ...
                            <asp:CheckBox ID="cbOcultarObservacoes" runat="server" Text="Ocultar avaliações"
                                Checked="True" />
