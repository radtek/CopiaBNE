...
<asp:Panel ID="pnlTrocarEmpresa" runat="server" CssClass="modal_conteudo empresa trocar-empresa" Style="display: none;">
        ...
        <ContentTemplate>
            <div class="titulo_modal">
                ...
                <asp:UpdatePanel ID="upBtiFechar" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:LinkButton CssClass="fechar" ID="btiFechar" runat="server" CausesValidation="false" OnClick="btiFechar_Click"><span aria-hidden="true">×</span></asp:LinkButton>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
            <asp:Panel runat="server" ID="pnlTrocarEmpresaConteudo" CssClass="conteudo-modal">
                <p class="titulo_item_modal">Pesquise por CNPJ ou Nome da Empresa</p>
                <div class="linha">
