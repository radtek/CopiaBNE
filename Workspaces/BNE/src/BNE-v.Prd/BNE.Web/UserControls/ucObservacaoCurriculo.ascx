...
<div class="painel_padrao">
    ...
    <div class="linha">
        ...
        <div class="linha">
            <h2 class="titulo_painel_padrao">
                <asp:Label ID="lblNronquinha" runat="server" Text="Bronquinha(s) do Currículo" />
            </h2>
        <asp:UpdatePanel runat="server" ID="upBronquinha" UpdateMode="Conditional">
            <ContentTemplate>
                <Employer:EmployerGrid ID="gvBronquinha" runat="server" DataKeyNames="Idf_Curriculo_Correcao"
                    AllowPaging="true" CellSpacing="2" PageSize="10" AutoGenerateColumns="false">
                    <Columns>
                        <asp:BoundField HeaderText="Data" DataField="Dta_Cadastro" DataFormatString="{0:dd/MM/yyyy HH:mm:ss}" />
                        <asp:BoundField HeaderText="Motivo" DataField="Des_Correcao" HtmlEncode="False" />
                    </Columns>
                </Employer:EmployerGrid>
            </ContentTemplate>
        </asp:UpdatePanel>
