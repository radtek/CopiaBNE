            ...
            <asp:UpdatePanel ID="upnAbaMiniCurriculoDados" runat="server" UpdateMode="Conditional">
                ...
                <%--    <AjaxToolkit:AutoCompleteExtender ID="aceEmail" runat="server" TargetControlID="txtEmail"
                                ...
                                <div class="container_campo">
                                    ...
                                    <asp:TextBox ID="txtAT" ClientIDMode="Static" runat="server"  OnTextChanged="txtAT_TextChanged" AutoPostBack="true" CssClass="textbox_padrao" Visible="false" Columns="12"></asp:TextBox>
                                    <asp:DropDownList CssClass="textbox_padrao" ID="ddlAt" ClientIDMode="Static" AutoPostBack="true" OnSelectedIndexChanged="ddlAt_SelectedIndexChanged" runat="server"></asp:DropDownList>
                                </div>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </div>
                    ...
                    <div class="linha">
                        ...
                        <asp:CheckBox runat="server" ID="cbWhats" ClientIDMode="Static"  />
                    ...
                    <div class="linha">
                        ...
                        <div class="container_campo">
                            <asp:DropDownList ID="ddlEscolaridade" runat="server" ClientIDMode="Static" CssClass="textbox_padrao campo_obrigatorio dropdown_escolaridade" AutoPostBack="False">
                            </asp:DropDownList>
                            <%--<asp:CheckBoxList ID="chblContrato" CssClass="container_candidato_tipo_contrato" RepeatDirection="Horizontal" RepeatColumns="3" runat="server" />--%>
                        </div>
                    </div>
