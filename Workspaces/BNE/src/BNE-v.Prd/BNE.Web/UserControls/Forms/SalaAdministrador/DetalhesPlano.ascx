    ...
    <ContentTemplate>
        <asp:Panel ID="pnlEditarParcela" runat="server" CssClass="blocodados">
            ...
            <div class="linha">
                ...
                Multa de 2% e 0.033% ao dia.
                <asp:Label runat="server" id="lblValorSimulado" ClientIDMode="Static"></asp:Label>
            </div>
            ...
            <div class="linha">
                ...
                <div class="container_campo">
                    <asp:TextBox runat="server" ID="txtEmailBoleto" ValidationGroup="SalvarParcela" MaxLength="200" Width="600px"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="linha">
                <asp:Label ID="lblUrlNotaFiscal" runat="server" Text="Url Nota Fiscal" CssClass="label_principal"></asp:Label>
                <div class="container_campo">
                    <asp:TextBox ID="txtUrlNota" ClientIDMode="Static" runat="server" Width="600px"></asp:TextBox>
                </div>
            </div>
            <%--FIM Numero da Nota--%>
            <%-- Ordem de Compra --%>
            ...
            <MasterTableView DataKeyNames="Idf_Pagamento, Parcela, Des_Identificador">
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Número da Nota" ItemStyle-CssClass="center">
                        <ItemTemplate>
                            <a href='<%# Eval("Url_Nota_Fiscal") %>' target="_blank" title="Abrir nota Fiscal">
                    ...
                    <telerik:GridTemplateColumn HeaderText="Valor" ItemStyle-CssClass="center">
                     ...
                     <telerik:GridTemplateColumn HeaderText="Valor Juros" ItemStyle-CssClass="center">
                        <ItemTemplate>
                            <asp:Label ID="lblJuros" runat="server" Text='<%# Eval("Vlr_Juros") %>'></asp:Label>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
