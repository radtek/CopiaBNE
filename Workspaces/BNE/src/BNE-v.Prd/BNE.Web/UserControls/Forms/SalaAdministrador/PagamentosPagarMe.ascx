<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PagamentosPagarMe.ascx.cs" Inherits="BNE.Web.UserControls.Forms.SalaAdministrador.PagamentosPagarMe" %>

<link href="../../../css/local/UserControls/PlanoFidelidade.css" rel="stylesheet" type="text/css" />
<h2>Pagamentos PagarMe</h2>
<asp:UpdatePanel ID="upPagamentosPagarMe" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <asp:Panel ID="idPagamentosPagarMe" runat="server" CssClass="coluna_direita" Style="margin: 10px;">
            <asp:Label runat="server" ID="lblCartao" Text="Cartão de Crédito"></asp:Label>
            <asp:FileUpload ID="fCsvPagarMe" runat="server" />
...
<asp:UpdatePanel runat="server" ID="pnlPagamentosBoleto" UpdateMode="Conditional">
    <ContentTemplate>
        <asp:Panel ID="pnlPagamentoBoleto" runat="server" Style="margin: 10px; float: left;">
            <asp:Label ID="lblBoleto" runat="server" Text="Boleto Bancário"></asp:Label>

            <asp:FileUpload ID="fuCvsBoleto" runat="server" />
            <asp:Button ID="btEnviarBoleto" runat="server" Text="Enviar" OnClick="btEnviarBoleto_Click" />
        </asp:Panel>
    </ContentTemplate>
    <Triggers>
        <asp:PostBackTrigger ControlID="btEnviarBoleto" />
    </Triggers>
</asp:UpdatePanel>
<asp:UpdatePanel ID="upPagamentos" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <asp:Panel ID="pnlCartao" runat="server" Visible="false">
            ...
            <telerik:RadGrid ID="gvPagamentosPagarMe" CssClas="gridview_padrao" runat="server"
                ...
                <MasterTableView DataKeyNames="Des_Codigo_Autorizacao">
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Status" ItemStyle-CssClass="center">
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("StatusPagamento") %>'></asp:Label>
                            </ItemTemplate>
        ...
        <asp:Panel ID="pnlBoleto" runat="server" Visible="false">

            <telerik:RadGrid ID="gvPagamentosBoleto" CssClas="gridview_padrao" runat="server"
                Skin="Office2007" GridLines="None">
                <PagerStyle Mode="NextPrevNumericAndAdvanced" Position="TopAndBottom" />
                <AlternatingItemStyle CssClass="alt_row" />
                <MasterTableView DataKeyNames="Des_Codigo_Autorizacao">
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Código de Barras" ItemStyle-CssClass="center">
                            <ItemTemplate>
                                <asp:Label ID="lblCodigoBarra" runat="server" Text='<%# Eval("Codigo_Barra") %>'></asp:Label>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Valor" ItemStyle-CssClass="center">
                            <ItemTemplate>
