...
<asp:UpdatePanel ID="upPnlPlanoFidelidade" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <asp:Panel ID="pnlPlanoFidelidade" runat="server" CssClass="blocodados">
            ...
            <div class="linha" runat="server" id="divQuantidadeParcelas">
                <asp:Label runat="server" Text="Quantidade de Parcelas" CssClass="label_principal"></asp:Label>
                <div class="container-campo">
                    <%-- <asp:DropDownList  CssClass="rcbCombo" runat="server" ID="ddlQuantidadeParcelas" OnSelectedIndexChanged="ddlQuantidadeParcelas_OnSelectedIndexChanged" AutoPostBack="True"/>--%>
                    <telerik:RadComboBox runat="server" ID="RadQuantidadeParcelas" EmptyMessage=" " AllowCustomText="false"
                        CssClass="rcbComboFinanceiro" OnSelectedIndexChanged="ddlQuantidadeParcela_SelectedIndexChanged"
                        AutoPostBack="True">
                    </telerik:RadComboBox>
                </div>
            </div>
            ...
            <%--Linha Enviar Para--%>
            <div class="linha">
                 <asp:Label ID="Label6" runat="server" Text="" CssClass="label_principal" />
                <div class="container_campo">
                    <asp:RequiredFieldValidator runat="server" ID="rfEnviarEmail" CssClass="validador" ValidationGroup="Salvar" ControlToValidate="txtEnviarPara"
            ...
            <div class="linha" id="divEnviarPara" runat="server">
                ...
                <div class="container_campo">
                    ...
                    <asp:TextBox runat="server" ID="txtEnviarPara" MaxLength="200" ValidationGroup="Salvar" Width="600px"></asp:TextBox>
                </div>
            </div>
            <%--FIM  Enviar Para --%>
