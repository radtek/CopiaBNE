        ...
        <asp:Panel runat="server" class="callout callout-info box.box-warning img-polaroid" ID="pnPerguntaAleatoria">
            <asp:Panel runat="server" ID="pnUltimaEmpresa" Visible="false">
                <asp:Panel runat="server" ID="pnUltimaEmpresa_Fase1" Visible="false">
                    ...
                    <p>
                        <asp:Button runat="server" ID="btnSalvarUltimaEmpresa_Fase1" Text="Salvar e continuar" CausesValidation="True" OnClick="btnSalvarUltimaEmpresa_Fase1_Click" CssClass="btn btn-primary btn-small" Style="width:160px;" ValidationGroup="SalvarExperienciaProfissional" />
