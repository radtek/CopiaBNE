...
namespace BNE.Web.UserControls.Forms.SalaVip
{
    public partial class MenuSalaVip : BaseUserControl
    {
        ...
        public void Inicializar()
        {
            ...
            CarregarBoxJaEnviei();
            CarregarBoxMeuPlano();
            hlMeuCurriculo.NavigateUrl = GetRouteUrl(Enumeradores.RouteCollection.CadastroCurriculoDados.ToString(), null);
        }
        #endregion
        ...
        public void CarregarBoxJaEnviei()
        {
            ...
            {
                hlJaEnviei.NavigateUrl = GetRouteUrl(Enumeradores.RouteCollection.SalaVipJaEnviei.ToString(), null);
            }
            else
            {
                JaEnvieiVirgemRedirect = true;
                hlJaEnviei.NavigateUrl = GetRouteUrl(BLL.Enumeradores.RouteCollection.SalaVipJaEnvieiNaoCandidatura.ToString(), null);
            }
        }
        #endregion
