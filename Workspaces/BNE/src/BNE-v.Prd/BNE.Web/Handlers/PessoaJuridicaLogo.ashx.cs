...
namespace BNE.Web.Handlers
{
    ...
    /// Salvar Quem me viu da empresa/CV
    /// </summary>
    public class PessoaJuridicaLogo : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            numeroCnpj = new Regex("[^0-9]").Replace(numeroCnpj, string.Empty);
            ...
            //objImagem = ResizeImage(objImagem, MaxSize != Size.Empty ? MaxSize : new Size(Convert.ToInt32(Parametro.RecuperaValorParametro(BLL.Enumeradores.Parametro.WidthMaxLogo)), Convert.ToInt32(Parametro.RecuperaValorParametro(BLL.Enumeradores.Parametro.HeightMaxLogo))));
        ...
        public static byte[] RecuperarLogo(decimal numeroCNPJ, OrigemLogo origemLogo)
        {
            ...
            switch (origemLogo)
            {
                case OrigemLogo.Local:
                    ...
                    try
                    {
                        byteArray = FilialLogo.RecuperarArquivo(numeroCNPJ);
                    }
                    catch (Exception ex)
                    {
