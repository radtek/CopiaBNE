...
namespace BNE.Web
{
    public partial class CiaPlanosNovo : BasePagePagamento
    {
        ...
        public decimal ValorTotalPlano
        {
            get
            {
                return Convert.ToInt32(ViewState[Chave.Permanente.ValorTotalPlano.ToString()]);
            }
            set
            {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (base.IdFilial.HasValue)
            {
                ...
                if (BLL.Pagamento.PagouPrimeiroBoleto(base.IdFilial.Value))
                {
                    Redirect(GetRouteUrl(Enumeradores.RouteCollection.ReimprimirBoleto.ToString(), null));
                }
            }
        }
        #endregion
        ...
        public void CriarPlanoAdquirido()
        {
            ...
            if (ddlQuantidadeParcelas.SelectedItem.Value != null)
                objPlano.QuantidadeParcela = Convert.ToInt32(ddlQuantidadeParcelas.SelectedItem.Value);
        ...
        private void PreencherCamposCustomizado()
        {
            ...
            int quantidadeMaximaParcelas = Plano.QuantidadeMaximaParcela(PlanoCustomizadoIdentificador);

            ValorTotalPlano = objPlano.ValorBase * Convert.ToDecimal(quantidadeMaximaParcelas);
            CarregaDdlQuantidadeParcelas(quantidadeMaximaParcelas, objPlano.FlagCustomizaParcela);
            decimal valorPlano = CalculaValorParcelado(quantidadeMaximaParcelas);
        ...
        public void GerarPDFContrato(string razaoSocial, decimal numCNPJ, string descRua, string numeroRua, string estado,
                                     ...
                                     int quantidadeSms, int quantidadeTanque, int quantidadeUsuarios, int templateContrato)
        {
            ...
            var pdf = GerarContratoPlano.ContratoPadraoPdf(razaoSocial, numCNPJ, descRua, numeroRua, estado,
                                                           ...
                                                           quantidadeSms, quantidadeTanque, quantidadeUsuarios, templateContrato);
            ...
            if (idUsuario > 0)
            {
                ...
                if (base.PagamentoIdentificadorPlano.HasValue)
                {
                    ...
                    if (objPlano.FlagEnviarContrato)
                    {
                        ...
                        GerarPDFContrato(_razaoSocial, _numCNPJ, _descRua, _numeroRua, _estado, _nomeCidade, _numeroCEP, _nomePessoa, _numRG, _numCPF, _valorPlano, _numeroParcelas, _tempoPlano, _quantidadeSms, quantidadeSMSTanque, _quantidadeUsuarios, objPlano.TemplateContrato.IdTemplateContrato);
                    }
                    else
                    {
        ...
        private void VerContratoPlanoRecorrente()
        {
            ...
            if (idUsuario > 0)
            {
                ...
                GerarPDFContratoPlanoRecorrente(_razaoSocial, _numCNPJ, _descRua, _numeroRua, _estado, _nomeCidade, _numeroCEP, _nomePessoa, _numRG, _numCPF, _valorPlano, _quantidadeVisualizacoes, _quantidadeSms, _quantidadeUsuarios, (int)templateContrato);
            }
            else
            {
                _numCNPJ = _numCPF = 0;
        ...
        public void GerarPDFContratoPlanoRecorrente(string razaoSocial, decimal numCNPJ, string descRua, string numeroRua, string estado,
                                     string nomeCidade, string numCEP, string nomePessoa, string numRG, decimal numCPF,
                                     decimal valorPlano, int quantidadeVisualizacoes, int quantidadeSms, int quantidadeUsuarios, int templateContrato)
        {
        ...
        protected void ddlQuantidadeParcelas_OnSelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        {
            ddlQuantidadeParcelas.Items.Clear();
            for (int i = 1; i <= quantidadeMaximaParcelas; i++)
            {
                ddlQuantidadeParcelas.Items.Add(new ListItem(i.ToString(), i.ToString()));
            }
            ddlQuantidadeParcelas.SelectedValue = quantidadeMaximaParcelas.ToString();

            ddlQuantidadeParcelas.Enabled = customizaParcela;
        }
