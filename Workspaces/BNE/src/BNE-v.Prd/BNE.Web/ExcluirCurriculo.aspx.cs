...
namespace BNE.Web
{
    public partial class ExcluirCurriculo : BasePage
    {
        ...
        protected void btnExcluirCV_Click(Object sender, EventArgs e)
        {
            ...
            {
                result = BLL.CurriculoMotivoExclusao.RegistrarCurriculoMotivoExclusao(base.IdCurriculo.Value, string.Empty, rblEmpregoBNE.SelectedValue == "1",
            ...
            {
                result = BLL.CurriculoMotivoExclusao.RegistrarCurriculoMotivoExclusao(base.IdCurriculo.Value, string.Empty, false, (byte)BLL.Enumeradores.MotivoExclusao.PoucasVagas);
                motivos.Add("poucas vagas");
            }

            if (chkMuitosEmails.Checked)
            {
                result = BLL.CurriculoMotivoExclusao.RegistrarCurriculoMotivoExclusao(base.IdCurriculo.Value, string.Empty, false, (byte)BLL.Enumeradores.MotivoExclusao.ReceboMuitosEmails);
