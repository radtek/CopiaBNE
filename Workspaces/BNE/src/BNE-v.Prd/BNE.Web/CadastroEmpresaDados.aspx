            ...
            <asp:Panel ID="pnlDadosBasicosCadastro" runat="server" CssClass="painel_padrao">
                ...
                <div class="linha">
                    ...
                    <div class="container_campo">
                        <componente:CNPJ runat="server" ID="txtCNPJ" Obrigatorio="true" ValidationGroup="SalvarDadosEmpresa" />
                    </div>
                </div>
                <%--FIM: Linha CNPJ --%>
            </asp:Panel>
                    ...
                    <div class="caixa_amarela">
                        <div class="input_CNAE_natureza_empresa">
                            <div class="container_campo CNAE">
                                ...
                                <asp:Label ID="lblInfoCNAE" runat="server" CssClass="label" Style="color:black;"></asp:Label>
                            </div>
                            <div class="container_campo natureza_juridica">
                                ...
                                <asp:Label ID="lblInfoNaturezaJuridica" runat="server" Style="color:black;" CssClass="label"></asp:Label>
                            </div>
                        </div>
            ...
            <asp:UpdatePanel ID="upFoto" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <Componentes:SelecionarFoto ID="ucFoto" runat="server" InitialSelection="1;1;370;244"
                        ...
                        SemFotoImagemUrl="/img/btn_coloque_sua_logo.png" ThumbDir="~/ArquivosTemporarios/"
                    ...
                    <div class="dados_da_empresa">
                            ...
                            <div class="container_campo">
                                <div>
                                    <asp:RegularExpressionValidator ID="regexSite"
                                        ...
                                        CssClass="validador"
                                        ValidationGroup="SalvarDadosEmpresa"
                                        ValidationExpression="((http|https|ftp)\://|(www))(((25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])|([a-zA-Z0-9_\-\.])+\.(adv|com|net|org|edu|int|mil|gov|arpa|biz|aero|name|inf|coop|info|pro|museum|senac|uk|me|ind|eng|srv|esp))((:[a-zA-Z0-9]*)?/?([a-zA-Z0-9\-\._\?\,\'/\\\+&amp;%\$#\=~])*)">
                                    </asp:RegularExpressionValidator>
                                </div>
                        ...
                        <div class="linha">
                            ...
                            <div class="container_campo">
                                ...
                                <asp:Label runat="server" ID="lblMinhaEmpresaCursos" CssClass="label_principal" Text="Minha empresa comercializa cursos"
