...
namespace BNE.Web
{
    public partial class SalaAdministradorEdicaoCV : BasePage
    {
        ...
        public void Inicializar()
        {
            ...
            var cpf = RouteData.Values["cpf"];
            if (cpf != null)
                ucEdicaoCV.Inicializar(cpf.ToString());
            else
                ucEdicaoCV.Inicializar(string.Empty);
        }
        #endregion
        ...
        void ucEdicaoCV_EventEditarCurriculo(int idCurriculo)
        {
            ...
            Redirect(GetRouteUrl(BLL.Enumeradores.RouteCollection.AdministradorEditarCurriculo.ToString(), null));
        }
        #endregion
