    ...
    public partial class PlanoVIP : BasePagePagamento
    {
        ...
        private void ValidarCodigoDesconto()
        {
            ...
            if (codigo.HaPlanosVinculados(out planosVinculados))
            {
                ...
                else
                {
                    ...
                    if (mostraRecorrente)
                    {
                         btnPlanoRecorrente.Visible = true;
                    }
        ...
        private void PreencherCampos()
        {
            if (base.IdCurriculo.HasValue)
            {
                ...
                lblPrecoSemDesconto.Text = precoDescontoRecorrente.ToString();
                ...
                lblPrecoDescontoRecorrente.CssClass = string.Empty;
            }
            else
            {   
                lblPrecoDescontoRecorrente.Text = "9,99";
                lblPrecoDescontoRecorrente.CssClass = "blurry";
            }
        ...
        private void ControlaDivDesconto(Boolean controleExibicao)
        {
            divObsCupomDesconto.Visible = controleExibicao;
            divPorMes.Visible = !controleExibicao;
        }
        ...
        private void ComprarPlano()
        {
            ...
            try
            {
                ...
                //Verifica se o pagamento é via mobile
                ...
                if ((b.IsMatch(u) || v.IsMatch(u.Substring(0, 4))))
                        r = "Payment/PaymentMobileFluxoVip.aspx";
                else
                {
                    CriarPlanoAdquirido();
                    r = Rota.RecuperarURLRota(Enumeradores.RouteCollection.PagamentoPlano);
                }
#if DEBUG
