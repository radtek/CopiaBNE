...
<head runat="server">
    ...
    <script src="js/Framework/employer.js"></script>
    <script src="js/Framework/employer.event.js"></script>
    <script src="js/Framework/employer.controles.js"></script>
    <script src="js/Framework/employer.key.js"></script>
    <script src="js/Framework/employer.util.js"></script>
    <script src="js/Framework/employer.util.number.js"></script>
    <script src="js/Framework/employer.util.string.js"></script>
    <script src="js/Framework/employer.form.js"></script>
    <script src="js/Framework/employer.form.util.js"></script>
