...
function contador(campo){
    document.getElementById("lblContagem").innerHTML = campo.value.length;
    document.getElementById("txtEmail").maxLength = 2000;
}


function contadorSMS(campo) {
    document.getElementById("lblContagemSMS").innerHTML = campo.value.length;
    document.getElementById("txtSMS").maxLength = 135;
}
