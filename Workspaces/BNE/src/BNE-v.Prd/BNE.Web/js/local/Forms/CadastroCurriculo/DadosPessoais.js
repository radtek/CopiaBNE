$(document).ready(function () {
    ...
    $('#cphConteudo_ucDadosPessoais_avisoSalarioinvalido').hide();
    ...
    autocomplete.funcao("txtFuncaoExercida1");
    autocomplete.funcao("txtFuncaoExercida2");
    autocomplete.funcao("txtFuncaoExercida3");
    autocomplete.funcao("txtFuncaoExercida4");
    autocomplete.funcao("txtFuncaoExercida5");
    autocomplete.funcao("txtFuncaoExercida6");
    autocomplete.funcao("txtFuncaoExercida7");
    autocomplete.funcao("txtFuncaoExercida8");
    autocomplete.funcao("txtFuncaoExercida9");
    autocomplete.funcao("txtFuncaoExercida10");

    autocomplete.cidade("txtCidade");
    autocomplete.cidade("txtCidadeEspecializacao");
...
function txtFuncaoExercida1_TextChanged(args) {
    ...
    if (res.error == null) {
        $('#cphConteudo_ucDadosPessoais_txtSugestaoTarefas1').val(res.value);
    }
}
function txtFuncaoExercida2_TextChanged(args) {
    var res = DadosPessoais.RecuperarJobFuncao(args.value);
    if (res.error == null) { $('#cphConteudo_ucDadosPessoais_txtSugestaoTarefas2').val(res.value); }
    
}
function txtFuncaoExercida3_TextChanged(args) {
    var res = DadosPessoais.RecuperarJobFuncao(args.value);
    if (res.error == null) { $('#cphConteudo_ucDadosPessoais_txtSugestaoTarefas3').val(res.value); }
}
function txtFuncaoExercida4_TextChanged(args) {
    var res = DadosPessoais.RecuperarJobFuncao(args.value);
    if (res.error == null) { $('#cphConteudo_ucDadosPessoais_txtSugestaoTarefas4').val(res.value); }
}
function txtFuncaoExercida5_TextChanged(args) {
    var res = DadosPessoais.RecuperarJobFuncao(args.value);
    if (res.error == null) { $('#cphConteudo_ucDadosPessoais_txtSugestaoTarefas5').val(res.value); }
}
function txtFuncaoExercida6_TextChanged(args) {
    var res = DadosPessoais.RecuperarJobFuncao(args.value);
    if (res.error == null) { $('#cphConteudo_ucDadosPessoais_txtSugestaoTarefas6').val(res.value); }
}
function txtFuncaoExercida7_TextChanged(args) {
    var res = DadosPessoais.RecuperarJobFuncao(args.value);
    if (res.error == null) { $('#cphConteudo_ucDadosPessoais_txtSugestaoTarefas7').val(res.value); }
}
function txtFuncaoExercida8_TextChanged(args) {
    var res = DadosPessoais.RecuperarJobFuncao(args.value);
    if (res.error == null) { $('#cphConteudo_ucDadosPessoais_txtSugestaoTarefas8').val(res.value); }
}
function txtFuncaoExercida9_TextChanged(args) {
    var res = DadosPessoais.RecuperarJobFuncao(args.value);
    if (res.error == null) { $('#cphConteudo_ucDadosPessoais_txtSugestaoTarefas9').val(res.value); }
}
function txtFuncaoExercida10_TextChanged(args) {
    var res = DadosPessoais.RecuperarJobFuncao(args.value);
    if (res.error == null) { $('#cphConteudo_ucDadosPessoais_txtSugestaoTarefas10').val(res.value); }
}
...
function ValidarDataDemissao(campoDtaAdmissao, campoDtaDemissao, divAviso) {
    ...
    var ano = hojeMaisDiasLimiteSaida.getFullYear();
    var mes = (parseInt(hojeMaisDiasLimiteSaida.getMonth()) + 1);
    var dia = (hojeMaisDiasLimiteSaida.getDate().toString() < 10 ? '0' : '') + hojeMaisDiasLimiteSaida.getDate().toString();
    var data60Dias = ano + (mes < 10 ? '0' : '') + mes + '' + dia;
    ...
    if (dataAdmissao > dataDemissao || dataDemissao > data60Dias) {
