<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentMobileSuccess.aspx.cs" Inherits="BNE.Web.Payment.PaymentMobileSuccess" %>
...
<body class="mobile-payment return" style="background-color: #45B04C !important;">
    <form id="form1" runat="server" autocomplete="off">
        ...
        <section id="mobile-payment-return" class="container-small ">
            ...
            <div id="payment-return" class="white">
                ...
                <div class="col-xs-12">
                    <h4>Seu pagamento foi realizado, a partir de agora você já pode utilizar os serviços exclusivos do BNE.</h4>
                </div>
                <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 payment-return-actions">
                    <asp:Button ID="btnVerVagas" runat="server" CssClass="btn btn-lg btn-info btn-block" OnClick="btnVerVagas_Click" Text="Ver vagas" /></div>
                <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 payment-return-actions">
                    <asp:Button ID="btnHome" runat="server" CssClass="btn btn-lg btn-block" OnClick="btnHome_Click" Text="Página inicial" /></div>
                </div>
            </div>
        </section>
        <div class="clear"></div>
