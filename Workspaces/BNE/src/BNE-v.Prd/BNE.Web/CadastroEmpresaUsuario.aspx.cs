    ...
    public partial class CadastroEmpresaUsuario : BasePage
    {
        ...
        private void PreencherCampos()
        {
            ...
            if (IdUsuarioFilialContato.HasValue)
            {
                ...
                if (!string.IsNullOrEmpty(objUsuarioFilialContato.NumeroDDDCelular) && !string.IsNullOrEmpty(objUsuarioFilialContato.NumeroCelular))
                {
                    ...
                    if (objUsuarioFilialContato.FlagWhatsApp.HasValue)
                        cbWhats.Checked = objUsuarioFilialContato.FlagWhatsApp.Value;
                }
                else
                {
        ...
        private bool Salvar(out string erro)
        {
            ...
            else //Se não existe pessoa física, então é apenas um contato
            {
                ...
                objUsuarioFilialContato.FlagWhatsApp = cbWhats.Checked;
        ...
        private bool Excluir(bool confirmacao)
        {
            try
            {
                if (IdUsuarioFilialPerfil.HasValue)
                {
                    ...
                    if (!confirmacao && objUsuarioFilialPerfil.FlagUsuarioResponsavel && !base.IdUsuarioFilialPerfilLogadoUsuarioInterno.HasValue)
                    {
                        UIHelper.CarregarRadGrid(gvResponsavel, UsuarioFilialPerfil.CarregarUsuariosMasterPorFilial(objUsuarioFilialPerfil.Filial.IdFilial));
        ...
        public void HabilitarCamposCpfExistenteEmpresa(bool enable)
        {
            ...
            txtCPF.Enabled = txtDataNascimento.Enabled = enable;
