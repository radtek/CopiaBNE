...
{
    internal class Dica : INotificacaoCV
    {
        public bool Notificar(DTO.Curriculo curriculo, short idNotificacao, int idCiclo)
        {
            try
            {
                ...
                InformativoVip informativoParaEnvio = InformativoVip.RetornarInformativoNaoEnviadoCVPorTipo(curriculo.idCurriculo, (int)Enumeradores.TipoInformativoVip.Dica);
            ...
            {
                EL.GerenciadorException.GravarExcecao(ex, "Falha na notificação de Dica para o CV " + curriculo.idCurriculo);
                return false;
            }
        }
    }
