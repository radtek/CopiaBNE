...
{
    public class ApiVendedorEmpresaFinalPrazoController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetVWEmpresas()
        {
            using (var context = new Model())
            {
                var result = context.Database
                    .SqlQuery<EmpresaAlertas>("dbo.getUsuarioEmpresasFinalPrazo")
                    .ToList();
        ...
        public async Task<IHttpActionResult> Indices(string id)
       {
           ...
           using (var context = new Model())
           {
               ...
               var result = context.Database
                   .SqlQuery<EmpresaAlertas>("dbo.getUsuarioEmpresasFinalPrazo @nome", cpf)
                   .ToList();
