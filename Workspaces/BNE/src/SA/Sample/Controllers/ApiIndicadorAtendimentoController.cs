...
{
    public class ApiIndicadorAtendimentoController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetVWEmpresas()
        {
            using (var context = new Model())
            {
                 var result = context.Database
                    .SqlQuery<Vendas>("dbo.getIndicadoresAtendimento")
                    .ToList();
        ...
        public async Task<IHttpActionResult> Indices(decimal id)
       {
           ...
           using (var context = new Model())
           {
               ...
               var result = context.Database
                   .SqlQuery<Vendas>("dbo.getIndicadoresAtendimento @cpf", filial)
                   .ToList();
