...
{
    public class ApiVendedorEmpresaOnlineController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetVWEmpresas()
        {
            using (var context = new Model())
            {
                var result = context.Database
                    .SqlQuery<EmpresaAlertas>("dbo.getUsuarioEmpresasOnline")
                    .ToList();
        ...
        public async Task<IHttpActionResult> Indices(string id)
       {
           ...
           using (var context = new Model())
           {
               ...
               var result = context.Database
                   .SqlQuery<EmpresaAlertas>("dbo.getUsuarioEmpresasOnline @nome", cpf)
                   .ToList();
