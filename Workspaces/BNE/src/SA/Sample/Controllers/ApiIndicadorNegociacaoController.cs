...
{
    public class ApiIndicadorNegociacaoController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetVWEmpresas()
        {
            using (var context = new Model())
            {
                 var result = context.Database
                    .SqlQuery<Vendas>("dbo.getIndicadoresNegociacao")
                    .ToList();
        ...
        public async Task<IHttpActionResult> Indices(decimal id)
       {
           ...
           using (var context = new Model())
           {
               ...
               var result = context.Database
                   .SqlQuery<Vendas>("dbo.getIndicadoresNegociacao @cpf", filial)
                   .ToList();
