...
namespace APIGateway.ModelValidation.Util
{
    public abstract class DataAccessLayer
    {
        ...
        public static string CONN_STRING
        {
            get
            {
                return ConfigurationManager.ConnectionStrings["APIGateway"].ToString();
            }
        }
        #endregion

        #region CONN_PLATAFORMA
        public static string CONN_PLATAFORMA
        {
            get
            {
        ...
        public static void SaveBulkTable(DataTable tbMsg, string DestinationTableName, SqlTransaction tran = null)
        {
            ...
            if (tran == null)
                bulkCopy = new SqlBulkCopy(DataAccessLayer.CONN_STRING, SqlBulkCopyOptions.FireTriggers & SqlBulkCopyOptions.KeepIdentity & SqlBulkCopyOptions.KeepNulls);
            else
