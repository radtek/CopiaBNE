...
{
    /// <summary>
    /// Classe auxiliar para acesso direto ao banco de dados
    /// </summary>
    public class DataAccessLayer
    {
        #region GetConnectionString
        /// <summary>
        /// Método para recuperar a string de conexão presente no Config
        /// </summary>
        /// <param name="connectionName">UrlSuffix da conexão</param>
        /// <returns>String com a string de conexão definida no Config.</returns>
        ...
        /// </summary>
        /// <param name="connectionName">Noma da string de conexão da configuração</param>
        ...
        public static int ExecuteNonQuery(string connectionName, CommandType cmdType, string cmdText, List<SqlParameter> cmdParms)
        {
        ...
        public static SqlCommand ExecuteNonQueryCmd(string connectionName, CommandType cmdType, string cmdText, List<SqlParameter> cmdParms)
        {
            SqlCommand cmd = new SqlCommand();
            using (SqlConnection conn = new SqlConnection(GetConnectionString(connectionName)))
            {
        ...
        public static SqlDataReader ExecuteReader(string connectionName, CommandType cmdType, string cmdText, List<SqlParameter> cmdParms, string connStringKey)
        {
            ...
            SqlConnection conn = new SqlConnection(GetConnectionString(connectionName));
            SqlCommand cmd = new SqlCommand();
            try
            {
                PrepareCommand(cmd, conn, null, cmdType, cmdText, cmdParms);
        ...
        /// <param name="cmdParms">Coleção de parâmetros SQL.</param>
        /// <returns>SqlDataReader de retorno da consulta.</returns>
        public static SqlDataReader ExecuteReader(string connectionName, CommandType cmdType, string cmdText, List<SqlParameter> cmdParms)
        {
            //SqlDataReader dr = null;
            SqlConnection conn = new SqlConnection(GetConnectionString(connectionName));
            SqlCommand cmd = new SqlCommand();
        ...
        public static object ExecuteScalar(string connectionName, CommandType cmdType, string cmdText, List<SqlParameter> cmdParms)
        {
        ...
        public static DataSet ExecuteReaderDs(string connectionName, CommandType cmdType, string cmdText, List<SqlParameter> cmdParms, string connStringKey)
        {
            string connString = ConfigurationManager.ConnectionStrings[connStringKey].ConnectionString;
        ...
        /// <param name="cmdParms">Coleção de parâmetros SQL.</param>
        /// <returns>DataSet de retorno da consulta.</returns>
        public static DataSet ExecuteReaderDs(string connectionName, CommandType cmdType, string cmdText, List<SqlParameter> cmdParms)
        {
            DataSet ds = new DataSet();
            SqlCommand cmd = new SqlCommand();
            using (SqlConnection conn = new SqlConnection(GetConnectionString(connectionName)))
        ...
        public static void AddBulkTable(ref DataTable tbMsg, object ObjDaata)
        {
            ...
            if (tbMsg == null)
            {
                ...
                {
                    string pName = par.ParameterName.Replace("@", "");
                    Type tyColummn = null;
                    ...
                    tbMsg.Columns.Add(pName, tyColummn);
                }
            }
            ...
            foreach (SqlParameter par in parms)
            {
                ...
                {
                    if (((string)value).Length > par.Size)
                    {
                        value = ((string)value).Substring(0, par.Size);
                    }
                }
                linha[pName] = value;
            }
        ...
        /// 
        public static void SaveBulkTable(string connectionName, DataTable tbMsg, string DestinationTableName, SqlTransaction tran = null)
        {
            ...
            if (tran == null)
                bulkCopy = new SqlBulkCopy(GetConnectionString(connectionName), SqlBulkCopyOptions.FireTriggers & SqlBulkCopyOptions.KeepIdentity & SqlBulkCopyOptions.KeepNulls);
            else
