...
namespace BNE.Web.Vagas.Controllers
{
    public class BaseController : Controller
    {
        ...
        {
            return PartialView("_Rodape", new Rodape { STC = STC.ValueOrDefault, PerfilLogadoEmpresa = IdUsuarioFilialPerfilLogadoEmpresa.HasValue });
        }
        #endregion
        ...
        {
            return PartialView("_Estatistica", new Estatistica { QuantidadeCurriculo = BLL.Estatistica.Estatisticas.QuantidadeCurriculo, QuantidadeEmpresa = BLL.Estatistica.Estatisticas.QuantidadeEmpresa, QuantidadeVaga = BLL.Estatistica.Estatisticas.QuantidadeVaga.Value });
        }
        #endregion
