...
namespace BNE.Services
{
    partial class ProjectInstaller
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.DebitoOnlineBradescoInstaller = new System.ServiceProcess.ServiceInstaller();
            this.EnviarEmailConfirmacaoCandidaturaInstaller = new System.ServiceProcess.ServiceInstaller();
            this.EnviarEmailOportunidadeInstaller = new System.ServiceProcess.ServiceInstaller();
            this.RastreadorCurriculoInstaller = new System.ServiceProcess.ServiceInstaller();
            this.EnviarCampanhaInstaller = new System.ServiceProcess.ServiceInstaller();
            this.EnvioEmailParaSMSNaoRecebidaInstaller = new System.ServiceProcess.ServiceInstaller();
            // 
            ...
            // EnviarCurriculo
            // 
            this.EnviarCurriculo.Description = "Serviço responsável por notificar todas as candidaturas feitas em uma vaga quando" +
    " a empresa marca o para receber TODOS os currículos.";
            ...
            this.BuscaCoordenadaInstaller.StartType = System.ServiceProcess.ServiceStartMode.Automatic;
            // 
            ...
            // 
            // DebitoOnlineBradescoInstaller
            // 
            this.DebitoOnlineBradescoInstaller.DisplayName = "BNE.Services.DebitoOnlineBradesco";
            this.DebitoOnlineBradescoInstaller.ServiceName = "BNE.Services.DebitoOnlineBradesco";
            this.DebitoOnlineBradescoInstaller.StartType = System.ServiceProcess.ServiceStartMode.Automatic;
            // 
            // EnviarEmailConfirmacaoCandidaturaInstaller
            // 
            this.EnviarEmailConfirmacaoCandidaturaInstaller.DisplayName = "BNE.Services.EnviarEmailConfirmacaoCandidatura";
            this.EnviarEmailConfirmacaoCandidaturaInstaller.ServiceName = "BNE.Services.EnviarEmailConfirmacaoCandidatura";
            this.EnviarEmailConfirmacaoCandidaturaInstaller.StartType = System.ServiceProcess.ServiceStartMode.Automatic;
            // 
            // EnviarEmailOportunidadeInstaller
            // 
            this.EnviarEmailOportunidadeInstaller.DisplayName = "BNE.Services.EnviarEmailOportunidade";
            this.EnviarEmailOportunidadeInstaller.ServiceName = "BNE.Services.EnviarEmailOportunidade";
            this.EnviarEmailOportunidadeInstaller.StartType = System.ServiceProcess.ServiceStartMode.Automatic;
            // 
            // RastreadorCurriculoInstaller
            // 
            this.RastreadorCurriculoInstaller.DisplayName = "BNE.Services.RastreadorCurriculo";
            this.RastreadorCurriculoInstaller.ServiceName = "BNE.Services.RastreadorCurriculo";
            // 
            // EnviarCampanhaInstaller
            // 
            this.EnviarCampanhaInstaller.DisplayName = "BNE.Services.EnviarCampanha";
            this.EnviarCampanhaInstaller.ServiceName = "BNE.Services.EnviarCampanha";
            this.EnviarCampanhaInstaller.StartType = System.ServiceProcess.ServiceStartMode.Automatic;
            // 
            // EnvioEmailParaSMSNaoRecebidaInstaller
            // 
            this.EnvioEmailParaSMSNaoRecebidaInstaller.DisplayName = "BNE.Services.EnvioEmailParaSMSNaoRecebida";
            this.EnvioEmailParaSMSNaoRecebidaInstaller.ServiceName = "BNE.Services.EnvioEmailParaSMSNaoRecebida";
            this.EnvioEmailParaSMSNaoRecebidaInstaller.StartType = System.ServiceProcess.ServiceStartMode.Automatic;
            // 
            // ProjectInstaller
            // 
            ...
            this.DebitoOnlineBradescoInstaller,
            this.EnviarEmailConfirmacaoCandidaturaInstaller,
            this.EnviarEmailOportunidadeInstaller,
            this.RastreadorCurriculoInstaller,
            this.EnviarCampanhaInstaller,
            this.EnvioEmailParaSMSNaoRecebidaInstaller});
        ...
        private ServiceInstaller DebitoOnlineBradescoInstaller;
        private ServiceInstaller EnviarEmailConfirmacaoCandidaturaInstaller;
        private ServiceInstaller EnviarEmailOportunidadeInstaller;
        private ServiceInstaller RastreadorCurriculoInstaller;
        private ServiceInstaller EnviarCampanhaInstaller;
        private ServiceInstaller EnvioEmailParaSMSNaoRecebidaInstaller;
    }
}