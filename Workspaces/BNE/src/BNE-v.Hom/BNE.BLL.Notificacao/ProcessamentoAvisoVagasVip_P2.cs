...
WHERE   Idf_Processamento_Jornal_Vagas_VIP IN ( {0} )";
        ...
        #region NotificacaoErro
        public void NotificacaoErro(string errorMessage)
        {
            ...
            //EmailService.EnviarEmail(ProcessKeyAvisoVagasVip, "atendimento@bne.com.br", "ramalho@bne.com.br", "Erro processamente Aviso Instântaneo de Vagas", sb.ToString());
            //EmailService.EnviarEmail(ProcessKeyAvisoVagasVip, "atendimento@bne.com.br", "brunoboscolo@employer.com.br", "Erro processamente Aviso Instântaneo de Vagas", sb.ToString());
