...
namespace BNE.BLL.Enumeradores
{
    public enum UsuarioSistemaTanque
    {
        ...
        QuemMeViu,
        [Display(Name = "SMS de validação de número de Celular")]
        ValidacaoCelCV,
        [Display(Name = "EnviaSMSCadSemEmail")]
        EnviaSMSCadSemEmail,
        [Display(Name = "SMSSolicitarAtualizacaoCurriculo")]
        SolicitarAtualizacaoCurriculo
    }
}
