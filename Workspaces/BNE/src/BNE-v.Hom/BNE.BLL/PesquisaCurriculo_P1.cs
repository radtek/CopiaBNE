...
namespace BNE.BLL
{
    public partial class PesquisaCurriculo // Tabela: TAB_Pesquisa_Curriculo
    {
        ...
        private Cidade _cidadeFormacao;
        private Int16? _numeroPeriodoFormacao;
        private Int16? _anoConclusaoFormacao;
        private SituacaoFormacao _situacaoCursoFormacao;
        private Escolaridade _escolaridadeFormacao;
        private Curso _cursoFormacao;
        private Fonte _fonteFormacao;
        private string _descricaoCursoFormacao;
        private string _descricaoFonteFormacao;
        private PesquisaCurriculo _pesquisaCurriculoOrigem;
        ...
        #region CidadeFormacao
        /// <summary>
        /// Campo opcional.
        /// </summary>
        public Cidade CidadeFormacao
        {
            get
            {
                return this._cidadeFormacao;
            }
            set
            {
                this._cidadeFormacao = value;
                this._modified = true;
            }
        }
        #endregion

        #region NumeroPeriodoFormacao
        /// <summary>
        /// Campo opcional.
        /// </summary>
        public Int16? NumeroPeriodoFormacao
        {
            get
            {
                return this._numeroPeriodoFormacao;
            }
            set
            {
                this._numeroPeriodoFormacao = value;
                this._modified = true;
            }
        }
        #endregion

        #region AnoConclusaoFormacao
        /// <summary>
        /// Campo opcional.
        /// </summary>
        public Int16? AnoConclusaoFormacao
        {
            get
            {
                return this._anoConclusaoFormacao;
            }
            set
            {
                this._anoConclusaoFormacao = value;
                this._modified = true;
            }
        }
        #endregion

        #region SituacaoCursoFormacao
        /// <summary>
        /// Campo opcional.
        /// </summary>
        public SituacaoFormacao SituacaoCursoFormacao
        {
            get
            {
                return this._situacaoCursoFormacao;
            }
            set
            {
                this._situacaoCursoFormacao = value;
                this._modified = true;
            }
        }
        #endregion

        #region EscolaridadeFormacao
        /// <summary>
        /// Campo opcional.
        /// </summary>
        public Escolaridade EscolaridadeFormacao
        {
            get
            {
                return this._escolaridadeFormacao;
            }
            set
            {
                this._escolaridadeFormacao = value;
                this._modified = true;
            }
        }
        #endregion

        #region CursoFormacao
        /// <summary>
        /// Campo opcional.
        /// </summary>
        public Curso CursoFormacao
        {
            get
            {
                return this._cursoFormacao;
            }
            set
            {
                this._cursoFormacao = value;
                this._modified = true;
            }
        }
        #endregion

        #region FonteFormacao
        /// <summary>
        /// Campo opcional.
        /// </summary>
        public Fonte FonteFormacao
        {
            get
            {
                return this._fonteFormacao;
            }
            set
            {
                this._fonteFormacao = value;
                this._modified = true;
            }
        }
        #endregion

        #region DescricaoCursoFormacao
        /// <summary>
        /// Tamanho do campo: 100.
        /// Campo opcional.
        /// </summary>
        public string DescricaoCursoFormacao
        {
            get
            {
                return this._descricaoCursoFormacao;
            }
            set
            {
                this._descricaoCursoFormacao = value;
                this._modified = true;
            }
        }
        #endregion

        #region DescricaoFonteFormacao
        /// <summary>
        /// Tamanho do campo: 100.
        /// Campo opcional.
        /// </summary>
        public string DescricaoFonteFormacao
        {
            get
            {
                return this._descricaoFonteFormacao;
            }
            set
            {
                this._descricaoFonteFormacao = value;
                this._modified = true;
            }
        }
        #endregion

        #region PesquisaCurriculoOrigem
        /// <summary>
        /// Campo opcional.
        /// </summary>
        public PesquisaCurriculo PesquisaCurriculoOrigem
        {
            get
            {
                return this._pesquisaCurriculoOrigem;
            }
            set
            {
                this._pesquisaCurriculoOrigem = value;
                this._modified = true;
            }
        }
        #endregion
        ...
        private List<SqlParameter> GetParameters()
        {
            ...
            parms.Add(new SqlParameter("@Idf_Cidade_Formacao", SqlDbType.Int, 4));
            parms.Add(new SqlParameter("@Num_Periodo_Formacao", SqlDbType.Int, 2));
            parms.Add(new SqlParameter("@Ano_Conclusao_Formacao", SqlDbType.Int, 2));
            parms.Add(new SqlParameter("@Idf_Situacao_Curso_Formacao", SqlDbType.Int, 2));
            parms.Add(new SqlParameter("@Idf_Escolaridade_Formacao", SqlDbType.Int, 4));
            parms.Add(new SqlParameter("@Idf_Curso_Formacao", SqlDbType.Int, 4));
            parms.Add(new SqlParameter("@Idf_Fonte_Formacao", SqlDbType.Int, 4));
            parms.Add(new SqlParameter("@Des_Curso_Formacao", SqlDbType.VarChar, 100));
            parms.Add(new SqlParameter("@Des_Fonte_Formacao", SqlDbType.VarChar, 100));
            parms.Add(new SqlParameter("@Idf_Pesquisa_Curriculo_Origem", SqlDbType.Int, 4));
            return (parms);
        }
        #endregion
        ...
        private void SetParameters(List<SqlParameter> parms)
        {
            ...
            if (this._numeroIdadeMin.HasValue)
                parms[47].Value = this._numeroIdadeMin;
            else
            ...
            if (!String.IsNullOrEmpty(this._descricaoAvaliacao))
                parms[49].Value = this._descricaoAvaliacao;
            else
                parms[49].Value = DBNull.Value;


            if (this._cidadeFormacao != null)
                parms[50].Value = this._cidadeFormacao.IdCidade;
            else
                parms[50].Value = DBNull.Value;


            if (this._numeroPeriodoFormacao.HasValue)
                parms[51].Value = this._numeroPeriodoFormacao;
            else
                parms[51].Value = DBNull.Value;


            if (this._anoConclusaoFormacao.HasValue)
                parms[52].Value = this._anoConclusaoFormacao;
            else
                parms[52].Value = DBNull.Value;


            if (this._situacaoCursoFormacao != null)
                parms[53].Value = this._situacaoCursoFormacao.IdSituacaoFormacao;
            else
                parms[53].Value = DBNull.Value;


            if (this._escolaridadeFormacao != null)
                parms[54].Value = this._escolaridadeFormacao.IdEscolaridade;
            else
                parms[54].Value = DBNull.Value;


            if (this._cursoFormacao != null)
                parms[55].Value = this._cursoFormacao.IdCurso;
            else
                parms[55].Value = DBNull.Value;


            if (this._fonteFormacao != null)
                parms[56].Value = this._fonteFormacao.IdFonte;
            else
                parms[56].Value = DBNull.Value;


            if (!String.IsNullOrEmpty(this._descricaoCursoFormacao))
                parms[57].Value = this._descricaoCursoFormacao;
            else
                parms[57].Value = DBNull.Value;


            if (!String.IsNullOrEmpty(this._descricaoFonteFormacao))
                parms[58].Value = this._descricaoFonteFormacao;
            else
                parms[58].Value = DBNull.Value;


            if (this._pesquisaCurriculoOrigem != null)
                parms[59].Value = this._pesquisaCurriculoOrigem.IdPesquisaCurriculo;
            else
        ...
        private static bool SetInstance(IDataReader dr, PesquisaCurriculo objPesquisaCurriculo, bool dispose = true)
        {
            try
            {
                if (dr.Read())
                {
                    ...
                    if (dr["Idf_Cidade_Formacao"] != DBNull.Value)
                        objPesquisaCurriculo._cidadeFormacao = new Cidade(Convert.ToInt32(dr["Idf_Cidade_Formacao"]));
                    if (dr["Num_Periodo_Formacao"] != DBNull.Value)
                        objPesquisaCurriculo._numeroPeriodoFormacao = Convert.ToInt16(dr["Num_Periodo_Formacao"]);
                    if (dr["Ano_Conclusao_Formacao"] != DBNull.Value)
                        objPesquisaCurriculo._anoConclusaoFormacao = Convert.ToInt16(dr["Ano_Conclusao_Formacao"]);
                    if (dr["Idf_Situacao_Curso_Formacao"] != DBNull.Value)
                        objPesquisaCurriculo._situacaoCursoFormacao = new SituacaoFormacao(Convert.ToInt16(dr["Idf_Situacao_Curso_Formacao"]));
                    if (dr["Idf_Escolaridade_Formacao"] != DBNull.Value)
                        objPesquisaCurriculo._escolaridadeFormacao = new Escolaridade(Convert.ToInt32(dr["Idf_Escolaridade_Formacao"]));
                    if (dr["Idf_Curso_Formacao"] != DBNull.Value)
                        objPesquisaCurriculo._cursoFormacao = new Curso(Convert.ToInt32(dr["Idf_Curso_Formacao"]));
                    if (dr["Idf_Fonte_Formacao"] != DBNull.Value)
                        objPesquisaCurriculo._fonteFormacao = new Fonte(Convert.ToInt32(dr["Idf_Fonte_Formacao"]));
                    if (dr["Des_Curso_Formacao"] != DBNull.Value)
                        objPesquisaCurriculo._descricaoCursoFormacao = Convert.ToString(dr["Des_Curso_Formacao"]);
                    if (dr["Des_Fonte_Formacao"] != DBNull.Value)
                        objPesquisaCurriculo._descricaoFonteFormacao = Convert.ToString(dr["Des_Fonte_Formacao"]);
                    if (dr["Idf_Pesquisa_Curriculo_Origem"] != DBNull.Value)
                        objPesquisaCurriculo._pesquisaCurriculoOrigem = new PesquisaCurriculo(Convert.ToInt32(dr["Idf_Pesquisa_Curriculo_Origem"]));
