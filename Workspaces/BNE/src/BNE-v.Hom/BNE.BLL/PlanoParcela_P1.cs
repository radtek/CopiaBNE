...
namespace BNE.BLL
{
    public partial class PlanoParcela // Tabela: BNE_Plano_Parcela
    {
        ...
        {
            get { return this._idPlanoParcela; }
        }
        ...
        {
            get { return this._planoAdquirido; }
            set
            {
        ...
        {
            get { return this._dataPagamento; }
            set
            {
        ...
        {
            get { return this._planoParcelaSituacao; }
            set
            {
        ...
        {
            get { return this._numeroDesconto; }
            set
            {
        ...
        {
            get { return this._quantidadeSMSTotal; }
            set
            {
        ...
        {
            get { return this._quantidadeSMSLiberada; }
            set
            {
        ...
        {
            get { return this._dataEmissaoNotaAntecipada; }
            set
            {
        ...
        [Display(Name = "Email de Envio de Boleto")]
        public string EmailEnvioBoleto {
            get { return _emailEnvioBoleto; }
            set
            {
        ...
        #region Consultas
        private const string SPINSERT = "INSERT INTO BNE_Plano_Parcela (Idf_Plano_Adquirido, Dta_Cadastro, Dta_Pagamento, Vlr_Parcela, Flg_Inativo, Idf_Plano_Parcela_Situacao, Num_Desconto, Qtd_SMS_Total, Qtd_SMS_Liberada,Dta_Emissao_Nota_Antecipada, Eml_Envio_Boleto) VALUES (@Idf_Plano_Adquirido, @Dta_Cadastro, @Dta_Pagamento, @Vlr_Parcela, @Flg_Inativo, @Idf_Plano_Parcela_Situacao, @Num_Desconto, @Qtd_SMS_Total, @Qtd_SMS_Liberada,@Dta_Emissao_Nota_Antecipada, @Eml_Envio_Boleto);SET @Idf_Plano_Parcela = SCOPE_IDENTITY();";
        private const string SPUPDATE = "UPDATE BNE_Plano_Parcela SET Idf_Plano_Adquirido = @Idf_Plano_Adquirido, Dta_Cadastro = @Dta_Cadastro, Dta_Pagamento = @Dta_Pagamento, Vlr_Parcela = @Vlr_Parcela, Flg_Inativo = @Flg_Inativo, Idf_Plano_Parcela_Situacao = @Idf_Plano_Parcela_Situacao, Num_Desconto = @Num_Desconto, Qtd_SMS_Total = @Qtd_SMS_Total, Qtd_SMS_Liberada = @Qtd_SMS_Liberada, Dta_Emissao_Nota_Antecipada = @Dta_Emissao_Nota_Antecipada, Eml_Envio_Boleto = @Eml_Envio_Boleto WHERE Idf_Plano_Parcela = @Idf_Plano_Parcela";
        private const string SPDELETE = "DELETE FROM BNE_Plano_Parcela WHERE Idf_Plano_Parcela = @Idf_Plano_Parcela";
        private const string SPSELECTID = "SELECT * FROM BNE_Plano_Parcela with(nolock) WHERE Idf_Plano_Parcela = @Idf_Plano_Parcela";
        #endregion
        ...
        private List<SqlParameter> GetParameters()
        {
            ...
            parms.Add(new SqlParameter("@Eml_Envio_Boleto", SqlDbType.Text, 100));
        ...
        private void SetParameters(List<SqlParameter> parms)
        {
            ...
            parms[11].Value = this._emailEnvioBoleto.HasValue() ? this._emailEnvioBoleto : parms[11].Value = string.Empty; 
            ...
            try
            {
                if (dr.Read())
                {
                    ...
                    if (dr["Eml_Envio_Boleto"] != DBNull.Value)
                        objPlanoParcela._emailEnvioBoleto = dr["Eml_Envio_Boleto"].ToString();
                    return true;
                }
                else
                {
