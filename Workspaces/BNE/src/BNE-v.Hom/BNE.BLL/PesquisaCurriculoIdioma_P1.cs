...
namespace BNE.BLL
{
    public partial class PesquisaCurriculoIdioma // Tabela: TAB_Pesquisa_Curriculo_Idioma
    {
        ...
        #region Consultas
        private const string SPINSERT = "INSERT INTO TAB_Pesquisa_Curriculo_Idioma (Idf_Pesquisa_Curriculo, Idf_Idioma, Idf_Nivel_Idioma) VALUES (@Idf_Pesquisa_Curriculo, @Idf_Idioma, @Idf_Nivel_Idioma);SET @Idf_Pesquisa_Curriculo_Idioma = SCOPE_IDENTITY();";
        private const string SPUPDATE = "UPDATE TAB_Pesquisa_Curriculo_Idioma SET Idf_Pesquisa_Curriculo = @Idf_Pesquisa_Curriculo, Idf_Idioma = @Idf_Idioma, Idf_Nivel_Idioma = @Idf_Nivel_Idioma WHERE Idf_Pesquisa_Curriculo_Idioma = @Idf_Pesquisa_Curriculo_Idioma";
        ...
        private const string SPSELECTID = "SELECT * FROM TAB_Pesquisa_Curriculo_Idioma WITH(NOLOCK) WHERE Idf_Pesquisa_Curriculo_Idioma = @Idf_Pesquisa_Curriculo_Idioma";
        #endregion
        ...
        public static IDataReader LoadDataReader(string colunaOrdenacao, string direcaoOrdenacao, int paginaCorrente, int tamanhoPagina, out int totalRegistros)
        {
            ...
            string SPSELECTPAG = "SELECT ROW_NUMBER() OVER (ORDER BY " + colunaOrdenacao + " " + direcaoOrdenacao + ") AS RowID, Pes.Idf_Pesquisa_Curriculo_Idioma, Pes.Idf_Pesquisa_Curriculo, Pes.Idf_Idioma, Pes.Idf_Nivel_Idioma FROM TAB_Pesquisa_Curriculo_Idioma Pes";
        ...
        /// <returns>Verdadeiro ou falso informando se a operação foi executada com sucesso.</returns>
        /// <remarks>Mailson</remarks>
        private static bool SetInstance(IDataReader dr, PesquisaCurriculoIdioma objPesquisaCurriculoIdioma, bool dispose = true)
        {
            try
            {
                if (dr.Read())
                {
                    ...
                    if (dr["Idf_Nivel_Idioma"] != DBNull.Value)
                        objPesquisaCurriculoIdioma._nivelIdioma = new NivelIdioma(Convert.ToInt32(dr["Idf_Nivel_Idioma"]));
