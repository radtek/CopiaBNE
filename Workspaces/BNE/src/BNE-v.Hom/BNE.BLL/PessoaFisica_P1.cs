            ...
            try
            {
                if (dr.Read())
                {
                    ...
                    if (dr["Flg_WhatsApp"] != DBNull.Value)
                        objPessoaFisica._flagWhatsApp = Convert.ToBoolean(dr["Flg_WhatsApp"]);
