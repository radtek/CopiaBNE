...
namespace BNE.BLL
{
    public partial class UsuarioFilialContato // Tabela: BNE_Usuario_Filial_Contato
    {
        ...
        /// Campo opcional.
        /// </summary>
        public bool? FlagWhatsApp
        {
            get
            {
                return this._flagWhatsApp;
            }
            set
            {
                this._flagWhatsApp = value;
                this._modified = true;
            }
        }
        #endregion
        ...
        #region Consultas
        private const string SPINSERT = "INSERT INTO BNE_Usuario_Filial_Contato (Nme_Contato, Idf_Funcao, Des_Funcao, Idf_Filial, Eml_Contato, DDD_Telefone, Num_Telefone, Dta_Cadastro, Flg_Inativo, Num_CPF, Dta_Nascimento, Idf_Sexo, Num_Ramal, Num_DDD_Celular, Num_Celular, Flg_WhatsApp) VALUES (@Nme_Contato, @Idf_Funcao, @Des_Funcao, @Idf_Filial, @Eml_Contato, @DDD_Telefone, @Num_Telefone, @Dta_Cadastro, @Flg_Inativo, @Num_CPF, @Dta_Nascimento, @Idf_Sexo, @Num_Ramal, @Num_DDD_Celular, @Num_Celular, @Flg_WhatsApp);SET @Idf_Usuario_Filial_Contato = SCOPE_IDENTITY();";
        private const string SPUPDATE = "UPDATE BNE_Usuario_Filial_Contato SET Nme_Contato = @Nme_Contato, Idf_Funcao = @Idf_Funcao, Des_Funcao = @Des_Funcao, Idf_Filial = @Idf_Filial, Eml_Contato = @Eml_Contato, DDD_Telefone = @DDD_Telefone, Num_Telefone = @Num_Telefone, Dta_Cadastro = @Dta_Cadastro, Flg_Inativo = @Flg_Inativo, Num_CPF = @Num_CPF, Dta_Nascimento = @Dta_Nascimento, Idf_Sexo = @Idf_Sexo, Num_Ramal = @Num_Ramal, Num_DDD_Celular = @Num_DDD_Celular, Num_Celular = @Num_Celular, Flg_WhatsApp = @Flg_WhatsApp  WHERE Idf_Usuario_Filial_Contato = @Idf_Usuario_Filial_Contato";
        ...
        private List<SqlParameter> GetParameters()
        {
            ...
            parms.Add(new SqlParameter("@Flg_WhatsApp", SqlDbType.Bit, 1));
            return (parms);
        }
        #endregion
        ...
        private void SetParameters(List<SqlParameter> parms)
        {
            ...
            if (this._flagWhatsApp.HasValue)
                parms[16].Value = this._flagWhatsApp;
            else
            ...
            try
            {
                if (dr.Read())
                {
                    ...
                    if (dr["Flg_WhatsApp"] != DBNull.Value)
                        objUsuarioFilialContato._flagWhatsApp = Convert.ToBoolean(dr["Flg_WhatsApp"]);
