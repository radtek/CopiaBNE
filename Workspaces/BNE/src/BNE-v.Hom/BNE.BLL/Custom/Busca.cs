    ...
    public class Busca
    {
        ...
        FROM    ( SELECT    PF.Idf_Pessoa_Fisica ,
                  ...
                  FROM      BNE.TAB_Pessoa_Fisica PF WITH ( NOLOCK )
                            ...
                            LEFT JOIN BNE.TAB_Usuario_Filial_Perfil UFP WITH ( NOLOCK ) ON PF.Idf_Pessoa_Fisica = UFP.Idf_Pessoa_Fisica
                            LEFT JOIN BNE.BNE_Pagamento P WITH ( NOLOCK ) ON UFP.Idf_Usuario_Filial_Perfil = P.Idf_Usuario_Filial_Perfil
                            JOIN BNE.BNE_Boleto_Bancario BB WITH(NOLOCK) ON BB.Num_Nosso_Numero = P.Des_Identificador
                  WHERE     BB.Num_Nosso_Numero LIKE '%' + @NumeroBoleto
        ...
        FROM    BNE.BNE_Pagamento pg WITH (NOLOCK) 
				JOIN BNE.TAB_Usuario_Filial_Perfil FP WITH(NOLOCK) ON FP.Idf_Usuario_Filial_Perfil = pg.Idf_Usuario_Filial_Perfil
        ...
        WHERE  pg.Des_Identificador LIKE @Cod_TID";
        #endregion
