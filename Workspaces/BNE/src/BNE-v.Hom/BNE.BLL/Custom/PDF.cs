    ...
    public class PDF
    {
        ...
        public static byte[] GerarPdfAPartirdoHtml(string HTML)
        {
            try
            {
                ...
                htmlToPdf.CustomWkHtmlArgs = "--encoding UTF-8 --load-media-error-handling ignore"; //https://www.nrecosite.com/pdf_generator_net.aspx#faq6 ou https://github.com/wkhtmltopdf/wkhtmltopdf/issues/2073
                htmlToPdf.Margins = new PageMargins { Top = 1, Bottom = 1, Left = 1, Right = 1 };
