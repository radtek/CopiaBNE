...
namespace BNE.BLL.Custom
{
    ...
    public static class SitemapHelper
    {
        ...
        public static string MontarUrlVagaComPesquisa(string nomeFuncao, string nomeAreaBNE, string nomeCidade, string siglaEstado, int identificadorVaga, int codigoPesquisa)
        {
            var url = MontarUrlVaga(nomeFuncao, nomeAreaBNE, nomeCidade, siglaEstado, identificadorVaga);
