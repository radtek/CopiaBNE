...
namespace BNE.BLL
{
	public partial class CurriculoObservacao // Tabela: BNE_Curriculo_Observacao
	{
        ...
        /// </summary>
        public static void SalvarCRM(string descricao, Curriculo objCurriculo, string nomeProcessoSistema, SqlTransaction trans = null)
        {
            SalvarCRM(descricao, objCurriculo, null, nomeProcessoSistema, trans);
        }
        public static void SalvarCRM(string descricao, Curriculo objCurriculo, UsuarioFilialPerfil objUsuarioGerador, SqlTransaction trans = null)
        {
            SalvarCRM(descricao, objCurriculo, objUsuarioGerador, null, trans);
        }
        private static void SalvarCRM(string descricao, Curriculo objCurriculo, UsuarioFilialPerfil objUsuarioGerador, string nomeProcessoSistema, SqlTransaction trans = null)
        {
