...
namespace BNE.BLL
{
    public partial class CampanhaRecrutamento // Tabela: BNE_Campanha_Recrutamento
    {
        ...
        private decimal? _numeroDDDTelefoneContato;
        private decimal? _NUMTelefoneContato;
        ...
        #region NumeroDDDTelefoneContato
        /// <summary>
        /// Campo opcional.
        /// </summary>
        public decimal? NumeroDDDTelefoneContato
        {
            get
            {
                return this._numeroDDDTelefoneContato;
            }
            set
            {
                this._numeroDDDTelefoneContato = value;
                this._modified = true;
            }
        }
        #endregion

        #region NUMTelefoneContato
        /// <summary>
        /// Campo opcional.
        /// </summary>
        public decimal? NUMTelefoneContato
        {
            get
            {
                return this._NUMTelefoneContato;
            }
            set
            {
                this._NUMTelefoneContato = value;
                this._modified = true;
            }
        }
        #endregion
        ...
        #region Consultas
        private const string SPINSERT = "INSERT INTO BNE_Campanha_Recrutamento (Qtd_Retorno, Idf_Tipo_Retorno_Campanha_Recrutamento, Idf_Vaga, Dta_Cadastro, Idf_Pesquisa_Curriculo, Idf_Motivo_Campanha_Finalizada, Num_DDD_Telefone_Contato, NUM_Telefone_Contato) VALUES (@Qtd_Retorno, @Idf_Tipo_Retorno_Campanha_Recrutamento, @Idf_Vaga, @Dta_Cadastro, @Idf_Pesquisa_Curriculo, @Idf_Motivo_Campanha_Finalizada, @Num_DDD_Telefone_Contato, @NUM_Telefone_Contato);SET @Idf_Campanha_Recrutamento = SCOPE_IDENTITY();";
        private const string SPUPDATE = "UPDATE BNE_Campanha_Recrutamento SET Qtd_Retorno = @Qtd_Retorno, Idf_Tipo_Retorno_Campanha_Recrutamento = @Idf_Tipo_Retorno_Campanha_Recrutamento, Idf_Vaga = @Idf_Vaga, Dta_Cadastro = @Dta_Cadastro, Idf_Pesquisa_Curriculo = @Idf_Pesquisa_Curriculo, Idf_Motivo_Campanha_Finalizada = @Idf_Motivo_Campanha_Finalizada, Num_DDD_Telefone_Contato = @Num_DDD_Telefone_Contato, NUM_Telefone_Contato = @NUM_Telefone_Contato WHERE Idf_Campanha_Recrutamento = @Idf_Campanha_Recrutamento";
        ...
        private List<SqlParameter> GetParameters()
        {
            ...
            parms.Add(new SqlParameter("@Num_DDD_Telefone_Contato", SqlDbType.Decimal, 5));
            parms.Add(new SqlParameter("@NUM_Telefone_Contato", SqlDbType.Decimal, 5));
            return (parms);
        }
        #endregion
        ...
        private void SetParameters(List<SqlParameter> parms)
        {
            ...
            if (this._numeroDDDTelefoneContato.HasValue)
                parms[7].Value = this._numeroDDDTelefoneContato;
            else
                parms[7].Value = DBNull.Value;


            if (this._NUMTelefoneContato.HasValue)
                parms[8].Value = this._NUMTelefoneContato;
            else
        ...
        public static IDataReader LoadDataReader(string colunaOrdenacao, string direcaoOrdenacao, int paginaCorrente, int tamanhoPagina, out int totalRegistros)
        {
            ...
            string SPSELECTPAG = "SELECT ROW_NUMBER() OVER (ORDER BY " + colunaOrdenacao + " " + direcaoOrdenacao + ") AS RowID, Cam.Idf_Campanha_Recrutamento, Cam.Qtd_Retorno, Cam.Idf_Tipo_Retorno_Campanha_Recrutamento, Cam.Idf_Vaga, Cam.Dta_Cadastro, Cam.Idf_Pesquisa_Curriculo, Cam.Idf_Motivo_Campanha_Finalizada, Cam.Num_DDD_Telefone_Contato, Cam.NUM_Telefone_Contato FROM BNE_Campanha_Recrutamento Cam";
            ...
            try
            {
                if (dr.Read())
                {
                    ...
                    if (dr["Num_DDD_Telefone_Contato"] != DBNull.Value)
                        objCampanhaRecrutamento._numeroDDDTelefoneContato = Convert.ToDecimal(dr["Num_DDD_Telefone_Contato"]);
                    if (dr["NUM_Telefone_Contato"] != DBNull.Value)
                        objCampanhaRecrutamento._NUMTelefoneContato = Convert.ToDecimal(dr["NUM_Telefone_Contato"]);
