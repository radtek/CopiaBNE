...
namespace BNE.BLL
{
    public partial class PlanoAdquiridoDetalhes // Tabela: BNE_Plano_Adquirido_Detalhes
    {
        ...
        /// Campo obrigatório.
        /// </summary>
        [Display(Name = "Responsável Pelo Plano")]
        ...
        /// </summary>
        /// 
        [Display(Name = "Observação do Plano")]
        ...
        private List<SqlParameter> GetParameters()
        {
            ...
            parms.Add(new SqlParameter("@Eml_Envio_Boleto", SqlDbType.VarChar, 200));
        ...
        private void SetParameters(List<SqlParameter> parms)
        {
            ...
            if (!String.IsNullOrEmpty(this._numeroResDDDTelefone))
                parms[5].Value = this._numeroResDDDTelefone;
            else
                parms[5].Value = DBNull.Value;


            if (!String.IsNullOrEmpty(this._numeroResTelefone))
        ...
        /// <returns>Verdadeiro ou falso informando se a operação foi executada com sucesso.</returns>
        /// <remarks>Mailson</remarks>
        private static bool SetInstance(IDataReader dr, PlanoAdquiridoDetalhes objPlanoAdquiridoDetalhes, bool dispose = true)
        {
            try
            {
                if (dr.Read())
