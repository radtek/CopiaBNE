...
namespace BNE.Web
{
    public partial class PesquisaCurriculoAvancada : BasePage
    {
        ...
        private BLL.PesquisaCurriculo Buscar()
        {
            ...
            var listaDeficiencia = rcbPCD.GetCheckedItems().Select(item => new PesquisaCurriculoDeficiencia {
                 Deficiencia = new Deficiencia(Convert.ToInt32(item.Value))
                }).ToList();
            ...
            objPesquisaCurriculo.Salvar(listaFuncoes, listaIdioma, listaDisponibilidade, listaCampoBuscaPalavraChave, listaDeficiencia, ucEstagiarioFuncao.CheckBoxEstagiarioSelecionado, ucEstagiarioFuncao.CheckBoxAprendizSelecionado);
        ...
        private void Inicializar()
        {
            ...
            UIHelper.CarregarDropDownList(rcbEstado, Estado.Listar(), new ListItem("Qualquer", "0"));
        ...
        private void LimparCampos()
        {
            ...
            pnlBairroTexto.CssClass = "visible";
        ...
        private void RecuperarBairros(string cidade, string estado)
        {
            try
            {
                ...
                var url = "http://wsintegracao.bne.com.br/cep/api/bairro/getbycidade/São Paulo/SP";
                ...
                using (var client = new HttpClient())
                {
                    ...
                    if (response.IsSuccessStatusCode)
                    {
                        ...
                        if (jsonObject != null)
                        {
                            ...
                            pnlBairroTexto.CssClass = "Invisible";
                        }
                        else
                        {
                            pnlBairroZona.Visible = false;
            ...
            try
            {
                ...
                if (objPesquisaCurriculo != null)
                {
                    try
                    {
                        ...
                        objVaga.SalvarVaga(listaDisponibilidade, listaVagaTipoVinculo, null, null, false, 
