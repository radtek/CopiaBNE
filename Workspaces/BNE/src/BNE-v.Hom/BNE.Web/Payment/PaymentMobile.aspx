        ...
        <div class="fluxo-vip">
            ...
            <section id="payment-stage" next-color="#e1e1e1">
                            ...
                            <ContentTemplate>
                                ...
                                <div class="payment-method-desc row panel-collapse collapse" id="credito">
                                    ...
                                    <div class="col-xs-12 form-group" id="campo_cartao_credito">
                                        ...
                                        <asp:TextBox runat="server" ID="txtNumeroCartao" CssClass="form-control input-lg" placeholder="Número do Cartão" MaxLength="16" />
                ...
                <div id="mobile-payment-footer">
                    <p>Banco Nacional de Empregos © 2017</p>
                </div>
            </section>
        </div>
    </form>
