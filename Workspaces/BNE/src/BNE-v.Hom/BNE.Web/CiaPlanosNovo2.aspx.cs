...
namespace BNE.Web
{
    public partial class CiaPlanosNovo2 : BasePagePagamento
    {
        ...
        public void GerarPDFContrato(string razaoSocial, decimal numCNPJ, string descRua, string numeroRua, string estado,
                                     ...
                                     int quantidadeSms, int quantidadeTanque, int quantidadeUsuarios, int idTemplateContrato)
        {
            ...
            var pdf = GerarContratoPlano.ContratoPadraoPdf(razaoSocial, numCNPJ, descRua, numeroRua, estado,
                                                           ...
                                                           numeroParcelas, tempoPlano, quantidadeSms, quantidadeTanque, quantidadeUsuarios, idTemplateContrato);
            ...
            if (idUsuario > 0)
            {
                ...
                if (base.PagamentoIdentificadorPlano.HasValue)
                {
                    ...
                    if (objPlano.FlagEnviarContrato)
                    {
                        ...
                        GerarPDFContrato(_razaoSocial, _numCNPJ, _descRua, _numeroRua, _estado, _nomeCidade, _numeroCEP, _nomePessoa, _numRG, _numCPF, _valorPlano, _numeroParcelas, _tempoPlano, _quantidadeVisualizacoes, _quantidadeSms, quantidadeSMSTanque, _quantidadeUsuarios, objPlano.TemplateContrato.IdTemplateContrato);
                    }
                    else
                    {
