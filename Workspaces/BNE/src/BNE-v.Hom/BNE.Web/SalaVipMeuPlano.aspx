        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlPlano" runat="server">
                <asp:UpdatePanel ID="upMeuPlano" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <div id="salavip_meuplano">
                            <section id="salavip_meuplano_tpplano">
                                <div>
                                    <div class="salavip_meuplano_tpplano__prdplano">
                                        Data de aquisição: <span>
                                            <asp:Label ID="lblDataPlanoAdquiridoValor" runat="server"></asp:Label></span>
                                    </div>

                                    <asp:Panel ID="pnlPlanoValidade" runat="server">
                                        <div class="salavip_meuplano_tpplano__prdplano">
                                            Data de vencimento: <span>
                                                <asp:Label ID="lblPlanoValidadeValor" runat="server"></asp:Label></span>
                                        </div>
                                    </asp:Panel>
                                    ...
                                    <asp:Label ID="lblPlanoValor" Text="Valor do Plano: " runat="server" Visible="false" CssClass="label_campo"></asp:Label>
                                    <asp:Label ID="lblPlanoValorTexto" runat="server" Visible="false"></asp:Label>

                                    <asp:Label ID="lblTipoPlano" runat="server" Text="Plano de Acesso: " Visible="false" CssClass="label_campo"></asp:Label>
                                    <asp:Label ID="lblTipoPlanoValor" runat="server" Visible="false"></asp:Label>
                                </div>
                                <div>
                                    <asp:Button id="btnCancelarAssinatura" CssClass="btn btn-default salavip_meuplano_cancelar" runat="server" Text="Cancelar Plano" OnClick="btnEfetivarCancelamentoAssinatura_Click" OnClientClick="OcultarBtnCancelar();" visible="false" />
                                </div>
                            </section>
                            <asp:HiddenField ID="hdfDiasVip" runat="server" />
                            <section id="salavip_meuplano_extrato">
                                <div class="salavip_meuplano_extrato__title">
                                    <span runat="server" id="spanPerido">Seu extrato dos últimos dias desde a<strong> data da assinatura</strong></span>
                                    <span runat="server" id="spanExtrato">Seu extrato no período</span>
                                    <span runat="server" id="spanDdl">
                                        <asp:DropDownList class="form-control salavip_meuplano_extrato__title__form-control" AutoPostBack="true" runat="server" ID="ddlPeriodo" OnSelectedIndexChanged="ddlPeriodo_SelectedIndexChanged">
                                            <asp:ListItem Value="0" Text="Últimos 30 dias"></asp:ListItem>
                                            <asp:ListItem Value="1" Text="Desde a data da assinatura"></asp:ListItem>
                                        </asp:DropDownList>
                                    </span>
                                </div>
                                <ul class="salavip_meuplano_extrato__itemslist">
                                    <li class="salavip_meuplano_extrato__item">
                                        <div class="salavip_meuplano_extrato__item_num">
                                            <span class="Text_numero" id="lblVisualizacoesCurriculo_mes" runat="server"></span>
                                        </div>
                                        <div class="salavip_meuplano_extrato__item_details">
                                            <div>Visualizações em seu currículo</div>
                                        </div>
                                    </li>
                                    <li class="salavip_meuplano_extrato__item">
                                        <div class="salavip_meuplano_extrato__item_num">
                                            <span id="lblJornalRecebido_mes" runat="server"></span>
                                        </div>
                                        <div class="salavip_meuplano_extrato__item_details">
                                            <div>Vagas recebidas pelo Jornal de Vagas</div>
                                        </div>
                                    </li>
                                    <li class="salavip_meuplano_extrato__item">
                                        <div class="salavip_meuplano_extrato__item_num">
                                            <span  id="lblVagasCandidatadas_mes" runat="server"></span>
                                        </div>
                                        <div class="salavip_meuplano_extrato__item_details">
                                            <div>Vagas candidatadas</div>
                                        </div>
                                    </li>
                                    <li class="salavip_meuplano_extrato__item">
                                        <div class="salavip_meuplano_extrato__item_num">
                                            <span  runat="server" id="lblVagasVisualizadas_mes"></span>
                                        </div>
                                        <div class="salavip_meuplano_extrato__item_details">
                                            <div>Vagas visualizadas</div>
                                        </div>
                                    </li>
                                    <li class="salavip_meuplano_extrato__item">
                                        <div class="salavip_meuplano_extrato__item_num">
                                            <span  runat="server" id="lblApareceuNasBuscas_mes"></span>
                                        </div>
                                        <div class="salavip_meuplano_extrato__item_details">
                                            <div>Apareceu nas buscas</div>
                                        </div>
                                    </li>
                                    <li class="salavip_meuplano_extrato__item">
                                        <div class="salavip_meuplano_extrato__item_num">
                                            <span runat="server" id="lblEmpresasBuscaramSeuPerfil_mes"></span>
                                        </div>
                                        <div class="salavip_meuplano_extrato__item_details">
                                            <div>Empresas buscaram seu perfil</div>
                                        </div>
                                    </li>
                                    <li class="salavip_meuplano_extrato__item">
                                        <div class="salavip_meuplano_extrato__item_num">
                                            <span runat="server" id="lblVagasNaoVisualizadas_mes"></span>
                                        </div>
                                        <div class="salavip_meuplano_extrato__item_details">
                                            <div>Vagas não visualizadas</div>
                                        </div>
                                    </li>
                                    <li class="salavip_meuplano_extrato__item">
                                        <div class="salavip_meuplano_extrato__item_num">
                                            <span  runat="server" id="lblBuscasPeloSeuPerfil_mes"></span>
                                        </div>
                                        <div class="salavip_meuplano_extrato__item_details">
                                            <div>Buscas pelo seu perfil</div>
                                        </div>
                                    </li>
                                    <li class="salavip_meuplano_extrato__item">
                                        <div class="salavip_meuplano_extrato__item_num">
                                            <span runat="server" id="lblVagasNoSeuPerfil_mes"></span>
                                        </div>
                                        <div class="salavip_meuplano_extrato__item_details">
                                            <div>Vagas no seu perfil</div>
                                        </div>
                                    </li>
                                </ul>
                            </section>
                ...
                <asp:Panel ID="pnlBotoes" runat="server" CssClass="painel_botoes">
                    <asp:Button ID="btnVoltar" runat="server" CssClass="btn btn-default salavip_meuplano_cancelar" Text="Voltar" CausesValidation="false"
                ...
                <div id="divConteudoCancelarAssinatura" runat="server" class="modal-body" style="font-size: 16px; color: #666">
                    ...
                    <div style="margin-top: 20px;">
                        ...
                        <div style="margin-left: 20px;">
                            <asp:Button ID="Button2" CssClass="btn_sim_cancelarAss" runat="server" Text="Sim" OnClick="btnEfetivarCancelamentoAssinatura_Click" OnClientClick="OcultarBtnCancelar();" />
                        </div>
                    </div>
                ...
                Sua opinião é muito importante para nós.
                        ...
                        <div class="cancelation-question row">
                            ...
                            <div>
                                ...
                                <asp:CheckBoxList runat="server" ID="cblMotivoCancelar" TextAlign="Right" onclick="selectdItem();" RepeatDirection="Vertical">
                ...
                <div class="mobile-cancelation">
                    ...
                    <section id="etapa04">
                        ...
                        <div class="cancelation-title">
                         ...
                         Seu acesso estará disponível até <strong>
                             <asp:Label ID="lblDataVencimentoVip" runat="server"></asp:Label></strong>.
                            </h4>--%>
                              <h4>Para completar o cancelamento <br /> ligue para o telefone</br>
                                  41 3037-9416 <strong>
                                      <h5> Horário de atendimento de <br>Segunda a sexta das 8:00 as 18:00</h5>
                             </strong>
                            </h4>
                        </div>
                        <div class="cancelation-actions ">
