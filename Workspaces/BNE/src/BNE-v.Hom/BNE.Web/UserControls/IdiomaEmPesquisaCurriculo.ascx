...
<!-- Combo Box Idiomas -->
    ...
    <asp:UpdatePanel ID="upDDL" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <div class="col-md-5">
                <telerik:RadComboBox id="rcbIdioma" runat="server"  CssClass="" ></telerik:RadComboBox>
            </div>
            <div class="col-md-5">
                <telerik:RadComboBox id="rcbNivel" runat="server" ></telerik:RadComboBox>
            </div>
            <div class="col-md-2">
                <asp:Button runat="server" ID="btnAdicionar" OnClick="btnAdicionar_Click" class="adicionar_alert btn btn-success" Text="Adicionar"></asp:Button>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
    <div >            
