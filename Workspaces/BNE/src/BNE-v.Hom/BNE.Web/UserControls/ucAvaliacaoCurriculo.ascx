        ...
        <ContentTemplate>
            <Employer:EmployerGrid ID="gvClassificacoes" runat="server" DataKeyNames="Idf_Curriculo_Classificacao, Idf_Usuario_Filial_Perfil"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Usuário" DataField="Nme_Pessoa" NullDisplayText="" />
                    <asp:TemplateField HeaderText="Ações" HeaderStyle-CssClass="rgHeader centro">
                        <ItemTemplate>
                            ...
                            <asp:ImageButton ID="btiEditar" runat="server" ToolTip="Editar" AlternateText="Editar"
                                ...
                                ImageUrl="~/img/icone_editar_16x16.gif" CommandName="Atualizar" Visible='<%# BotaoVisivel(Convert.ToInt32(  (Eval("Idf_Usuario_Filial_Perfil") is DBNull)?0:Eval("Idf_Usuario_Filial_Perfil") )) %>' />
                             ...
                             <asp:ImageButton ID="btiExcluir" runat="server" AlternateText="Excluir" CausesValidation="False"
                                ...
                                CommandName="Inativar" Visible='<%# BotaoVisivel(Convert.ToInt32(   (Eval("Idf_Usuario_Filial_Perfil") is DBNull)?0:Eval("Idf_Usuario_Filial_Perfil") )) %>' />
                        </ItemTemplate>
