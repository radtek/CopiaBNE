...
<style>
    input.spanddd, input.spandddMsg {
        width: 15% !important;
        /*margin-left: 35px;*/
    }
...
<div id="myModalComercial" class="modal fade webcallback" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                ...
                <div class="modal-content">
                    ...
                    <div id="divJanelaLigacao" runat="server" class="modal-body" style="font-size: 16px; color: #666">
                        ...
                        <div class="input-group">
                            ...
                            <br />
                            <div>DDD: &nbsp&nbsp&nbsp&nbsp&nbsp Telefone:</div>
...
<div id="myModalMensagem" class="modal fade modal-size" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
