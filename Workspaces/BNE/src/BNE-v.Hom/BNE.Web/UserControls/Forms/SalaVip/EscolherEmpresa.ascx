...
<div class="painel_padrao_sala_vip">
    ...
    <asp:UpdatePanel ID="upGvEscolherEmpresa" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <div class="boxFiltro">
                <label class="lblFiltro">Cidade</label>
                <telerik:RadTextBox runat="server" ID="txtCidade" Columns="40" TextMode="SingleLine"
                    ValidationGroup="Filtrar" EmptyMessage="Informe a cidade"
                    CssClass="textbox_filtro_busca">
                </telerik:RadTextBox>
            </div>
            <div class="boxFiltro">
                <label class="lblFiltro">Ramo de Atividade</label>
                <telerik:RadTextBox runat="server" ID="txtRamoAtividade" Columns="40" TextMode="SingleLine"
                    ValidationGroup="Filtrar" EmptyMessage="Informe o ramo de atividade"
                    CssClass="textbox_filtro_busca">
                </telerik:RadTextBox>
            </div>
            <div class="boxFiltro">
                <label class="lblFiltro">Nome da Empresa</label>
                <telerik:RadTextBox runat="server" ID="txtNomeEmpresa" Columns="40" TextMode="SingleLine"
                    ValidationGroup="Filtrar" EmptyMessage="Informe o nome"
                    CssClass="textbox_filtro_busca">
                </telerik:RadTextBox>
