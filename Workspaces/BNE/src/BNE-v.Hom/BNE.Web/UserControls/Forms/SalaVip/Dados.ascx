...
<Employer:DynamicHtmlLink runat="server" Href="/icons/stylecv.css" type="text/css" rel="stylesheet" />
...
<asp:UpdatePanel
    ...
    <ContentTemplate>
        ...
        <asp:Panel runat="server" ID="pnAviso" Visible="false" CssClass="alert">
            <asp:Literal runat="server" ID="ltAvisoSucesso"></asp:Literal>
        </asp:Panel>
        <asp:Panel runat="server" class="callout callout-info box.box-warning img-polaroid" ID="pnPerguntaAleatoria">
            <asp:Panel runat="server" ID="pnUltimaEmpresa" Visible="true">
                <asp:Panel runat="server" ID="pnUltimaEmpresa_Fase1" Visible="true">
                    <p class="pNomeEmpresa center">Atualize as informações do seu último emprego</p>
                    <%-- Linha Empresa --%>
                    <p>
                        <div class="linha">
                            ...
                            <div class="container_campo">
                                <div>
                                    <asp:RequiredFieldValidator ID="rfvEmpresa1" runat="server" ControlToValidate="txtEmpresa1"
                                        ValidationGroup="SalvarExperienciaProfissional" Display="Dynamic"></asp:RequiredFieldValidator>
                                </div>
                    ...
                    <p>
                        <componente:Data ID="txtDataAdmissao1" runat="server" MensagemErroIntervalo="Data Inválida"
                            CssClassTextBox="textbox_padrao" ValidationGroup="SalvarExperienciaProfissional" />
                    </p>
                    <%-- Linha Data Demissão --%>
                    <p>
                        <asp:Label ID="lblDataDemissao1" runat="server" Text="Data de Demissão" AssociatedControlID="txtDataDemissao1" />

                        <componente:Data ID="txtDataDemissao1" runat="server" ValidationGroup="SalvarExperienciaProfissional"
                    ...
                    <p>
                        <asp:Button runat="server" ID="btnSalvarUltimaEmpresa_Fase1" Text="Salvar e continuar" CausesValidation="True" OnClick="btnSalvarUltimaEmpresa_Fase1_Click" CssClass="btn btn-primary btn-small" ValidationGroup="SalvarExperienciaProfissional" />
                        <asp:Button runat="server" ID="btnPularUltimaEmpresa_Fase1" Text="Atualizar depois" CausesValidation="False" OnClick="btnPularExperiencia_Click" CssClass="btn btn-warning btn-small" />
                    </p>
                </asp:Panel>
                ...
                <asp:Panel runat="server" ID="pnUltimaEmpresa_Fase2" Visible="false">
                    ...
                    <p class="label_principal">
                        Confira as atividades que você realizava na
                        <asp:Literal runat="server" ID="ltNomeEmpresa"></asp:Literal>
                    </p>
                    <p>
                    ...
                    <p>
                        <asp:Button runat="server" ID="btnSalvarExperiencia" Text="Atualizar" OnClick="btnSalvarExperiencia_Click" CssClass="btn btn-primary btn-small" />
                    </p>
            ...
            <asp:Panel runat="server" ID="pnCelular" Visible="false">
                <asp:Panel runat="server" ID="pnPerguntaCelular">
                    <p class="pNomeEmpresa center">Seu número de celular ainda é?</p>
                    <p  class="center"><b><asp:Label runat="server" ID="lbCelular" class="formataLabel"></asp:Label></b></p>
                    
                    <div class="pnAvisoAction">
                        <asp:Button runat="server" ID="btnCelularSim" Text="Sim" OnClick="btnCelularSim_Click" CssClass="btn btn-blue" />
                        <asp:Button runat="server" ID="btnCelularNão" Text="Não" OnClick="btnCelularNao_Click" CssClass="btn btn-grey" />
                    </div>
                    <asp:HiddenField runat="server" ID="hdfTelefoneDDD" Value="" />
                    <asp:HiddenField runat="server" ID="hdfTelefoneNumero" Value="" />
                </asp:Panel>
                <asp:Panel runat="server" ID="pnAtualizarCelular" Visible="false" CssClass="pnAtualizarCelular" >
                    <p class="pNomeEmpresa center">Por favor, atualize o seu número de celular.</p>
                    ...
                    <asp:Panel runat="server" CssClass="painel_botoes" ID="pnlBotoes">
                        <asp:Button runat="server" ID="btnSalvarTelefone" Text="Atualizar" OnClick="btnSalvarTelefone_Click"
                            CssClass="btn btn-blue" ValidationGroup="CadastroCurriculoMini" />
                    </asp:Panel>
                </asp:Panel>
            </asp:Panel>
            <asp:Panel runat="server" ID="pnEmail" Visible="true">
                <asp:Panel runat="server" ID="pnPerguntaEmail">
                    <p class="pNomeEmpresa center">Seu e-mail ainda é?</p>
                    <p class="center"><b><asp:Label runat="server" ID="lblEmail" class="formataLabel"></asp:Label></b></p>
                    <p class="center">
                        <asp:Button runat="server" ID="btnEmailSim" Text="Sim" OnClick="btnEmailSim_Click" CssClass="btn btn-blue" />
                        <asp:Button runat="server" ID="btnEmailNao" Text="Não" OnClick="btnEmailNao_Click" CssClass="btn btn-grey" />
                    </p>
                    <div>
                ...
                <asp:Panel runat="server" ID="pnAtualizarEmail" Visible="false">
                    <p class="pNomeEmpresa center">Informe o seu novo e-mail.</p>
                    <div class="container_campo">
                        <div>
                    ...
                    <div class="center">
                        ...
                        CssClass="btn btn-blue" ValidationGroup="" />
                    </div>
                    
                </asp:Panel>
            </asp:Panel>
            <asp:Panel runat="server" ID="pnSalario" Visible="true">
                <asp:Panel runat="server" ID="pnPerguntaSalario">
                    <p class="pNomeEmpresa">Sua pretensão salarial ainda é?</p>
                    <p>
                        <b>
                            <asp:Label runat="server" ID="lblSalario" class="formataLabel"></asp:Label></b>
                    </p>
                    <p>
                ...
                <asp:Panel runat="server" ID="pnAtualizarSalario" Visible="false">
                    <p class="pNomeEmpresa">Informe sua nova pretensão salarial.</p>
        ...
        <div class="dadosTopo">
            <div class="foto_usuario" id="divFoto" runat="server">
            </div>
            <div class="nome_usuario_sv">
                <h4>
                    <asp:Label ID="lblSaudacao" runat="server"></asp:Label>
                    <asp:Label ID="lblNomePessoa" runat="server" />.     
                </h4>
                <h6><asp:Label ID="lblBemVindo" Visible="false" runat="server"></asp:Label></h6>                    
            </div>
            <div class="div_itens" style="display:none">
                <div>
                    <asp:LinkButton ID="btiMensagens" ToolTip="Mensagens" runat="server"
                        CausesValidation="false" OnClick="btiMensagens_Click" Visible="false" >
                        <i class="fa fa-envelope"></i> Mensagem
                    </asp:LinkButton>
                </div>
                <div>
                    <asp:LinkButton ID="btiJaEnviei" ToolTip="Já Enviei" runat="server"
                        CausesValidation="false" OnClick="btiJaEnviei_Click">
                        <i class="fa fa-check"></i> Já Enviei
                    </asp:LinkButton>
                </div>
                <div>
                    <asp:LinkButton ID="btiVagasPerfil" ToolTip="Vagas no meu perfil"  runat="server"
                        CausesValidation="false" OnClick="btiVagasPerfil_Click">
                        <i class="fa fa-bars"></i> Vagas no Meu Perfil
                    </asp:LinkButton>
                </div>
            </div>
            <div>
                <asp:Panel ID="pnlMenuSecaoCandidato" CssClass="menu_secao" runat="server">
                </asp:Panel>
            </div>                 
