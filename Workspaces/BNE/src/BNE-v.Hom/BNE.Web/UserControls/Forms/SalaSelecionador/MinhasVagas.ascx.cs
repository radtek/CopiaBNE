...
namespace BNE.Web.UserControls.Forms.SalaSelecionador
{
    public partial class MinhasVagas : BaseUserControl
    {
        ...
        protected void gvVagas_ItemCommand(object source, GridCommandEventArgs e)
        {
            ...
            //{
                if (e.CommandName != "Page")
                {
                    ...
                    objResultadoPesquisaCurriculo.Vaga.Cidade = $"{gvVagas.MasterTableView.DataKeyValues[e.Item.ItemIndex]["Nme_Cidade"].ToString()}/{gvVagas.MasterTableView.DataKeyValues[e.Item.ItemIndex]["Sig_Estado"]}";
                    objResultadoPesquisaCurriculo.Vaga.Funcao = gvVagas.MasterTableView.DataKeyValues[e.Item.ItemIndex]["Des_Funcao"].ToString();
        ...
        protected void gvVagasCampanha_ItemCommand(object source, GridCommandEventArgs e)
        {
            ...
            //{
                if (e.CommandName != "Page")
                {
                    ...
                    //Setando o id da vaga no objeto de redirect para a pesquisa de currículo
                    objResultadoPesquisaCurriculo.Vaga.IdVaga = idVaga;
                    objResultadoPesquisaCurriculo.Vaga.Cidade = $"{gvVagasCampanha.MasterTableView.DataKeyValues[e.Item.ItemIndex]["Nme_Cidade"].ToString()}/{gvVagasCampanha.MasterTableView.DataKeyValues[e.Item.ItemIndex]["Sig_Estado"]}";
                    objResultadoPesquisaCurriculo.Vaga.Funcao = gvVagasCampanha.MasterTableView.DataKeyValues[e.Item.ItemIndex]["Des_Funcao"].ToString();
        ...
        private void Inicializar()
        {
            ...
            //Carregar apenas as vaga ativas como default
                rcbStatus.SelectedValue = "1";
        ...
        public void CarregarGridVagas()
        {
            ...
            int totalRegistros;
            DataTable dt = Vaga.ListarVagasFilial(base.IdFilial.Value, gvVagas.CurrentPageIndex, gvVagas.PageSize, vagasAnunciadas, usuarioFilialPerfil, usuarioFilialPerfilConfidencial, RecuperarListFuncoes(), RecuperarListNomeFuncoes(), out totalRegistros, false, RecuperarListAnunciantes());
        ...
        public void CarregarGridVagasCampanha()
        {
            ...
            DataTable dataVagasCampanha = Vaga.ListarVagasFilial(base.IdFilial.Value, gvVagasCampanha.CurrentPageIndex, gvVagasCampanha.PageSize, vagasAnunciadas, usuarioFilialPerfil, usuarioFilialPerfilConfidencial,
                RecuperarListFuncoes(), RecuperarListNomeFuncoes(), out totalRegistrosVagaCampanha, true, RecuperarListAnunciantes());
        ...
        private List<string> RecuperarListNomeFuncoes()
        {
            return ccFiltrarVagasFuncao.GetCheckedItems().Select(item => item.Text).ToList();
        ...
        protected string RetornarBancoCurriculos(int idVaga)
        {
            ...
            return objVaga.RetornarQuantidadeBancoCurriculos().ToString();
        }
        #endregion
