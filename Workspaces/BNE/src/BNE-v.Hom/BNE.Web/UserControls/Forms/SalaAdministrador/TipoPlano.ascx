...
<asp:UpdatePanel ID="upCadastroPlano" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <asp:Panel ID="pnlCadastroPlano" runat="server" CssClass="blocodados">
            ...
            <div class="linha">
                <asp:Label runat="server" Text="Template do Contrato" CssClass="label_principal"></asp:Label>
                <div class="container_campo">
                    <telerik:RadComboBox runat="server" Width="252" ID="radTemplateContrato" EmptyMessage=" " AllowCustomText="false" CssClass="checkbox_large"></telerik:RadComboBox>
                </div>
            </div>
            ...
            <div class="linha">
                <asp:Label runat="server" Text="Customização de Parcelas" CssClass="label_principal"></asp:Label>
                <div class="container_campo">
                    <asp:CheckBox ID="chkCustomizacaoParcela" runat="server" Text="Habilita a customização da quantidade de parcelas" />
                </div>
            </div>
            <div class="=linha">
                <asp:Label runat="server" Text="Recorrente Após Pagamento" CssClass="label_principal"></asp:Label>
                <div class="container_campo">
                    <asp:CheckBox runat="server" ID="chkRecorrenciaAposPagamento" Text="Plano passa a ser recorrente após ser paga a última parcela do plano"/>
                </div>
                <Componentes:BalaoSaibaMais ID="BalaoSaibaMais1" runat="server" ToolTipText="Ex: Planos do tipo 200/6 ou Ilimitado/12, após o termino da última parcela, passa a ser recorrente com cobranças mensais." Text="Saiba mais" ToolTipTitle="Período de Pagamento" CssClassLabel="balao_saiba_mais" ShowOnMouseover="true" />
            </div>
