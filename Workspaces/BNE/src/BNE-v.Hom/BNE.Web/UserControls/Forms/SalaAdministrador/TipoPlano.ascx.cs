    ...
    public partial class TipoPlano : BaseUserControl
    {
        ...
        protected void btnSalvar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (radTemplateContrato.SelectedValue.Equals("-1"))
                {
                    base.ExibirMensagem("Selecione um template de contrato!", Code.Enumeradores.TipoMensagem.Aviso);
                    return;
                }
        ...
        private void AjustarCampos()
        {
            ...
            txtQuantidadeSMS.Obrigatorio = txtQuantidadeVisualizacoes.Obrigatorio = txtQuantidadeCampanha.Obrigatorio = chkCustomizacaoParcela.Enabled = chkRecorrenciaAposPagamento.Enabled = rcbFiltrarTipoCliente.SelectedValue.Equals(((int)Enumeradores.PlanoTipo.PessoaJuridica).ToString());
        ...
        private void PreencherCampos()
        {
            if (IdPlano.HasValue)
            {
                ...
                chkCustomizacaoParcela.Checked = objPlano.FlagCustomizaParcela;
                ...
                chkRecorrenciaAposPagamento.Checked = objPlano.FlagRecorrenteAposTermPagamento;
                if (objPlano.TemplateContrato != null)
                    radTemplateContrato.SelectedValue = objPlano.TemplateContrato.IdTemplateContrato.ToString(CultureInfo.CurrentCulture);
            }
        ...
        private void Salvar()
        {
            ...
            objPlano.TemplateContrato = new TemplateContrato(Convert.ToInt16(radTemplateContrato.SelectedValue));
            ...
            objPlano.FlagCustomizaParcela = chkCustomizacaoParcela.Checked;
            objPlano.FlagRecorrenteAposTermPagamento = chkRecorrenciaAposPagamento.Checked;
            objPlano.Save();
        ...
        private void LimparCampos()
        {
            ...
            chkCustomizacaoParcela.Checked = false;
            chkRecorrenciaAposPagamento.Checked = false;
            radTemplateContrato.SelectedValue = "-1";
        }
        #endregion
        ...
        public void Inicializar()
        {
            ...
            UIHelper.CarregarRadComboBox(radTemplateContrato, TemplateContrato.Listar(), "idf_Template_Contrato", "des_Template", new RadComboBoxItem("Selecione", "-1"));
            AjustarCampos();
        }
        #endregion
