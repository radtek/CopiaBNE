...
namespace BNE.Web.Code
{
    public abstract class BNEChatConsumerBasic : BNEChatConsumerBase
    {
        ...
        {
            object usuarioFilialPerfil;
            
            if (HttpContext.Current.Session != null)
                usuarioFilialPerfil = HttpContext.Current.Session[typeof(SessionVariable<int>) + Chave.Permanente.IdUsuarioFilialPerfilLogadoEmpresa.ToString()];
            else
                usuarioFilialPerfil = HttpContext.Current.Request.QueryString["ufp"];
