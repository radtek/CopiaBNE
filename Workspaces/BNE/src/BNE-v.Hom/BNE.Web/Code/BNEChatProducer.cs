...
namespace BNE.Web.Code
{
    public class BNEChatProducer : BNEChatProducerBase
    {
        ...
        public void AtualizarStatusMensagemChatOutrasConexoes(BNE.Chat.DTO.StatusMensagemChatDTO statusMensagemChatDTO, string conexaoDeEnvio)
        {
        ...
        public void AtualizarStatusMensagemChat(BNE.Chat.DTO.StatusMensagemChatDTO statusMensagemChatDTO)
        {
            AtualizarHistorico(statusMensagemChatDTO);
        ...
        public void EnviarMensagemChatOutrasConexoes(BNE.Chat.DTO.MensagemChatDTO mensagemChatDTO, string conexaoDeEnvio)
        {
        ...
        public void EnviarMensagemChat(BNE.Chat.DTO.MensagemChatDTO mensagemChatDto)
        {
        ...
        private void EnviarParaJanelasDeChat(BNE.Chat.DTO.MensagemChatDTO mensagemChatDTO, Tuple<int, string, string> pfExtraInfo, IEnumerable<string> conexoes)
        {
        ...
        private void AtualizarHistorico(BNE.Chat.DTO.StatusMensagemChatDTO statusMensagemChatDTO)
        {
