        ...
        private void Salvar()
        {
            ...
            if (Agradecimento.SalvarAgradecimento(null, txtNome.Text, txtEmail.Text, objCidade, txtMensagem.Text))
            {
                ...
                EmailSenderFactory
                    ...
                    .Enviar(null, idUsuarioFilialPerfil.HasValue ? new UsuarioFilialPerfil(idUsuarioFilialPerfil.Value) : null, null, String.Empty, txtMensagem.Text,null, txtEmail.Text, Parametro.RecuperaValorParametro(Enumeradores.Parametro.EmailAgradecimento));
            }
        }
        #endregion
