...
<asp:Content ID="Content2" ContentPlaceHolderID="cphConteudo" runat="server">
    ...
    <asp:Panel ID="pnlCamposPesquisa" runat="server" CssClass="painel_padrao pesquisa_avancada" DefaultButton="btnBuscar">
     ...
     <%--   <div class="linha">
             <asp:Label ID="lblDeficiencia" AssociatedControlID="txtCodigoVaga"
                runat="server" CssClass="label_principal" Text="Deficiência" />
            <div class="container_campo">
                 <asp:CheckBox runat="server" ID="ckbDeficiencia"  />
            </div>
        </div>--%>
         <div class="linha">
