...
namespace Employer.Componentes.UI.Web
{
    ...
    /// Componente de CEP.
    /// </summary>
    public class ControlCEP: ControlBaseTextBox
    {
        #region CustomEvents
        /// <summary>
        ...
        #region ValorDecimal
        /// <summary>
        /// Retorna o valor decimal do CEP
        /// </summary>
        public decimal? ValorDecimal
        {
            ...
            set
            {
                if (value.HasValue)
                {
                    this.Text = Formatadores.FormatarCEP(value.Value.ToString());
                }
                else
        ...
        public override string Text
        {
            ...
            set
            {
                ...
                {
                    base.Text = Formatadores.FormatarCEP(value);
                    return;
                }
                base.Text = value;
            }
        ...
        public override short TabIndex
        {
            ...
            set
            {
                TabIndexInternal = value;
            }
        }

        private short TabIndexInternal
        {
            get{
                return ViewState["TabIndexInternal"] == null ? (short)0 : (short)ViewState["TabIndexInternal"];
            }
            set{
                ViewState["TabIndexInternal"] = value;
                base.CampoTexto.TabIndex = value;
            }
        }
        #endregion
        ...
        protected override void CreateChildControls()
        {
            ...
            InicializarPainel();
            base.CampoTexto.TabIndex = TabIndexInternal;
            base.CampoTexto.MaxLength = 10;
        ...
        {
            ScriptControlDescriptor descriptor = new ScriptControlDescriptor("Employer.Componentes.UI.Web.ControlCEP", this.ClientID);
        ...
        public override IEnumerable<System.Web.UI.ScriptReference> GetScriptReferences()
        {
            ...
            reference.Name = "Employer.Componentes.UI.Web.Content.js.ControlCEP.js";
        ...
        private void InicializarCustomValidator()
        {
            ...
            _cvValor.ID = "cvValor";
            _cvValor.ClientValidationFunction = "Employer.Componentes.UI.Web.ControlCEP.ValidarTextBox";
        }
        #endregion
