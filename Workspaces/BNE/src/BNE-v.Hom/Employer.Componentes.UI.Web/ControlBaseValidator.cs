...
{
    /// <summary>
    /// Classe base para outros webcontros de Validador
    /// </summary>
    public abstract class ControlBaseValidator : AjaxClientControlBase, ITextControl, IRequiredField, IMensagemErro
    {
        #region Propriedades
        ...
        /// <summary>
        /// Mensagem de erro de campo mínimo apresentada no sumário.
        /// </summary>
        ...
        /// <summary>
        /// Mensagem de erro de campo máximo apresentada no sumário.
        /// </summary>
        ...
        public virtual bool CausesValidation
        {
            ...
            {
                EnsureChildControls();
                return CampoTexto.CausesValidation;
            }

            set
            {
                EnsureChildControls();
                CampoTexto.CausesValidation = value;
            }
        }
        #endregion
        ...
        protected override void SetScriptReferences(IList<ScriptReference> references)
        {
            ...
            reference.Name = "Employer.Componentes.UI.Web.Content.js.ControlBaseValidator.js";
