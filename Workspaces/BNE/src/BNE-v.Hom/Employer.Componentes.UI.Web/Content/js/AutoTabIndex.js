...
Employer.Componentes.UI.Web.AutoTabIndex = function (element) {
    Employer.Componentes.UI.Web.AutoTabIndex.initializeBase(this, [element]);
    ...
    this.RegisterEvents = function () {
        $(function () {
            //console.debug('RegisterEvents');

            var query = ":input:visible:not([semtab='true']):not([type='submit']):not([type='button'])";
            ...
            $(query)
                .unbind("focus").focus(function () {
                    ...
                    if (NaoignoraFoco) {
                        window.setTimeout(
                            function () {
                                //console.log('Posição campo: ' + campo.attr("id"));
    ...
    this.initialize = function () {
        Employer.Componentes.UI.Web.AutoTabIndex.callBaseMethod(this, 'initialize');
    ...
    this.dispose = function () {
        ...
        Employer.Componentes.UI.Web.AutoTabIndex.callBaseMethod(this, 'dispose');
    }
}



Employer.Componentes.UI.Web.AutoTabIndex.registerClass('Employer.Componentes.UI.Web.AutoTabIndex', Sys.UI.Behavior);