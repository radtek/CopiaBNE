...
//{
//    public class HandlerCaptch : IHttpHandler, IReadOnlySessionState
//    {
...
//            try
//            {
//                var sCaptchaCode = context.Request.QueryString["CaptchaCode"];
//                if (string.IsNullOrEmpty(sCaptchaCode))
//                    return;

//                var code = new CryptUtil().ActionDecrypt(sCaptchaCode);
...
//                sCaptchaText = int.Parse(parans[1]).ToString();

//                var oBytes = context.Cache.Get("ImgHandlerCaptchCaptchaCode_" + sCaptchaText) as byte[];
//                if (oBytes != null)
//                {
...
//            using (Bitmap oOutputBitmap = new Bitmap(iWidth, iHeight, PixelFormat.Format24bppRgb))
//            {
...
//                    oBytes = oMemoryStream.GetBuffer();
//                }
//            }

//            context.Cache.Add("ImgHandlerCaptchCaptchaCode_" + sCaptchaText,
//                oBytes, null, DateTime.MaxValue, new TimeSpan(0, 10, 1), CacheItemPriority.Default, null);
