...
{
    public partial class StatusAtividade // Tabela: TAB_Status_Atividade
	{
		#region Atributos
		...
		#region Consultas
		private const string SPINSERT = "INSERT INTO TAB_Status_Atividade (Des_Status_Atividade, Flg_Inativo, Dta_Cadastro) VALUES (@Des_Status_Atividade, @Flg_Inativo, @Dta_Cadastro);SET @Idf_Status_Atividade = SCOPE_IDENTITY();";
		private const string SPUPDATE = "UPDATE TAB_Status_Atividade SET Des_Status_Atividade = @Des_Status_Atividade, Flg_Inativo = @Flg_Inativo, Dta_Cadastro = @Dta_Cadastro WHERE Idf_Status_Atividade = @Idf_Status_Atividade";
		private const string SPDELETE = "DELETE FROM TAB_Status_Atividade WHERE Idf_Status_Atividade = @Idf_Status_Atividade";
		private const string SPSELECTID = "SELECT * FROM TAB_Status_Atividade WHERE Idf_Status_Atividade = @Idf_Status_Atividade";
		#endregion
		...
		{
			List<SqlParameter> parms = new List<SqlParameter>();
			string query = "delete from TAB_Status_Atividade where Idf_Status_Atividade in (";
		...
		public static IDataReader LoadDataReader(string colunaOrdenacao, string direcaoOrdenacao, int paginaCorrente, int tamanhoPagina, out int totalRegistros)
		{
			...
			string SPSELECTPAG = "SELECT ROW_NUMBER() OVER (ORDER BY " + colunaOrdenacao + " " + direcaoOrdenacao + ") AS RowID, Sta.Idf_Status_Atividade, Sta.Des_Status_Atividade, Sta.Flg_Inativo, Sta.Dta_Cadastro FROM TAB_Status_Atividade Sta";
