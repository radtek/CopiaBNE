...
{
	public partial class Plugin // Tabela: TAB_Plugin
	{
		#region Atributos
		...
		#region Consultas
		private const string SPINSERT = "INSERT INTO TAB_Plugin (Idf_Tipo_Plugin, Des_Plugin, Des_Plugin_Metadata, Flg_Inativo, Dta_Cadastro) VALUES (@Idf_Tipo_Plugin, @Des_Plugin, @Des_Plugin_Metadata, @Flg_Inativo, @Dta_Cadastro);SET @Idf_Plugin = SCOPE_IDENTITY();";
		private const string SPUPDATE = "UPDATE TAB_Plugin SET Idf_Tipo_Plugin = @Idf_Tipo_Plugin, Des_Plugin = @Des_Plugin, Des_Plugin_Metadata = @Des_Plugin_Metadata, Flg_Inativo = @Flg_Inativo, Dta_Cadastro = @Dta_Cadastro WHERE Idf_Plugin = @Idf_Plugin";
		private const string SPDELETE = "DELETE FROM TAB_Plugin WHERE Idf_Plugin = @Idf_Plugin";
		private const string SPSELECTID = "SELECT * FROM TAB_Plugin WHERE Idf_Plugin = @Idf_Plugin";
		#endregion
		...
		{
			List<SqlParameter> parms = new List<SqlParameter>();
			string query = "delete from TAB_Plugin where Idf_Plugin in (";
		...
		public static IDataReader LoadDataReader(string colunaOrdenacao, string direcaoOrdenacao, int paginaCorrente, int tamanhoPagina, out int totalRegistros)
		{
			...
			string SPSELECTPAG = "SELECT ROW_NUMBER() OVER (ORDER BY " + colunaOrdenacao + " " + direcaoOrdenacao + ") AS RowID, Plu.Idf_Plugin, Plu.Idf_Tipo_Plugin, Plu.Des_Plugin, Plu.Des_Plugin_Metadata, Plu.Flg_Inativo, Plu.Dta_Cadastro, Plu.Cod_Plugin, Plu.Idf_Tipo_Atividade FROM TAB_Plugin Plu";
