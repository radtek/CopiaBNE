...
namespace BNE.BLL.AsyncServices
{
    public partial class Parametro // Tabela: TAB_Parametro
	{
		...
		#region Consultas
		private const string SPINSERT = "INSERT INTO TAB_Parametro (Idf_Parametro, Nme_Parametro, Vlr_Parametro, Dta_Cadastro) VALUES (@Idf_Parametro, @Nme_Parametro, @Vlr_Parametro, @Dta_Cadastro);";
		private const string SPUPDATE = "UPDATE TAB_Parametro SET Nme_Parametro = @Nme_Parametro, Vlr_Parametro = @Vlr_Parametro, Dta_Cadastro = @Dta_Cadastro WHERE Idf_Parametro = @Idf_Parametro";
		private const string SPDELETE = "DELETE FROM TAB_Parametro WHERE Idf_Parametro = @Idf_Parametro";
		private const string SPSELECTID = "SELECT * FROM TAB_Parametro WHERE Idf_Parametro = @Idf_Parametro";
		#endregion
		...
		{
			List<SqlParameter> parms = new List<SqlParameter>();
			string query = "delete from TAB_Parametro where Idf_Parametro in (";
		...
		public static IDataReader LoadDataReader(string colunaOrdenacao, string direcaoOrdenacao, int paginaCorrente, int tamanhoPagina, out int totalRegistros)
		{
			...
			string SPSELECTPAG = "SELECT ROW_NUMBER() OVER (ORDER BY " + colunaOrdenacao + " " + direcaoOrdenacao + ") AS RowID, Par.Idf_Parametro, Par.Nme_Parametro, Par.Vlr_Parametro, Par.Dta_Cadastro FROM TAB_Parametro Par";
