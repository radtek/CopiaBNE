(function () {
    ...
    var app = angular.module('Azulzinho', ['ngRoute', 'LocalStorageModule', 'angular-loading-bar', 'LoginController', 'authService', 'authInterceptorService', 'ui.mask', 'LanDirectives',
        'AzulzinhoController', 'VagaController', 'VagasController', 'HeaderController', 'VipController', 'xeditable', 'ui.bootstrap', 'webcam', 'QuemSomosController', 'ngCookies', 'camposDirectives']);
    ...
    app.config(['$routeProvider', '$locationProvider', function ($routeProvider, $locationProvider) {
        ...
        .when('/vaga/:filtro/:idvaga', {
            templateUrl: 'views/vagas/vaga.html',
            controller: 'VagaController',
            controllerAs: 'VagaController'
        })
        .when('/', {
            templateUrl: 'views/Home.html',
            controller: 'VagasController',
