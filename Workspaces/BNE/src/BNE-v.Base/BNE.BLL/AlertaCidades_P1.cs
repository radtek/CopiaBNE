...
namespace BNE.BLL
{
	public partial class AlertaCidades // Tabela: alerta.Tab_Alerta_Cidades
	{
		...
		public static IDataReader LoadDataReader(string colunaOrdenacao, string direcaoOrdenacao, int paginaCorrente, int tamanhoPagina, out int totalRegistros)
		{
			...
			string SPSELECTPAG = "SELECT ROW_NUMBER() OVER (ORDER BY " + colunaOrdenacao + " " + direcaoOrdenacao + ") AS RowID, bAl.Idf_Curriculo, bAl.Idf_Cidade, bAl.Nme_Cidade, bAl.Sig_Estado, bAl.Flg_Inativo FROM alerta.Tab_Alerta_Cidades bAl";
