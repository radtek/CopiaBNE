...
namespace BNE.BLL
{
    public partial class Rota // Tabela: BNE_Rota
    {
        ...
        #region Consultas
        private const string SPINSERT = "INSERT INTO BNE_Rota (Idf_Rota, Nme_Rota, Des_URL, Des_Caminho_Fisico, Flg_Inativo, Num_Peso) VALUES (@Idf_Rota, @Nme_Rota, @Des_URL, @Des_Caminho_Fisico, @Flg_Inativo, @Num_Peso);";
        private const string SPUPDATE = "UPDATE BNE_Rota SET Nme_Rota = @Nme_Rota, Des_URL = @Des_URL, Des_Caminho_Fisico = @Des_Caminho_Fisico, Flg_Inativo = @Flg_Inativo, Num_Peso = @Num_Peso WHERE Idf_Rota = @Idf_Rota";
        ...
        public static IDataReader LoadDataReader(string colunaOrdenacao, string direcaoOrdenacao, int paginaCorrente, int tamanhoPagina, out int totalRegistros)
        {
            ...
            string SPSELECTPAG = "SELECT ROW_NUMBER() OVER (ORDER BY " + colunaOrdenacao + " " + direcaoOrdenacao + ") AS RowID, Rot.Idf_Rota, Rot.Nme_Rota, Rot.Des_URL, Rot.Des_Caminho_Fisico, Rot.Flg_Inativo, Rot.Num_Peso FROM BNE_Rota Rot";
