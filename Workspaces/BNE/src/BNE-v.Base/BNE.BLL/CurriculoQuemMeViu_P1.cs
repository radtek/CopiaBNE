...
namespace BNE.BLL
{
	public partial class CurriculoQuemMeViu // Tabela: BNE_Curriculo_Quem_Me_Viu
	{
		...
		#region Consultas
		private const string SPINSERT = "INSERT INTO BNE_Curriculo_Quem_Me_Viu (Idf_Curriculo, Dta_Quem_Me_Viu, Idf_Filial, Flg_Inativo) VALUES (@Idf_Curriculo, @Dta_Quem_Me_Viu, @Idf_Filial, @Flg_Inativo);SET @Idf_Curriculo_Quem_Me_Viu = SCOPE_IDENTITY();";
		private const string SPUPDATE = "UPDATE BNE_Curriculo_Quem_Me_Viu SET Idf_Curriculo = @Idf_Curriculo, Dta_Quem_Me_Viu = @Dta_Quem_Me_Viu, Idf_Filial = @Idf_Filial, Flg_Inativo = @Flg_Inativo WHERE Idf_Curriculo_Quem_Me_Viu = @Idf_Curriculo_Quem_Me_Viu";
		...
		private const string SPSELECTID = "SELECT * FROM BNE_Curriculo_Quem_Me_Viu WHERE Idf_Curriculo_Quem_Me_Viu = @Idf_Curriculo_Quem_Me_Viu";
		#endregion
			...
			using (SqlConnection conn = new SqlConnection(DataAccessLayer.CONN_STRING))
			{
				...
				using (SqlTransaction trans = conn.BeginTransaction())
				{
					try
					{
						...
						this._idCurriculoQuemMeViu = Convert.ToInt32(cmd.Parameters["@Idf_Curriculo_Quem_Me_Viu"].Value);
		...
		public static IDataReader LoadDataReader(string colunaOrdenacao, string direcaoOrdenacao, int paginaCorrente, int tamanhoPagina, out int totalRegistros)
		{
			...
			string SPSELECTPAG = "SELECT ROW_NUMBER() OVER (ORDER BY " + colunaOrdenacao + " " + direcaoOrdenacao + ") AS RowID, Cur.Idf_Curriculo_Quem_Me_Viu, Cur.Idf_Curriculo, Cur.Dta_Quem_Me_Viu, Cur.Idf_Filial, Cur.Flg_Inativo FROM BNE_Curriculo_Quem_Me_Viu Cur";
		...
		/// <returns>Verdadeiro ou falso informando se a operação foi executada com sucesso.</returns>
		/// <remarks>Gieyson Stelmak</remarks>
		private static bool SetInstance(IDataReader dr, CurriculoQuemMeViu objCurriculoQuemMeViu)
		{
			try
			{
				if (dr.Read())
