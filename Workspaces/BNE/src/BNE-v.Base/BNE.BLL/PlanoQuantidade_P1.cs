...
namespace BNE.BLL
{
	public partial class PlanoQuantidade // Tabela: BNE_Plano_Quantidade
	{
		...
		#region Consultas
		private const string SPINSERT = "INSERT INTO BNE_Plano_Quantidade (Dta_Inicio_Quantidade, Dta_Fim_Quantidade, Qtd_SMS, Qtd_Visualizacao, Qtd_SMS_Utilizado, Qtd_Visualizacao_Utilizado, Flg_Inativo, Dta_Cadastro, Idf_Plano_Adquirido, Dta_Alteracao) VALUES (@Dta_Inicio_Quantidade, @Dta_Fim_Quantidade, @Qtd_SMS, @Qtd_Visualizacao, @Qtd_SMS_Utilizado, @Qtd_Visualizacao_Utilizado, @Flg_Inativo, @Dta_Cadastro, @Idf_Plano_Adquirido, @Dta_Alteracao);SET @Idf_Plano_Quantidade = SCOPE_IDENTITY();";
		private const string SPUPDATE = "UPDATE BNE_Plano_Quantidade SET Dta_Inicio_Quantidade = @Dta_Inicio_Quantidade, Dta_Fim_Quantidade = @Dta_Fim_Quantidade, Qtd_SMS = @Qtd_SMS, Qtd_Visualizacao = @Qtd_Visualizacao, Qtd_SMS_Utilizado = @Qtd_SMS_Utilizado, Qtd_Visualizacao_Utilizado = @Qtd_Visualizacao_Utilizado, Flg_Inativo = @Flg_Inativo, Dta_Cadastro = @Dta_Cadastro, Idf_Plano_Adquirido = @Idf_Plano_Adquirido, Dta_Alteracao = @Dta_Alteracao WHERE Idf_Plano_Quantidade = @Idf_Plano_Quantidade";
		private const string SPDELETE = "DELETE FROM BNE_Plano_Quantidade WHERE Idf_Plano_Quantidade = @Idf_Plano_Quantidade";
		private const string SPSELECTID = "SELECT * FROM BNE_Plano_Quantidade WHERE Idf_Plano_Quantidade = @Idf_Plano_Quantidade";
		#endregion
		...
		private void SetParameters(List<SqlParameter> parms)
		{
			...
			parms[9].Value = this._planoAdquirido.IdPlanoAdquirido;
			...
			parms[10].Value = this._dataAlteracao;
		}
		#endregion
		...
		/// <returns>Verdadeiro ou falso informando se a operação foi executada com sucesso.</returns>
		/// <remarks>Tiago Franco</remarks>
		private static bool SetInstance(IDataReader dr, PlanoQuantidade objPlanoQuantidade)
		{
			try
			{
				if (dr.Read())
