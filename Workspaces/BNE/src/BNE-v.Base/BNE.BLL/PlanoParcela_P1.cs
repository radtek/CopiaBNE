...
namespace BNE.BLL
{
    public partial class PlanoParcela // Tabela: BNE_Plano_Parcela
    {
        ...
        #region Consultas
        private const string SPINSERT = "INSERT INTO BNE_Plano_Parcela (Idf_Plano_Adquirido, Dta_Cadastro, Dta_Pagamento, Vlr_Parcela, Flg_Inativo, Idf_Plano_Parcela_Situacao, Num_Desconto, Qtd_SMS_Total, Qtd_SMS_Liberada) VALUES (@Idf_Plano_Adquirido, @Dta_Cadastro, @Dta_Pagamento, @Vlr_Parcela, @Flg_Inativo, @Idf_Plano_Parcela_Situacao, @Num_Desconto, @Qtd_SMS_Total, @Qtd_SMS_Liberada);SET @Idf_Plano_Parcela = SCOPE_IDENTITY();";
        private const string SPUPDATE = "UPDATE BNE_Plano_Parcela SET Idf_Plano_Adquirido = @Idf_Plano_Adquirido, Dta_Cadastro = @Dta_Cadastro, Dta_Pagamento = @Dta_Pagamento, Vlr_Parcela = @Vlr_Parcela, Flg_Inativo = @Flg_Inativo, Idf_Plano_Parcela_Situacao = @Idf_Plano_Parcela_Situacao, Num_Desconto = @Num_Desconto, Qtd_SMS_Total = @Qtd_SMS_Total, Qtd_SMS_Liberada = @Qtd_SMS_Liberada WHERE Idf_Plano_Parcela = @Idf_Plano_Parcela";
        ...
        public static IDataReader LoadDataReader(string colunaOrdenacao, string direcaoOrdenacao, int paginaCorrente, int tamanhoPagina, out int totalRegistros)
        {
            ...
            string SPSELECTPAG = "SELECT ROW_NUMBER() OVER (ORDER BY " + colunaOrdenacao + " " + direcaoOrdenacao + ") AS RowID, Pla.Idf_Plano_Parcela, Pla.Idf_Plano_Adquirido, Pla.Dta_Cadastro, Pla.Dta_Pagamento, Pla.Vlr_Parcela, Pla.Flg_Inativo, Pla.Idf_Plano_Parcela_Situacao, Pla.Num_Desconto, Pla.Qtd_SMS_Total, Pla.Qtd_SMS_Liberada FROM BNE_Plano_Parcela Pla";
