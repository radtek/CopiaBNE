...
namespace BNE.BLL
{
    public partial class ExperienciaProfissional // Tabela: BNE_Experiencia_Profissional
    {
        ...
        WHERE c.Idf_Situacao_Curriculo NOT IN (6,7,8)
        ...
        public void SalvarExperienciaProfissional(ExperienciaProfissional objExperienciaProfissional)
        {
        ...
        /// <param name="idPessoaFisica">Código identificador de uma pessoa física</param>
        /// <returns>Data Table</returns>
        public static List<ExperienciaProfissional> ListarExperienciasProfissinaisPorFuncao(PessoaFisica objPessoaFisica, Funcao objFuncao)
        {
            ...
            using (IDataReader dr = DataAccessLayer.ExecuteReader(CommandType.Text, SPSELECTEXPERIENCIAPORFUNCAO, parms))
            {
                ExperienciaProfissional objExp = new ExperienciaProfissional();
