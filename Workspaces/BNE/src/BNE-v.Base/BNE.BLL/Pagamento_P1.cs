...
namespace BNE.BLL
{
    public partial class Pagamento // Tabela: BNE_Pagamento
    {
        ...
        private List<SqlParameter> GetParameters()
        {
            ...
            parms.Add(new SqlParameter("@Des_Descricao", SqlDbType.VarChar, 100));
