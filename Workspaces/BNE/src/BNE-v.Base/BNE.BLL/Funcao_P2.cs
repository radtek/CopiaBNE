...
AND (@Idf_Categoria IS NULL OR F.Idf_Funcao_Categoria = @IDF_CATEGORIA)";
        ...
        public static bool CarregarPorDescricao(string descricaoFuncao, out Funcao objFuncao, SqlTransaction trans = null)
        {
            ...
            if (HabilitaCache)
            {
                ...
                if (funcao != null)
                {
                    objFuncao = new Funcao { IdFuncao = funcao.Identificador, DescricaoFuncao = funcao.DescricaoFuncao, DescricaoJob = funcao.DescricaoJob, AreaBNE = new AreaBNE(funcao.IdAreaBNE) };
                    retorno = true;
                }
                else
                    objFuncao = null;
        ...
        public static Funcao CarregarPorDescricao(string descricaoFuncao, SqlTransaction trans = null)
        {
            ...
            if (HabilitaCache)
            {
                var funcao = Funcoes.FirstOrDefault(f => f.DescricaoFuncao.NormalizarStringLINQ().Equals(descricaoFuncao.NormalizarStringLINQ()));
                if (funcao != null)
                    return new Funcao { IdFuncao = funcao.Identificador, DescricaoFuncao = funcao.DescricaoFuncao, DescricaoJob = funcao.DescricaoJob };
        ...
        public static Funcao LoadObject(int idFuncao)
        {
            ...
            if (HabilitaCache)
            {
                ...
                if (funcao != null)
                    return new Funcao { IdFuncao = funcao.Identificador, DescricaoFuncao = funcao.DescricaoFuncao, DescricaoJob = funcao.DescricaoJob, DescricaoFuncaoPesquisa = funcao.DescricaoFuncaoPesquisa, AreaBNE = new AreaBNE(funcao.IdAreaBNE) };
