...
namespace BNE.BLL
{
	public partial class Agradecimento // Tabela: BNE_Agradecimento
	{
		...
		#region Consultas
		private const string SPINSERT = "INSERT INTO BNE_Agradecimento (Idf_Usuario_Filial_Perfil, Nme_Pessoa, Eml_Pessoa, Idf_Cidade, Des_Mensagem, Dta_Cadastro, Flg_Auditado, Flg_Inativo) VALUES (@Idf_Usuario_Filial_Perfil, @Nme_Pessoa, @Eml_Pessoa, @Idf_Cidade, @Des_Mensagem, @Dta_Cadastro, @Flg_Auditado, @Flg_Inativo);SET @Idf_Agradecimento = SCOPE_IDENTITY();";
		private const string SPUPDATE = "UPDATE BNE_Agradecimento SET Idf_Usuario_Filial_Perfil = @Idf_Usuario_Filial_Perfil, Nme_Pessoa = @Nme_Pessoa, Eml_Pessoa = @Eml_Pessoa, Idf_Cidade = @Idf_Cidade, Des_Mensagem = @Des_Mensagem, Dta_Cadastro = @Dta_Cadastro, Flg_Auditado = @Flg_Auditado, Flg_Inativo = @Flg_Inativo WHERE Idf_Agradecimento = @Idf_Agradecimento";
		...
		public static IDataReader LoadDataReader(string colunaOrdenacao, string direcaoOrdenacao, int paginaCorrente, int tamanhoPagina, out int totalRegistros)
		{
			...
			string SPSELECTPAG = "SELECT ROW_NUMBER() OVER (ORDER BY " + colunaOrdenacao + " " + direcaoOrdenacao + ") AS RowID, Agr.Idf_Agradecimento, Agr.Idf_Usuario_Filial_Perfil, Agr.Nme_Pessoa, Agr.Eml_Pessoa, Agr.Idf_Cidade, Agr.Des_Mensagem, Agr.Dta_Cadastro, Agr.Flg_Auditado, Agr.Flg_Inativo FROM BNE_Agradecimento Agr";
