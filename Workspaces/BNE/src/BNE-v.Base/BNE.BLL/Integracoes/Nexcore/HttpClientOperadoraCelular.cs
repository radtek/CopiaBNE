...
//#if DEBUG
//        private static readonly string URI = "http://192.168.200.221/ncall/servicos/getop.php?magic=1333&nums={0}";
//#else
...
//#endif
        ...
        private const string PATTERN = @"^numero {0}::([^:]+)::(\d{{1,2}})::nP$";
