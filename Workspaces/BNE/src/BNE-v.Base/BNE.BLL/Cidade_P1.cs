...
namespace BNE.BLL
{
	public partial class Cidade // Tabela: plataforma.TAB_Cidade
	{
		...
		#region Consultas
		private const string SPINSERT = "INSERT INTO plataforma.TAB_Cidade (Idf_Cidade, Nme_Cidade, Flg_Inativo, Dta_Cadastro, Sig_Estado, Txa_ISS, Idf_Tipo_Base, Cod_Rais) VALUES (@Idf_Cidade, @Nme_Cidade, @Flg_Inativo, @Dta_Cadastro, @Sig_Estado, @Txa_ISS, @Idf_Tipo_Base, @Cod_Rais);";
		private const string SPUPDATE = "UPDATE plataforma.TAB_Cidade SET Nme_Cidade = @Nme_Cidade, Flg_Inativo = @Flg_Inativo, Dta_Cadastro = @Dta_Cadastro, Sig_Estado = @Sig_Estado, Txa_ISS = @Txa_ISS, Idf_Tipo_Base = @Idf_Tipo_Base, Cod_Rais = @Cod_Rais WHERE Idf_Cidade = @Idf_Cidade";
		private const string SPDELETE = "DELETE FROM plataforma.TAB_Cidade WHERE Idf_Cidade = @Idf_Cidade";
		private const string SPSELECTID = "SELECT * FROM plataforma.TAB_Cidade WHERE Idf_Cidade = @Idf_Cidade";
		#endregion
		...
		public static IDataReader LoadDataReader(string colunaOrdenacao, string direcaoOrdenacao, int paginaCorrente, int tamanhoPagina, out int totalRegistros)
		{
			...
			string SPSELECTPAG = "SELECT ROW_NUMBER() OVER (ORDER BY " + colunaOrdenacao + " " + direcaoOrdenacao + ") AS RowID, Cid.Idf_Cidade, Cid.Nme_Cidade, Cid.Flg_Inativo, Cid.Dta_Cadastro, Cid.Sig_Estado, Cid.Txa_ISS, Cid.Idf_Tipo_Base, Cid.Cod_Rais FROM plataforma.TAB_Cidade Cid";
