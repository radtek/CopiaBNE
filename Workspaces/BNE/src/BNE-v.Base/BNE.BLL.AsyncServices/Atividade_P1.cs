...
namespace BNE.BLL.AsyncServices
{
	public partial class Atividade // Tabela: TAB_Atividade
	{
		...
		private string _descricaoCaminhoArquivoUpload;
		private string _descricaoCaminhoArquivoGerado;
		private string _descricaoErro;
		private DateTime _dataAgendamento;
		private DateTime? _dataExecucao;
		private bool _flagInativo;
		private TipoSaida _tipoSaida;
		...
		#region DescricaoCaminhoArquivoUpload
		/// <summary>
		/// Tamanho do campo: 255.
		/// Campo opcional.
		/// </summary>
		public string DescricaoCaminhoArquivoUpload
		{
			get
			{
				return this._descricaoCaminhoArquivoUpload;
			}
			set
			{
				this._descricaoCaminhoArquivoUpload = value;
				this._modified = true;
			}
		}
		#endregion 

		#region DescricaoCaminhoArquivoGerado
		/// <summary>
		/// Tamanho do campo: 255.
		/// Campo opcional.
		/// </summary>
		public string DescricaoCaminhoArquivoGerado
		{
			get
			{
				return this._descricaoCaminhoArquivoGerado;
			}
			set
			{
				this._descricaoCaminhoArquivoGerado = value;
				this._modified = true;
			}
		}
		#endregion 
		...
		#region Consultas
		private const string SPINSERT = "INSERT INTO TAB_Atividade (Idf_Plugins_Compatibilidade, Idf_Status_Atividade, Des_Parametros_Entrada, Des_Parametros_Saida, Dta_Cadastro, Des_Caminho_Arquivo_Upload, Des_Caminho_Arquivo_Gerado, Des_Erro, Dta_Agendamento, Dta_Execucao, Flg_Inativo, Idf_Tipo_Saida) VALUES (@Idf_Plugins_Compatibilidade, @Idf_Status_Atividade, @Des_Parametros_Entrada, @Des_Parametros_Saida, @Dta_Cadastro, @Des_Caminho_Arquivo_Upload, @Des_Caminho_Arquivo_Gerado, @Des_Erro, @Dta_Agendamento, @Dta_Execucao, @Flg_Inativo, @Idf_Tipo_Saida);SET @Idf_Atividade = SCOPE_IDENTITY();";
		private const string SPUPDATE = "UPDATE TAB_Atividade SET Idf_Plugins_Compatibilidade = @Idf_Plugins_Compatibilidade, Idf_Status_Atividade = @Idf_Status_Atividade, Des_Parametros_Entrada = @Des_Parametros_Entrada, Des_Parametros_Saida = @Des_Parametros_Saida, Dta_Cadastro = @Dta_Cadastro, Des_Caminho_Arquivo_Upload = @Des_Caminho_Arquivo_Upload, Des_Caminho_Arquivo_Gerado = @Des_Caminho_Arquivo_Gerado, Des_Erro = @Des_Erro, Dta_Agendamento = @Dta_Agendamento, Dta_Execucao = @Dta_Execucao, Flg_Inativo = @Flg_Inativo, Idf_Tipo_Saida = @Idf_Tipo_Saida WHERE Idf_Atividade = @Idf_Atividade";
		private const string SPDELETE = "DELETE FROM TAB_Atividade WHERE Idf_Atividade = @Idf_Atividade";
		private const string SPSELECTID = "SELECT * FROM TAB_Atividade WHERE Idf_Atividade = @Idf_Atividade";
		#endregion
