...
namespace BNE.Componentes
{
    ...
    public class DataTextBox : ControlBaseTextBox, IScriptControl
    {
            ...
            get
            {
                if (ViewState["ImagemBotaoUrl"] == null)
                    return Page.ClientScript.GetWebResourceUrl(typeof(DataTextBox),
                        "BNE.Componentes.Content.Images.botao_calendar.png");
        ...
        //#region Feriados
        //public Dictionary<DateTime, Employer.Plataforma.BLL.Enumeradores.TipoFeriado> Feriados
        //{
        //    get
        //    {
        //        if (ViewState["Feriados"] == null)
        //        {
        //            var _Feriados = new Dictionary<DateTime, Employer.Plataforma.BLL.Enumeradores.TipoFeriado>();
        //            ViewState["Feriados"] = _Feriados;
        //            return _Feriados;
        //        }

        //        return (Dictionary<DateTime, Employer.Plataforma.BLL.Enumeradores.TipoFeriado>)ViewState["Feriados"];
        //    }
        //    set
        //    {
        //        ViewState["Feriados"] = value;
        //    }
        //}
        //#endregion
        ...
        //#region CssClassFeriadosNacionais
        //public String CssClassFeriadosNacionais
        //{
        //    get
        //    {
        //        return Convert.ToString(this.ViewState["CssClassFeriadosNacionais"]);                
        //    }
        //    set
        //    {
        //        ViewState["CssClassFeriadosNacionais"] = value;
        //    }
        //}
        //#endregion 

        //#region CssClassFeriadosMunicipais
        //public String CssClassFeriadosMunicipais
        //{
        //    get
        //    {
        //        return Convert.ToString(this.ViewState["CssClassFeriadosMunicipais"]);
        //    }
        //    set
        //    {
        //        ViewState["CssClassFeriadosMunicipais"] = value;
        //    }
        //}
        //#endregion 

        //#region CssClassFeriadosEstaduais
        //public String CssClassFeriadosEstaduais
        //{
        //    get
        //    {
        //        return Convert.ToString(this.ViewState["CssClassFeriadosEstaduais"]);
        //    }
        //    set
        //    {
        //        ViewState["CssClassFeriadosEstaduais"] = value;
        //    }
        //}
        //#endregion 

        //#region CssClassFeriadosOutros
        //public String CssClassFeriadosOutros
        //{
        //    get
        //    {
        //        return Convert.ToString(this.ViewState["CssClassFeriadosOutros"]);
        //    }
        //    set
        //    {
        //        ViewState["CssClassFeriadosOutros"] = value;
        //    }
        //}
        //#endregion 
        ...
        //{
        //    private Dictionary<DateTime, List<KeyValuePair<TipoFeriado, String>>> _feriados = new Dictionary<DateTime, List<KeyValuePair<TipoFeriado, String>>>();

        //    public void AdicionarFeriado(DateTime data, TipoFeriado tipo, String descricao)
        //    {
        //        if (_feriados.ContainsKey(data))
        //            _feriados[data].Add(new KeyValuePair<TipoFeriado, String>(tipo, descricao));
        //        else
        //            _feriados.Add(data,
        //                new List<KeyValuePair<TipoFeriado, String>>(
        //                new KeyValuePair<TipoFeriado, String>[] { 
        //                    new KeyValuePair<TipoFeriado, String>(tipo, descricao)
        //                }));
        //    }

        //    public Dictionary<DateTime, List<KeyValuePair<TipoFeriado, String>>> RetornarFeriados()
        //    {
        //        return _feriados;
        //    }
        //}
