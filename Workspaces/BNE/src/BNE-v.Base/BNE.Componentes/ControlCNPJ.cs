...
namespace BNE.Componentes
{
    ...
    public class ControlCNPJ : ControlBaseTextBox
    {
        ...
        {
            ScriptControlDescriptor descriptor = new ScriptControlDescriptor("BNE.Componentes.ControlCNPJ", this.ClientID);
        ...
        public override IEnumerable<System.Web.UI.ScriptReference> GetScriptReferences()
        {
            ...
            reference.Name = "BNE.Componentes.Content.js.ControlCNPJ.js";
        ...
        private void InicializarCustomValidator()
        {
            ...
            _cvValor.ClientValidationFunction = "BNE.Componentes.ControlCNPJ.ValidarTextBox";
        }
        #endregion
