        ...
        public DTO.OutLiberaUsuarioTanque liberaUsuarioTanque(DTO.InLiberaUsuarioTanque liberaUsuario, bool novoUsuario = true)
        {
            try
            {
                if (novoUsuario)
                {
                    ...
                    {
                        UsuarioFilialPerfil = UsuarioFilialPerfil.LoadObject(liberaUsuario.usuarioFilialPerfil),
                        Celular = Celular.LoadObject(1),
                        DataInicioUtilizacao = liberaUsuario.dataInicio,
                        DataFimUtilizacao = liberaUsuario.dtaFim,
