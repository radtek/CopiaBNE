...
namespace BNE.Auth
{
    public class CleanCookieBehavior : BNE.Auth.LoginBehaviorBase
    {
        private IEnumerable<LoginPadraoAspNet.CookieSimpleInfo> _cookiesToClean;
        ...
        protected override void OnBeforeLogoffSafe(Func<System.Web.HttpContextBase> contextAccessor, LoginBehaviorBase.LogOffInfo info)
        {
