...
namespace BNE.Web.WebServices
{
    ...
    public class wsAutoComplete : WebService
    {
        ...
        #region ListarCidadesPorNomeParcialEstado
        /// <summary>
        /// 
        /// </summary>
        ...
        public string[] ListarCidadesPorNomeParcialEstado(string prefixText, int count, string contextKey)
        {
            try
            {
                return UIHelper.RecuperarItensAutoComplete(Cidade.RecuperarNomesCidades(prefixText, contextKey, count));
            }
            catch (Exception ex)
            {
        ...
        /// <returns></returns>
        [WebMethod(EnableSession = false), ScriptMethod]
        public string[] ListarFuncoes(string prefixText, int count, string contextKey)
        {
            try
            {
                int? origem = null;
                ...
                return Funcao.RecuperarFuncoes(prefixText, count, origem);
            }
            catch (Exception ex)
            {
        ...
        public string[] ListarSiglaNomeFonteNivelCurso(string prefixText, string contextKey, int count)
        {
            try
            {
                ...
                return Fonte.RecuperarSiglaNomeFonteNivelCurso(prefixText, idNivelFonte, count);
            }
            catch (Exception ex)
            {
                string message = "A sentença informada foi: " + prefixText;
