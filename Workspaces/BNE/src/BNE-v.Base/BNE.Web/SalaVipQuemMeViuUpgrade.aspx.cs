...
namespace BNE.Web
{
    public partial class SalaVipQuemMeViuUpgrade : BasePage
    {
        ...
        public void SalvarAjuda(PessoaFisica objPessoaFisica)
        {
            ...
            string assunto;
            string templateMensagem = CartaEmail.RetornarConteudoBNE(Enumeradores.CartaEmail.PecaAjuda, out assunto);
            var parametros = new
                {
                    NomeCandidato = objPessoaFisica.NomePessoa,
                    NumeroCPF = objPessoaFisica.NumeroCPF,
            ...
            EmailSenderFactory
                ...
                .Enviar(new Curriculo(base.IdCurriculo.Value), objUsuarioFilialPerfil, null, assunto, mensagem, objPessoaFisica.EmailPessoa, Parametro.RecuperaValorParametro(Enumeradores.Parametro.EmailPecaAjuda));
        }
        #endregion
