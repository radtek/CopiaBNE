    ...
    <div style="width: 700px; margin: 0 auto; margin-left: 200px;">
        <div style="width: 600px; margin-left: 0px; position: relative">
            ...
            <div style="display: block; font-family: Arial Unicode MS; font-size: 12px; margin-left: 20px; position: relative; float: left;">
                ...
                | Atualizado em:<asp:Label CssClass="texto_data_atualizado" ID="lblAtualizacaoCV"
                    runat="server" />
            </div>
        ...
        <asp:UpdatePanel ID="upBotaoVerDados" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <asp:Panel runat="server" ID="pnlVerDados" CssClass="btn_ver_curriculo">
                    <asp:Button CausesValidation="false" CssClass="botao_padrao" ID="btnVerDados" OnClick="btnVerDados_Click"
                ...
                <asp:Panel ID="pnlDadosPessoais" runat="server">
                    ...
                    <table style="margin-left: 20px; width: 560px; float: left;">
                        <tr>
                            ...
                            <td valign="top" style="text-align: left; font-weight: bold; width: 50px;">CPF:
                            </td>
                            <td valign="top" style="text-align: left;">
                                <asp:Literal ID="litCpfValor" runat="server" />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td valign="top" style="text-align: left; font-weight: bold; width: 175px;">Data de Nascimento:
                            </td>
                            <td valign="top" style="text-align: left;">
                                <asp:Literal ID="litDataNascimentoValor" runat="server" />
                                <asp:Literal ID="litIdadeValor" runat="server" />
                            </td>
                            <td valign="top" style="text-align: right; font-weight: bold; width: 50px;">
                        ...
                        <tr>
                            ...
                            <td valign="top" style="text-align: left;">
                                ...
                                <asp:Image runat="server" ID="imgOperadoraCelular" Visible="False" Style="vertical-align: middle;" />
                            </td>
                            <td></td>
                            <td></td>
                        </tr>
        ...
        <div style="border-bottom: 1px solid #999; display: block; font-family: Arial Unicode MS; font-size: 15px; font-weight: bold; margin-left: 20px; width: 655px; clear: both;">
            Pretensões
        </div>
        <asp:Table runat="server" CssClass="pretensoes" Style="margin-left: 20px;" CellPadding="0" CellSpacing="0">
            ...
            <asp:TableRow>
                ...
                </asp:TableCell><asp:TableCell Width="0" valign="top" Style="text-align: left; width: 200px">
                    <asp:Literal ID="litFuncaoPretendidaValor" runat="server" />
                </asp:TableCell><asp:TableCell valign="top" Style="text-align: right; font-weight: bold; width: 50px;">
        ...
        <asp:Panel ID="pnlDadosEscolaridade" runat="server">
            <div style="border-bottom: 1px solid #999; display: block; font-family: Arial Unicode MS; font-size: 15px; font-weight: bold; margin-left: 20px; width: 655px">
                Escolaridade
            </div>
