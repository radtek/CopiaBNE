        ...
        protected void btnEnviar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                EmailSenderFactory
                    ...
                    .Enviar(null, idUsuarioFilialPerfil.HasValue ? new UsuarioFilialPerfil(idUsuarioFilialPerfil.Value) : null, null, assunto, mensagem, de, para);

                LimparCampos();

                ucModalConfirmacao.PreencherCampos("Confirmação de Envio", MensagemAviso._203018, false);
