            ...
            try
            {
                ...
                if (!String.IsNullOrEmpty(objPessoaFisica.EmailPessoa))
                {
                    ...
                    EmailSenderFactory
                        ...
                        .Enviar(null, new UsuarioFilialPerfil(base.IdUsuarioFilialPerfilLogadoCandidato.Value), null, "Não achei empresa", mensagem, objPessoaFisica.EmailPessoa, Parametro.RecuperaValorParametro(Enumeradores.Parametro.EmailCIA));
                }
