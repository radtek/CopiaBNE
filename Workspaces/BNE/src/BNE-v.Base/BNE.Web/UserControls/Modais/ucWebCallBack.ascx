...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('#cphRodape_ucWebCallBack_txtTelefone_txtDDD').prop('placeholder', 'DDD');
        $('#cphRodape_ucWebCallBack_txtTelefone_txtFone').prop('placeholder', 'TELEFONE');
        $('#cphRodape_ucWebCallBack_txtTelefoneClienteMsg_txtDDD').prop('placeholder', 'DDD');
        $('#cphRodape_ucWebCallBack_txtTelefoneClienteMsg_txtFone').prop('placeholder', 'TELEFONE');
        
        console.log($('#cphRodape_ucWebCallBack_txtTelefone_txtDDD').prop('placeholder'));
    });
</script>
<style>
    input.spanddd { width: 50px; margin-left: 35px; }    
    input.spanfone { width: 136px; margin-left: 10px !important; }
    input.spandddMsg { width:50px; margin-bottom:10px;}
    input.spanfoneMsg {width: 136px; margin-left: 10px !important; margin-bottom:8px;}
    .modal-body .input-group { width: 100%; }
</style>

<%-- INÍCIO Novo Atendimento on-line  --%>
<%--button chama modal--%>
...
<div id="myModalComercial" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<div id="myModalMensagem" class="modal hide fade modal-size" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div id="divJanelaMensagem" runat="server" class="modal-body" style="font-size: 16px; color: #666">
                ...
                <div class="form-group">
                    ...
                    <p>
                        ...
                        <textarea id="txtMensagemCliente" runat="server" rows="5" placeholder="Escreva aqui sua mensagem!" style="width: 350px!important" maxlength="200"></textarea>
