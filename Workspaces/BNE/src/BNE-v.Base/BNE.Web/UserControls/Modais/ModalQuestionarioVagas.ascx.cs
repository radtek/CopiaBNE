...
namespace BNE.Web.UserControls.Modais
{
    public partial class ModalQuestionarioVagas : BaseUserControl
    {
        ...
        private void PreencherCampos()
        {
            ...
            if (listaVagaPergunta.Count >= 1) //Caso tenha ao menos uma pergunta
            {
                ...
                rbtRespostaSim01.ValidationGroup = rbtRespostaNao01.ValidationGroup = btnEnviar.ValidationGroup;
            }
            if (listaVagaPergunta.Count >= 2)
            {
                ...
                rbtRespostaSim02.ValidationGroup = rbtRespostaNao02.ValidationGroup = btnEnviar.ValidationGroup;
            }
            if (listaVagaPergunta.Count >= 3)
            {
                ...
                rbtRespostaSim03.ValidationGroup = rbtRespostaNao03.ValidationGroup = btnEnviar.ValidationGroup;
            }
            if (listaVagaPergunta.Count.Equals(4))
            {
                ...
                rbtRespostaSim04.ValidationGroup = rbtRespostaNao04.ValidationGroup = btnEnviar.ValidationGroup;
            }
        ...
        {
            if ((!IdPergunta1.HasValue || (rbtRespostaSim01.Checked || rbtRespostaNao01.Checked)) && (!IdPergunta2.HasValue || (rbtRespostaSim02.Checked || rbtRespostaNao02.Checked)) && (!IdPergunta3.HasValue || (rbtRespostaSim03.Checked || rbtRespostaNao03.Checked)) && (!IdPergunta4.HasValue || (rbtRespostaSim04.Checked || rbtRespostaNao04.Checked)))
            {
                VagaRespostaEventArgs eventArgs = new VagaRespostaEventArgs(this.IdVaga, IdPergunta1, IdPergunta2, IdPergunta3, IdPergunta4, rbtRespostaSim01.Checked, rbtRespostaSim02.Checked, rbtRespostaSim03.Checked, rbtRespostaSim04.Checked);
                if (Salvar != null)
    ...
    public class VagaRespostaEventArgs : EventArgs
    {
        ...
        public VagaRespostaEventArgs(int idVaga, int? idPergunta1, int? idPergunta2, int? idPergunta3, int? idPergunta4, bool? flagRespostaPergunta1, bool? flagRespostaPergunta2, bool? flagRespostaPergunta3, bool? flagRespostaPergunta4)
        {
            this.IdVaga = idVaga;
