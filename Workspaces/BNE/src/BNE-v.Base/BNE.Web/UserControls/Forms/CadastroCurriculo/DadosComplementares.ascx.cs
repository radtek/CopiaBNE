        ...
        private void PreencherCampos()
        {
            if (IdPessoaFisica.HasValue)
            {
                ...
                if (PessoaFisicaComplemento.CarregarPorPessoaFisica(objPessoaFisica.IdPessoaFisica, out objPessoaFisicaComplemento))
                {
                    ...
                    if (objPessoaFisicaComplemento.ArquivoAnexo != null && !string.IsNullOrWhiteSpace(objPessoaFisicaComplemento.NomeAnexo))
                    {
                        hlDownload.NavigateUrl = GerarLinkDownload(objPessoaFisicaComplemento.ArquivoAnexo, objPessoaFisicaComplemento.NomeAnexo);
        ...
        public bool Salvar()
        {
            ...
            if (IdPessoaFisica.HasValue)
            {
                ...
                if (!auUpload.UploadedFiles.Count.Equals(0))
                {
                    ...
                    objPessoaFisicaComplemento.ArquivoAnexo = byteArray;
                }
