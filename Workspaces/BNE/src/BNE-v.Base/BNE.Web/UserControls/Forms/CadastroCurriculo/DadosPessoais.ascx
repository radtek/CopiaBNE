            ...
            <asp:Panel ID="pnlExperienciaProfissional" runat="server" CssClass="painel_padrao">
                ...
                <div class="linha">
                    ...
                    <div class="container_campo">
                        ...
                        <asp:TextBox ID="txtFuncaoExercida1" runat="server" CssClass="textbox_padrao" Columns="60"
                ...
                <div class="linha">
                    ...
                    <div class="container_campo container_campoAdjust_dpessoais">
                        <%-- <div>
                            <asp:RequiredFieldValidator ID="rfvUltimoSalario" runat="server" ControlToValidate="txtUltimoSalario"
                                ValidationGroup="CadastroDadosPessoais" Display="Dynamic"></asp:RequiredFieldValidator>
                        </div>--%>
                        <componente:ValorDecimal ID="txtUltimoSalario" runat="server" CasasDecimais="0" ValidationGroup="CadastroDadosPessoais"
                            ValorMinimo="1" ValorMaximo="999999" Obrigatorio="true" CssClassTextBox="textbox_padrao textarea_padraoAdjust_dpessoais" MensagemErroObrigatorio="Campo obrigatório" />
                ...
                <div class="linha">
                    ...
                    <div class="container_campo">
                        ...
                        <asp:TextBox ID="txtFuncaoExercida2" runat="server" CssClass="textbox_padrao" Columns="60"
                            MaxLength="60" AutoPostBack="true" OnTextChanged="txtFuncaoExercida2_TextChanged"></asp:TextBox>
                        <AjaxToolkit:AutoCompleteExtender ID="aceFuncaoExercida2" runat="server" TargetControlID="txtFuncaoExercida2"
                            UseContextKey="True" ServiceMethod="ListarFuncoes" OnClientItemSelected="">
                        </AjaxToolkit:AutoCompleteExtender>
                    </div>
                </div>
                ...
                <div class="linha">
                    ...
                    <div class="container_campo">
                        ...
                        <asp:TextBox ID="txtFuncaoExercida3" runat="server" CssClass="textbox_padrao" Columns="60"
                            MaxLength="60" AutoPostBack="true" OnTextChanged="txtFuncaoExercida3_TextChanged"></asp:TextBox>
                        <AjaxToolkit:AutoCompleteExtender ID="aceFuncaoExercida3" runat="server" TargetControlID="txtFuncaoExercida3"
                            UseContextKey="True" ServiceMethod="ListarFuncoes" OnClientItemSelected="">
                        </AjaxToolkit:AutoCompleteExtender>
                    </div>
                </div>
                ...
                <div class="linha">
                    ...
                    <div class="container_campo">
                        ...
                        <asp:TextBox ID="txtFuncaoExercida4" runat="server" CssClass="textbox_padrao" Columns="60"
                            MaxLength="60" AutoPostBack="true" OnTextChanged="txtFuncaoExercida4_TextChanged"></asp:TextBox>
                        <AjaxToolkit:AutoCompleteExtender ID="aceFuncaoExercida4" runat="server" TargetControlID="txtFuncaoExercida4"
                            UseContextKey="True" ServiceMethod="ListarFuncoes" OnClientItemSelected="">
                        </AjaxToolkit:AutoCompleteExtender>
                    </div>
                </div>
                ...
                <div class="linha">
                    ...
                    <div class="container_campo">
                        ...
                        <asp:TextBox ID="txtFuncaoExercida5" runat="server" CssClass="textbox_padrao" Columns="60"
                            MaxLength="60" AutoPostBack="true" OnTextChanged="txtFuncaoExercida5_TextChanged"></asp:TextBox>
                        <AjaxToolkit:AutoCompleteExtender ID="aceFuncaoExercida5" runat="server" TargetControlID="txtFuncaoExercida5"
                            UseContextKey="True" ServiceMethod="ListarFuncoes" OnClientItemSelected="">
                        </AjaxToolkit:AutoCompleteExtender>
                    </div>
                </div>
                ...
                <div class="linha">
                    ...
                    <div class="container_campo">
                        ...
                        <asp:TextBox ID="txtFuncaoExercida6" runat="server" CssClass="textbox_padrao" Columns="60"
                            MaxLength="60" AutoPostBack="true" OnTextChanged="txtFuncaoExercida6_TextChanged"></asp:TextBox>
                        <AjaxToolkit:AutoCompleteExtender ID="aceFuncaoExercida6" runat="server" TargetControlID="txtFuncaoExercida6"
                            UseContextKey="True" ServiceMethod="ListarFuncoes" OnClientItemSelected="">
                        </AjaxToolkit:AutoCompleteExtender>
                    </div>
                </div>
                ...
                <div class="linha">
                    ...
                    <div class="container_campo">
                        ...
                        <asp:TextBox ID="txtFuncaoExercida7" runat="server" CssClass="textbox_padrao" Columns="60"
                            MaxLength="60" AutoPostBack="true" OnTextChanged="txtFuncaoExercida7_TextChanged"></asp:TextBox>
                        <AjaxToolkit:AutoCompleteExtender ID="aceFuncaoExercida7" runat="server" TargetControlID="txtFuncaoExercida7"
                            UseContextKey="True" ServiceMethod="ListarFuncoes" OnClientItemSelected="">
                        </AjaxToolkit:AutoCompleteExtender>
                    </div>
                </div>
                ...
                <div class="linha">
                    ...
                    <div class="container_campo">
                        ...
                        <asp:TextBox ID="txtFuncaoExercida8" runat="server" CssClass="textbox_padrao" Columns="60"
                            MaxLength="60" AutoPostBack="true" OnTextChanged="txtFuncaoExercida8_TextChanged"></asp:TextBox>
                        <AjaxToolkit:AutoCompleteExtender ID="aceFuncaoExercida8" runat="server" TargetControlID="txtFuncaoExercida8"
                            UseContextKey="True" ServiceMethod="ListarFuncoes" OnClientItemSelected="">
                        </AjaxToolkit:AutoCompleteExtender>
                    </div>
                </div>
                ...
                <div class="linha">
                    ...
                    <div class="container_campo">
                        ...
                        <asp:TextBox ID="txtFuncaoExercida9" runat="server" CssClass="textbox_padrao" Columns="60"
                            MaxLength="60" AutoPostBack="true" OnTextChanged="txtFuncaoExercida9_TextChanged"></asp:TextBox>
                        <AjaxToolkit:AutoCompleteExtender ID="aceFuncaoExercida9" runat="server" TargetControlID="txtFuncaoExercida9"
                            UseContextKey="True" ServiceMethod="ListarFuncoes" OnClientItemSelected="">
                        </AjaxToolkit:AutoCompleteExtender>
                    </div>
                </div>
                ...
                <div class="linha">
                    ...
                    <div class="container_campo">
                        ...
                        <asp:TextBox ID="txtFuncaoExercida10" runat="server" CssClass="textbox_padrao" Columns="60"
                            MaxLength="60" AutoPostBack="true" OnTextChanged="txtFuncaoExercida10_TextChanged"></asp:TextBox>
                        <AjaxToolkit:AutoCompleteExtender ID="aceFuncaoExercida10" runat="server" TargetControlID="txtFuncaoExercida10"
                            UseContextKey="True" ServiceMethod="ListarFuncoes" OnClientItemSelected="">
                        </AjaxToolkit:AutoCompleteExtender>
                    </div>
                </div>
