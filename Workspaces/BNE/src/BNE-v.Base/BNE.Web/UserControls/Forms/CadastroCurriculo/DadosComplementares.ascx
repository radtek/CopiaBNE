        ...
        <ContentTemplate>
            <asp:Panel ID="pnlDadosComplementares" runat="server" CssClass="painel_padrao">
                ...
                <div class="linha">
                    ...
                    <div class="container_campo">
                        <componente:AlfaNumerico ID="txtModelo" runat="server" Columns="50" MaxLength="50" ValidationGroup="SalvarVeiculo"
                    ...
                    <div class="container_campo">
                        <asp:Panel ID="pnlAsyncUpload" runat="server">
                            <telerik:RadAsyncUpload ID="auUpload" runat="server" MaxFileInputsCount="1" InitialFileInputsCount="1"
                                OnFileUploaded="auUpload_FileUploaded" OnClientFileUploaded="auUpload_ClientFileUploaded" ReadOnlyFileInputs="True"
                                ControlObjectsVisibility="None" OverwriteExistingFiles="True" Skin="Office2007" CssClass="campo_anexar_arquivo" TemporaryFileExpiration="00:10:00">
