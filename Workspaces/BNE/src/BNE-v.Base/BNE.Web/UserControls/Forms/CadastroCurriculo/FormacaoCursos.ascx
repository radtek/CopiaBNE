            ...
            <asp:Panel ID="pnlCursosComplementares" runat="server" CssClass="painel_padrao">
                ...
                <div class="linha">
                    ...
                    <div class="container_campo">
                        ...
                        <AjaxToolkit:AutoCompleteExtender ID="aceCidadeComplementar" runat="server" TargetControlID="txtCidadeComplementar" ServiceMethod="ListarCidadesSiglaEstadoPorNomeParcialEstado">
                        </AjaxToolkit:AutoCompleteExtender>
                    </div>
                </div>
                <!-- FIM: Linha Cidade  -->
