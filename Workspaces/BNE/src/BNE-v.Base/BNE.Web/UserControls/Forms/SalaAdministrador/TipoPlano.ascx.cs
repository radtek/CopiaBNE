...
namespace BNE.Web.UserControls.Forms.SalaAdministrador
{
    public partial class TipoPlano : BaseUserControl
    {
        ...
        private void CarregarGrid()
        {
            ...
            UIHelper.CarregarRadGrid(gvPlanos, Plano.Listar(PageIndex, gvPlanos.PageSize, status, out totalRegistros), totalRegistros);
        }
        #endregion
        ...
        {
            lblQuantidadeSMS.Enabled = lblQuantidadeVisualizacoes.Enabled =
            txtQuantidadeSMS.Enabled = txtQuantidadeVisualizacoes.Enabled =
            txtQuantidadeSMS.Obrigatorio = txtQuantidadeVisualizacoes.Obrigatorio = rcbFiltrarTipoCliente.SelectedValue.Equals(((int)Enumeradores.PlanoTipo.PessoaJuridica).ToString());
        }
        #endregion
        ...
        private void PreencherCampos()
        {
            if (IdPlano.HasValue)
            {
                ...
                if (objPlano.TipoContrato != null)
                    rcbTipoContrato.SelectedValue = objPlano.TipoContrato.IdfTipoContrato.ToString(CultureInfo.CurrentUICulture);
            }
        }
        #endregion
