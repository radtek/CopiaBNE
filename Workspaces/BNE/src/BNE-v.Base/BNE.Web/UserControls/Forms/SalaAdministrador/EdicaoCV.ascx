                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Ações" ItemStyle-CssClass="col_action_arq">
                            <ItemTemplate>
                                ...
                                <asp:ImageButton ID="btiAvaliacao" runat="server" ImageUrl="../../../img/icn_infeliz.png"
                                ...
                                <asp:ImageButton ID="btiAvaliacaoBloqueado" runat="server" ImageUrl="../../../img/icn_infeliz.png"
                                    ToolTip="Bronquinha" Visible='<%# Convert.ToInt32(Eval("Idf_Situacao_Curriculo"))==6 %>'
