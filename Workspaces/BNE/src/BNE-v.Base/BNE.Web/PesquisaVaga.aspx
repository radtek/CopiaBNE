                    ...
                    <asp:Panel ID="pnlVaga" runat="server" CssClass='<%# RecuperarCssPainelVaga(DynamicHelper.GetValue(Container.DataItem,"Flg_BNE_Recomenda"), DynamicHelper.GetValue(GetDataItem(),"Idf_Origem")) %>'>
                        ...
                        <asp:Panel ID="pnlVagaColunaEsquerda" CssClass="coluna_esquerda_vaga" runat="server">
                            ...
                            <h2>
                                ...
                                <asp:Literal ID="litTituloVaga" runat="server" Text='<%# DynamicHelper.GetValue(GetDataItem(),"Des_Funcao") %>'></asp:Literal>
                            ...
                            <p class="texto_resumo_vaga">
                                <asp:Literal ID="litResumoDadosVaga" runat="server" Text='<%# RetornarDesricaoSalario(DynamicHelper.GetValue(GetDataItem(),"Vlr_Salario_De"), DynamicHelper.GetValue(GetDataItem(),"Vlr_Salario_Para")) + " - " + DynamicHelper.GetValue(GetDataItem(),"Nme_Cidade") + "/" + DynamicHelper.GetValue(GetDataItem(),"Sig_Estado") %>'></asp:Literal>
                            </p>
                            ...
                            <%-- FIM: pnlMaisDadosVaga --%>
                        </asp:Panel>
                        <%-- FIM: pnlVagaColunaEsquerda --%>
...
<asp:Content ID="conRodape" ContentPlaceHolderID="cphRodape" runat="server">
    ...
    <%-- Modal Confirmação IPhone --%>
    <asp:HiddenField ID="hfModalConfirmacaoIPhone" runat="server" />
    <AjaxToolkit:ModalPopupExtender CancelControlID="btiModalConfirmacaoIPhoneFechar"
        ID="mpeModalConfirmacaoIPhone" runat="server" PopupControlID="pnlModalConfirmacaoIPhone"
        TargetControlID="hfModalConfirmacaoIPhone">
    </AjaxToolkit:ModalPopupExtender>
    <asp:Panel ID="pnlModalConfirmacaoIPhone" runat="server" CssClass="modal_conteudo candidato reduzida"
        Style="display: none">
        <h2 class="titulo_modal">
            <span>Confirmação</span></h2>
        <asp:UpdatePanel ID="upBtiModalConfirmacaoIPhoneFechar" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <asp:ImageButton CssClass="botao_fechar_modal" ID="btiModalConfirmacaoIPhoneFechar"
                    ImageUrl="/img/botao_padrao_fechar.gif" runat="server" CausesValidation="false" />
            </ContentTemplate>
        </asp:UpdatePanel>
        <div class="icone_confirmacao">
            <img alt="" src="/img/img_icone_aviso_88x88.png" />
        </div>
        <p class="texto_aviso">
            Você esta logado(a) como
            <asp:UpdatePanel ID="upNome" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                <ContentTemplate>
            ...
            <p class="texto_aviso">
                Deseja realmente candidatar-se para esta vaga?
            </p>
            <div class="painel_botoes">
                <asp:UpdatePanel ID="upBotoesModalConfirmacaoIPhone" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Button ID="btnModalConfirmacaoIPhoneConfimar" runat="server" CausesValidation="false"
                            CssClass="botao_padrao" OnClick="btnModalConfirmacaoIPhoneConfimar_Click" Text="Sim" />
                        <asp:Button ID="btnModalConfirmacaoIPhoneCancelar" runat="server" CausesValidation="false"
                            CssClass="botao_padrao" OnClick="btnModalConfirmacaoIPhoneCancelar_Click" Text="Não" />
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
            <p>
