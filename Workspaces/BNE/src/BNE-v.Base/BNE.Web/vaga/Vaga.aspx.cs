...
namespace BNE.Web.vaga
{
    public partial class Vaga : BasePage
    {
        ...
        private void PreencherCampos()
        {
            ...
            List<VagaDisponibilidade> vagaDisponibilidade = VagaDisponibilidade.ListarDisponibilidadesPorVaga(objVaga.IdVaga);
            ...
            Page.Title = SitemapHelper.MontarTituloVaga(objVaga.Funcao.DescricaoFuncao, objVaga.Funcao.AreaBNE.DescricaoAreaBNE, (short)objVaga.QuantidadeVaga, objVaga.Cidade.NomeCidade, objVaga.Cidade.Estado.NomeEstado, objVaga.Cidade.Estado.SiglaEstado, objVaga.IdVaga);
        }
        #endregion
