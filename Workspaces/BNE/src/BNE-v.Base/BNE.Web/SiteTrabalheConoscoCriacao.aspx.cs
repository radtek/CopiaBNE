...
namespace BNE.Web
{
    public partial class SiteTrabalheConoscoCriacao : BasePage
    {
        ...
        {
            AjustarPermissoes();
            btnEscolhaTemaAmarelo.Attributes["onClick"] = "return false;";
            btnEscolhaTemaAzul.Attributes["onClick"] = "return false;";
            btnEscolhaTemaCinza.Attributes["onClick"] = "return false;";
            btnEscolhaTemaLaranja.Attributes["onClick"] = "return false;";
            btnEscolhaTemaVerde.Attributes["onClick"] = "return false;";
            btnEscolhaTemaVermelho.Attributes["onClick"] = "return false;";
            PreencherCampos();
        }
        #endregion
        ...
        private void CarregarLogo(Filial objFilial)
        {
            try
            {
                ...
                if (byteArray != null)
                {
                    ...
                    ucFoto.ImageUrl = UIHelper.RetornarUrlLogo(objFilial.CNPJ, PessoaJuridicaLogo.OrigemLogo.Local);
                }
                else
                {
