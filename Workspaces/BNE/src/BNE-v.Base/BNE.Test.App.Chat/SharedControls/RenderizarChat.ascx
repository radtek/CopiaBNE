...
<up:updatepanel runat="server" id="upPrincipalChat" updatemode="Conditional">
    <contenttemplate>
        <script type="text/javascript">var pathRenderJs = "<%= PathToRenderJs %>"; var pathDashboardLink = "<%= DashboardLink %>"; var pathRenderImg = "<%= PathToRenderImg %>"; var pathRenderCss = "<%= PathToRenderCss %>"; var pathRenderThumb = "<%= PathToRenderThumb %>"; var pathRenderLink = "<%= PathToTargetLink %>";</script>

        <script type="text/javascript" src="<%= PathToRenderJs + "/moment.js" %>"></script>
        <script type="text/javascript" src="<%= PathToRenderJs + "/linq.js" %>"></script>
        <script type="text/javascript" src="<%= PathToRenderJs + "/knockout-3.1.0.js" %>"></script>

        <script type="text/javascript" src="<%= PathToRenderJs + "/json2.js" %>"></script>
        <script type="text/javascript" src="<%= PathToRenderJs + "/jstorage.js" %>"></script>
        <script type="text/javascript" src="<%= PathToRenderJs + "/jquery.signalR-1.2.1.js" %>"></script>
        <script type="text/javascript" src="/signalr/hubs"></script>
        <script type="text/javascript" src="<%= PathToRenderJs + "/webchat.js" %>"></script>

        <script type="text/javascript" src="<%= PathToRenderJs + "/statechat.js" %>"></script>
        <script type="text/javascript" src="<%= PathToRenderJs + "/visualchat.js" %>"></script>
        <script type="text/javascript" src="<%= PathToRenderJs + "/viewmodelchat.js" %>"></script>

        <link rel="stylesheet" type="text/css" href="<%= PathToRenderCss + "/chat.css" %>" />
        <link rel="stylesheet" type="text/css" href="<%= PathToRenderCss + "/balao.css" %>" />
        <link rel="stylesheet" type="text/css" href="<%= PathToRenderCss + "/info.css" %>" />
        <link rel="stylesheet" type="text/css" href="<%= PathToRenderCss + "/pessoasFila.css" %>" />

        <style>
            .containerIconTopoDoc {
                background-image: url("<%= PathToRenderImg + "/iconTopoDoc.png"%>");
        ...
        <script type="text/html" id="message-chat-template">
                ...
                <!-- ko if: !errorToSend() -->
                    <!-- ko if: (statusMessage() >= 0 && statusMessage() < 5) -->
                        <img class="checked" src="<%= PathToRenderImg + "/checked.png"%>" data-bind="visible: owner" />
                    <!-- /ko -->
            ...
            <div class="janela_chat" data-bind="uniqueId: 'janela_chat_' + letter + '_', attr: { style: maximized() ? 'position: inherit; bottom:0px;' : 'position:relative; bottom:-288px;' }" >
                ...
                <div class="primaryContainerChat">
                    <div class="topo_verde"
                        ...
                        <img  data-bind="visible: maximized, click: function (s, e) { MoreInfoClick(s, e); $data.getMoreInfo(); }"  src="<%= PathToRenderImg + "/info.png"%>" class="image" />
                        <img  data-bind="click: CloseActiveWindowClick"  src="<%= PathToRenderImg + "/fechar.png"%>" class="fechar" />
                    </div>
             ...
             <li class="online_contact" data-bind="event: { mouseover: overEvent, mouseout: overEvent }, click: function (s, e) { $data.openChat(); }">
                 <div class="container_online_contact_info" data-bind="attr: { title: title }">
                        <div class="container_contact_info_left">
                            <img class="img_online_contact" data-bind="attr: { src: $data.thumbTargetImage() }"></img>
                        </div>
                    ...
                    <div class="container_notificacoes">
                        ...
                        <div id="box_excesso_pessoas">
                            <div class="box_janelas_pendentes">
                                <img src="<%= PathToRenderImg + "/balaob.png"%>" class="balaob" />
                                <img src="<%= PathToRenderImg + "/balao.png"%>" class="balao" />
                            </div>
