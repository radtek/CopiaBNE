...
namespace BNE.CLR.Custom
{
    public static class FormatObject
    {
        ...
        /// <returns></returns>
        public static string ToString(object anObject, string aFormat)
        {
            return ToString(anObject, aFormat, null);
        }

        public static string ToString(object anObject, string aFormat, IFormatProvider formatProvider)
        {
