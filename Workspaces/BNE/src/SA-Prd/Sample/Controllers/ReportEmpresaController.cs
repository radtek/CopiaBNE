...
{
    public class ReportEmpresaController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            reportViewer.ServerReport.ReportPath = "/TfsReports/BNE/Vendas VIP";
