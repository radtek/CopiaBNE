...
{
    public class ApiIndicadorSituacaoEmpresaComPlanoController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetVWEmpresas()
        {
            using (var context = new Model())
            {
                var result = context.Database
                      .SqlQuery<Indicadores>("dbo.getIndicadoresSituacaoEmpresaComPlano")
                      .ToList();
        ...
        public async Task<IHttpActionResult> Indices(decimal id)
       {
           ...
           using (var context = new Model())
           {
               ...
               var result = context.Database
                   .SqlQuery<Indicadores>("dbo.getIndicadoresSituacaoEmpresaComPlano @cpf", filial)
                   .ToList();
