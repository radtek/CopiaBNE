...
namespace Sample.Controllers
{
    public class VisualizacaoEmpresaController : Controller
    {
        ...
        public async Task<ActionResult> Details(decimal id,string msg, VisualizacaoEmpresa model)
        {
            if (id == null)
            {
            ...
            using (var context = new Model())
            {
                ...
                var result = context.Database
                    .SqlQuery<Visualizacao>("dbo.SP_Visualizacao_Curriculos @PageNumber, @RowspPage, @num_cnpj, @Qtd_Total out ", pag, rowPag, Num_CNPJ, Qtd_Total)
                    .ToList();
            ...
            ViewBag.nme_empresa = msg.Replace("/","-").Replace(":"," ");
            return View(model);
        }
