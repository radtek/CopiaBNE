...
namespace BNE.Services.AsyncServices.BLL
{
    public partial class Atividade // Tabela: TAB_Atividade
    {
        ...
        public static void AtualizarStatusAtividade(int idAtividade, Services.AsyncServices.BLL.Enumeradores.StatusAtividade tipoAtividade)
        {
            var parms = new List<SqlParameter>
                {
            ...
            var parms = new List<SqlParameter>
                {
                    ...
                    new SqlParameter { ParameterName = "@Status_Aguardando_Execucao", SqlDbType = SqlDbType.Int, Value = (int)Services.AsyncServices.BLL.Enumeradores.StatusAtividade.AguardandoExecucao } ,
