        ...
        public PartialViewResult Passo2(Models.CadastroEmpresa model)
        {
            ...
            try
            {
                ...
                if (responseMessage.IsSuccessStatusCode)
                {
                    ...
                    {
                        service.Post(LinkController.EnderecoApiPessoaJuridica(), "/cadastro/click2call", null, serializer.Serialize(new { Numero = content.numero.ToString(), Nome = content.nome.ToString() }));
                    }
