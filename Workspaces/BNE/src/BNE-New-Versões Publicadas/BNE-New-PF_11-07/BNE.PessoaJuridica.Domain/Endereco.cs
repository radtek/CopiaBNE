...
namespace BNE.PessoaJuridica.Domain
{
    public class Endereco
    {
        ...
        public Endereco(IEnderecoRepository enderecoRepository, Global.Domain.Cidade cidade, Global.Domain.Bairro bairro)
        {
        ...
        public void SalvarEndereco(Model.PessoaJuridica objPessoaJuridica, Command.CriarOuAtualizarPessoaJuridica command, DateTime baseData)
        {
        ...
        public bool TemParametrosParaCriarEndereco(Command.CriarOuAtualizarPessoaJuridica command)
        {
