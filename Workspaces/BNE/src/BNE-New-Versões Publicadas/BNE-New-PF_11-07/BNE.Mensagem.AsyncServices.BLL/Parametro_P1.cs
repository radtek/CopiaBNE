...
namespace BNE.Mensagem.AsyncServices.BLL
{
    public partial class Parametro // Tabela: plataforma.TAB_Parametro
    {
        ...
        public Parametro(short idParametro)
        {
        ...
        private List<SqlParameter> GetParameters()
        {
            ...
            parms.Add(new SqlParameter("@Idf_Parametro", SqlDbType.SmallInt, 2));
        ...
        private static bool SetInstance(IDataReader dr, Parametro objParametro)
        {
            try
            {
                if (dr.Read())
                {
                    objParametro._idParametro = Convert.ToInt16(dr["Idf_Parametro"]);
