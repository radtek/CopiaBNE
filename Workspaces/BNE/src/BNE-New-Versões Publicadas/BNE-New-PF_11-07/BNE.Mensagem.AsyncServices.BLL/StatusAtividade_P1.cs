...
{
    public partial class StatusAtividade // Tabela: atividade.TAB_Status_Atividade
    {
        #region Atributos
        private byte _idStatusAtividade;
        ...
        public StatusAtividade(byte idStatusAtividade)
        {
        ...
        #region Consultas
        private const string SPINSERT = "INSERT INTO atividade.TAB_Status_Atividade (Des_Status_Atividade) VALUES (@Des_Status_Atividade);SET @Idf_Status_Atividade = SCOPE_IDENTITY();";
        private const string SPUPDATE = "UPDATE atividade.TAB_Status_Atividade SET Des_Status_Atividade = @Des_Status_Atividade WHERE Idf_Status_Atividade = @Idf_Status_Atividade";
        private const string SPDELETE = "DELETE FROM atividade.TAB_Status_Atividade WHERE Idf_Status_Atividade = @Idf_Status_Atividade";
        private const string SPSELECTID = "SELECT * FROM atividade.TAB_Status_Atividade WHERE Idf_Status_Atividade = @Idf_Status_Atividade";
        #endregion
        ...
        private List<SqlParameter> GetParameters()
        {
            ...
            parms.Add(new SqlParameter("@Idf_Status_Atividade", SqlDbType.TinyInt, 1));
            ...
            using (SqlConnection conn = new SqlConnection(DataAccessLayer.CONN_STRING))
            {
                ...
                using (SqlTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        ...
                        this._idStatusAtividade = Convert.ToByte(cmd.Parameters["@Idf_Status_Atividade"].Value);
        ...
        public static IDataReader LoadDataReader(string colunaOrdenacao, string direcaoOrdenacao, int paginaCorrente, int tamanhoPagina, out int totalRegistros)
        {
            ...
            string SPSELECTPAG = "SELECT ROW_NUMBER() OVER (ORDER BY " + colunaOrdenacao + " " + direcaoOrdenacao + ") AS RowID, Sta.Idf_Status_Atividade, Sta.Des_Status_Atividade FROM plataforma.TAB_Status_Atividade Sta";
        ...
        private static bool SetInstance(IDataReader dr, StatusAtividade objStatusAtividade)
        {
            try
            {
                if (dr.Read())
                {
                    objStatusAtividade._idStatusAtividade = Convert.ToByte(dr["Idf_Status_Atividade"]);
