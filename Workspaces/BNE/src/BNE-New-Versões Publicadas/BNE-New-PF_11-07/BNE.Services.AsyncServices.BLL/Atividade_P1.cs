...
namespace BNE.Services.AsyncServices.BLL
{
    public partial class Atividade // Tabela: TAB_Atividade
    {
        ...
        #region Consultas
        private const string SPINSERT = "INSERT INTO TAB_Atividade (Idf_Plugins_Compatibilidade, Idf_Status_Atividade, Des_Parametros_Entrada, Des_Parametros_Saida, Dta_Cadastro,Des_Erro, Dta_Execucao, Flg_Inativo) VALUES (@Idf_Plugins_Compatibilidade, @Idf_Status_Atividade, @Des_Parametros_Entrada, @Des_Parametros_Saida, @Dta_Cadastro, @Des_Erro, @Dta_Execucao, @Flg_Inativo);SET @Idf_Atividade = SCOPE_IDENTITY();";
        private const string SPUPDATE = "UPDATE TAB_Atividade SET Idf_Plugins_Compatibilidade = @Idf_Plugins_Compatibilidade, Idf_Status_Atividade = @Idf_Status_Atividade, Des_Parametros_Entrada = @Des_Parametros_Entrada, Des_Parametros_Saida = @Des_Parametros_Saida, Dta_Cadastro = @Dta_Cadastro, Des_Erro = @Des_Erro, Dta_Execucao = @Dta_Execucao, Flg_Inativo = @Flg_Inativo WHERE Idf_Atividade = @Idf_Atividade";
