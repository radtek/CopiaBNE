...
{
	public partial class TipoAtividade // Tabela: plataforma.TAB_Tipo_Atividade
	{
		#region Atributos
		...
		#region Consultas
		private const string SPINSERT = "INSERT INTO plataforma.TAB_Tipo_Atividade (Des_Tipo_Atividade, Flg_Inativo, Num_Dias_Expiracao, Dta_Cadastro) VALUES (@Des_Tipo_Atividade, @Flg_Inativo, @Num_Dias_Expiracao, @Dta_Cadastro);SET @Idf_Tipo_Atividade = SCOPE_IDENTITY();";
		private const string SPUPDATE = "UPDATE plataforma.TAB_Tipo_Atividade SET Des_Tipo_Atividade = @Des_Tipo_Atividade, Flg_Inativo = @Flg_Inativo, Num_Dias_Expiracao = @Num_Dias_Expiracao, Dta_Cadastro = @Dta_Cadastro WHERE Idf_Tipo_Atividade = @Idf_Tipo_Atividade";
		private const string SPDELETE = "DELETE FROM plataforma.TAB_Tipo_Atividade WHERE Idf_Tipo_Atividade = @Idf_Tipo_Atividade";
		private const string SPSELECTID = "SELECT * FROM plataforma.TAB_Tipo_Atividade WHERE Idf_Tipo_Atividade = @Idf_Tipo_Atividade";
		#endregion
