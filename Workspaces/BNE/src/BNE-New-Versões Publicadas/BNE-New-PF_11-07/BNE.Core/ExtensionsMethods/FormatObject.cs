...
namespace BNE.Core.ExtensionsMethods
{
    ...
    {
        private static readonly Regex Regex = new Regex(@"({)([^}]+)(})", RegexOptions.IgnoreCase);
        ...
        {
            var expandoObject = anObject as ExpandoObject;
            if (expandoObject != null)
                return ToString(expandoObject, aFormat, null);
        ...
        public static string ToString(this ExpandoObject anObject, string aFormat, IFormatProvider formatProvider = null)
        {
            ...
            foreach (Match m in mc)
            {
                ...
                if (((IDictionary<string, object>)anObject).TryGetValue(toGet, out retrievedObject)) //Cool, we found something
                {
