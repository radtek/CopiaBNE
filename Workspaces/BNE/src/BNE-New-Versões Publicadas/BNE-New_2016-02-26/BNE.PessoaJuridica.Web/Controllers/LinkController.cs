...
namespace BNE.PessoaJuridica.Web.Controllers
{
    public class LinkController : Controller
    {
        ...
        {
            return RecuperarURL(URLBNE, "atualizar-dados-empresa");
        }
        #endregion
        ...
        #region LogarBNE
        public string LogarBNE(string destino)
        {
            return RecuperarURL(URLBNE, "logar/" + destino);
        }
        #endregion

        #region RecuperarURL
        private string RecuperarURL(string prefix, string destino)
        {
            var protocol = "http";
            ...
            return string.Format(URLPattern, protocol, prefix, destino);
        }
        #endregion

        public static string EnderecoApiPessoaJuridica()
        {
            return "http://" + System.Web.HttpContext.Current.Application[Enumeradores.ApplicationKeys.EnderecoApiPessoaJuridica.ToString()];
        }
