...
namespace BNE.PessoaFisica.Web
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/pre-curriculo", "/" + pathToStaticFiles + "/bundles/pre-curriculo" + FileVersion("~/Scripts/pre-curriculo.js")).Include("~/Scripts/pre-curriculo.js").Include("~/Scripts/jquery.bpopup.min.js"));
            ...
            bundles.Add(new ScriptBundle("~/bundles/banner-posso-ajudar", "/" + pathToStaticFiles + "/bundles/banner-posso-ajudar" + FileVersion("~/Scripts/site/banner-posso-ajudar.js")).Include("~/Scripts/site/banner-posso-ajudar.js"));
