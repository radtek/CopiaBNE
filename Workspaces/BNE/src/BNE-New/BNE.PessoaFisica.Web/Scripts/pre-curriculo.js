...
function ConfigurarPasso1() {
    ...
    bne.components.web.radiobutton('option-masc', true);
...
function ConfigurarIndicacao() {
    ...
    bne.components.web.textbox('txtNomeIndicadoUm', true, bne.components.web.textbox.type.nome);
    bne.components.web.textbox('txtNomeIndicadoDois', true, bne.components.web.textbox.type.nome);
    bne.components.web.textbox('txtNomeIndicadoTres', true, bne.components.web.textbox.type.nome);

    bne.components.web.autocomplete.email('txtEmailIndicadoUm', true, true);
    bne.components.web.autocomplete.email('txtEmailIndicadoDois', true, true);
    bne.components.web.autocomplete.email('txtEmailIndicadoTres', true, true);
...
function Pergunta() {
    ...
    for(var i=0; i< val.length;i++){
        bne.components.web.textbox(val[i].id, true, bne.components.web.textbox.type.text);
    }

    var val = document.getElementsByClassName("validarRadio");
    for (var i = 0; i < val.length; i++) {
        bne.components.web.radiobutton(val[i].id, true);
    }
