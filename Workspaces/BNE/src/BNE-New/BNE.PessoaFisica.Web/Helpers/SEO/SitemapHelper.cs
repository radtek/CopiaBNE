...
namespace BNE.PessoaFisica.Web.Helpers.SEO
{
    public class SitemapHelper
    {
        ...
        static readonly string SitemapTituloVaga = "Vaga de {Emprego} {Funcao} em {Cidade}/{SiglaEstado} - Vaga {Identificador} | BNE - Banco Nacional de Empregos";
        ...
        /// <returns></returns>
        public static string MontarTituloVaga(string nomeFuncao, bool eEstagio, string nomeAreaBNE, short quantidadeVaga, string nomeCidade, string nomeEstado, string siglaEstado, int identificadorVaga)
        {
            ...
            var parametros = new
            {
                ...
                Emprego = eEstagio ? "Estágio para" : "Emprego de"
            };
