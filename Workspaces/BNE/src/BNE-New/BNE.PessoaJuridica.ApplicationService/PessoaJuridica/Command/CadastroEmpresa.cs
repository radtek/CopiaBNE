...
namespace BNE.PessoaJuridica.ApplicationService.PessoaJuridica.Command
{
    public class CadastroEmpresa
    {
        ...
        public CadastroUsuarioEmpresa Usuario { get; set; }
        public List<CadastroUsuarioAdicionalEmpresa> UsuariosAdicionais { get; set; }

    }

    public class CadastroUsuarioAdicionalEmpresa
    {
