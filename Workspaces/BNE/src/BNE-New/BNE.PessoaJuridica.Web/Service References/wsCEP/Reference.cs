...
namespace BNE.PessoaJuridica.Web.wsCEP {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="wsCEP.ICEP")]
    public interface ICEP {
        ...
        BNE.PessoaJuridica.Web.wsCEP.CompletarCEPResponse CompletarCEP(BNE.PessoaJuridica.Web.wsCEP.CompletarCEPRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICEP/CompletarCEP", ReplyAction="http://tempuri.org/ICEP/CompletarCEPResponse")]
        System.Threading.Tasks.Task<BNE.PessoaJuridica.Web.wsCEP.CompletarCEPResponse> CompletarCEPAsync(BNE.PessoaJuridica.Web.wsCEP.CompletarCEPRequest request);
        ...
        int RecuperarQuantidadeEnderecosPorCEP(BNE.PessoaJuridica.Web.wsCEP.CEP cep);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICEP/RecuperarQuantidadeEnderecosPorCEP", ReplyAction="http://tempuri.org/ICEP/RecuperarQuantidadeEnderecosPorCEPResponse")]
        System.Threading.Tasks.Task<int> RecuperarQuantidadeEnderecosPorCEPAsync(BNE.PessoaJuridica.Web.wsCEP.CEP cep);
        ...
        BNE.PessoaJuridica.Web.wsCEP.CEP[] ConsultaCEP(string cep, string logradouro, string tipoLogradouro, string bairro, string estado, string cidade, string ordenacao);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICEP/ConsultaCEP", ReplyAction="http://tempuri.org/ICEP/ConsultaCEPResponse")]
        System.Threading.Tasks.Task<BNE.PessoaJuridica.Web.wsCEP.CEP[]> ConsultaCEPAsync(string cep, string logradouro, string tipoLogradouro, string bairro, string estado, string cidade, string ordenacao);
        ...
        BNE.PessoaJuridica.Web.wsCEP.ConsultaCEPPaginacaoResponse ConsultaCEPPaginacao(BNE.PessoaJuridica.Web.wsCEP.ConsultaCEPPaginacaoRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICEP/ConsultaCEPPaginacao", ReplyAction="http://tempuri.org/ICEP/ConsultaCEPPaginacaoResponse")]
        System.Threading.Tasks.Task<BNE.PessoaJuridica.Web.wsCEP.ConsultaCEPPaginacaoResponse> ConsultaCEPPaginacaoAsync(BNE.PessoaJuridica.Web.wsCEP.ConsultaCEPPaginacaoRequest request);
        ...
        BNE.PessoaJuridica.Web.wsCEP.CEP[] ListarCeps(string csvCEPs);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICEP/ListarCeps", ReplyAction="http://tempuri.org/ICEP/ListarCepsResponse")]
        System.Threading.Tasks.Task<BNE.PessoaJuridica.Web.wsCEP.CEP[]> ListarCepsAsync(string csvCEPs);
    }
    ...
    public partial class CompletarCEPRequest {
        ...
        public BNE.PessoaJuridica.Web.wsCEP.CEP cep;
        
        public CompletarCEPRequest() {
        }
        
        public CompletarCEPRequest(BNE.PessoaJuridica.Web.wsCEP.CEP cep) {
            this.cep = cep;
        }
    }
    ...
    public partial class CompletarCEPResponse {
        ...
        public CompletarCEPResponse(BNE.PessoaJuridica.Web.wsCEP.CEP cep) {
            this.cep = cep;
        }
    }
    ...
    public partial class ConsultaCEPPaginacaoRequest {
        ...
        public BNE.PessoaJuridica.Web.wsCEP.Colunas nomeColuna;
        
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://tempuri.org/", Order=7)]
        public BNE.PessoaJuridica.Web.wsCEP.DirecaoOrdenacao direcaoOrdenacao;
        ...
        public ConsultaCEPPaginacaoRequest(string cep, string logradouro, string tipoLogradouro, string bairro, string estado, string cidade, BNE.PessoaJuridica.Web.wsCEP.Colunas nomeColuna, BNE.PessoaJuridica.Web.wsCEP.DirecaoOrdenacao direcaoOrdenacao, int paginaCorrente, int tamanhoPagina) {
            this.cep = cep;
    ...
    public partial class ConsultaCEPPaginacaoResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://tempuri.org/", Order=0)]
        public BNE.PessoaJuridica.Web.wsCEP.CEP[] ConsultaCEPPaginacaoResult;
        ...
        public ConsultaCEPPaginacaoResponse(BNE.PessoaJuridica.Web.wsCEP.CEP[] ConsultaCEPPaginacaoResult, int totalRegistros) {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ICEPChannel : BNE.PessoaJuridica.Web.wsCEP.ICEP, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CEPClient : System.ServiceModel.ClientBase<BNE.PessoaJuridica.Web.wsCEP.ICEP>, BNE.PessoaJuridica.Web.wsCEP.ICEP {
        ...
        BNE.PessoaJuridica.Web.wsCEP.CompletarCEPResponse BNE.PessoaJuridica.Web.wsCEP.ICEP.CompletarCEP(BNE.PessoaJuridica.Web.wsCEP.CompletarCEPRequest request) {
            return base.Channel.CompletarCEP(request);
        }
        
        public void CompletarCEP(ref BNE.PessoaJuridica.Web.wsCEP.CEP cep) {
            BNE.PessoaJuridica.Web.wsCEP.CompletarCEPRequest inValue = new BNE.PessoaJuridica.Web.wsCEP.CompletarCEPRequest();
            inValue.cep = cep;
            BNE.PessoaJuridica.Web.wsCEP.CompletarCEPResponse retVal = ((BNE.PessoaJuridica.Web.wsCEP.ICEP)(this)).CompletarCEP(inValue);
            cep = retVal.cep;
        }
        
        public System.Threading.Tasks.Task<BNE.PessoaJuridica.Web.wsCEP.CompletarCEPResponse> CompletarCEPAsync(BNE.PessoaJuridica.Web.wsCEP.CompletarCEPRequest request) {
            return base.Channel.CompletarCEPAsync(request);
        }
        
        public int RecuperarQuantidadeEnderecosPorCEP(BNE.PessoaJuridica.Web.wsCEP.CEP cep) {
            return base.Channel.RecuperarQuantidadeEnderecosPorCEP(cep);
        }
        
        public System.Threading.Tasks.Task<int> RecuperarQuantidadeEnderecosPorCEPAsync(BNE.PessoaJuridica.Web.wsCEP.CEP cep) {
            return base.Channel.RecuperarQuantidadeEnderecosPorCEPAsync(cep);
        }
        
        public BNE.PessoaJuridica.Web.wsCEP.CEP[] ConsultaCEP(string cep, string logradouro, string tipoLogradouro, string bairro, string estado, string cidade, string ordenacao) {
            return base.Channel.ConsultaCEP(cep, logradouro, tipoLogradouro, bairro, estado, cidade, ordenacao);
        }
        
        public System.Threading.Tasks.Task<BNE.PessoaJuridica.Web.wsCEP.CEP[]> ConsultaCEPAsync(string cep, string logradouro, string tipoLogradouro, string bairro, string estado, string cidade, string ordenacao) {
            return base.Channel.ConsultaCEPAsync(cep, logradouro, tipoLogradouro, bairro, estado, cidade, ordenacao);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        BNE.PessoaJuridica.Web.wsCEP.ConsultaCEPPaginacaoResponse BNE.PessoaJuridica.Web.wsCEP.ICEP.ConsultaCEPPaginacao(BNE.PessoaJuridica.Web.wsCEP.ConsultaCEPPaginacaoRequest request) {
            return base.Channel.ConsultaCEPPaginacao(request);
        }
        
        public BNE.PessoaJuridica.Web.wsCEP.CEP[] ConsultaCEPPaginacao(string cep, string logradouro, string tipoLogradouro, string bairro, string estado, string cidade, BNE.PessoaJuridica.Web.wsCEP.Colunas nomeColuna, BNE.PessoaJuridica.Web.wsCEP.DirecaoOrdenacao direcaoOrdenacao, int paginaCorrente, int tamanhoPagina, out int totalRegistros) {
            BNE.PessoaJuridica.Web.wsCEP.ConsultaCEPPaginacaoRequest inValue = new BNE.PessoaJuridica.Web.wsCEP.ConsultaCEPPaginacaoRequest();
            inValue.cep = cep;
            ...
            BNE.PessoaJuridica.Web.wsCEP.ConsultaCEPPaginacaoResponse retVal = ((BNE.PessoaJuridica.Web.wsCEP.ICEP)(this)).ConsultaCEPPaginacao(inValue);
            totalRegistros = retVal.totalRegistros;
            return retVal.ConsultaCEPPaginacaoResult;
        }
        
        public System.Threading.Tasks.Task<BNE.PessoaJuridica.Web.wsCEP.ConsultaCEPPaginacaoResponse> ConsultaCEPPaginacaoAsync(BNE.PessoaJuridica.Web.wsCEP.ConsultaCEPPaginacaoRequest request) {
            return base.Channel.ConsultaCEPPaginacaoAsync(request);
        }
        
        public BNE.PessoaJuridica.Web.wsCEP.CEP[] ListarCeps(string csvCEPs) {
            return base.Channel.ListarCeps(csvCEPs);
        }
        
        public System.Threading.Tasks.Task<BNE.PessoaJuridica.Web.wsCEP.CEP[]> ListarCepsAsync(string csvCEPs) {
