...
namespace BNE.PessoaJuridica.Domain.Services
{
    public class UsuarioService
    {
        ...
        public UsuarioService(IUsuarioRepository usuarioRepository, Global.Domain.Sexo sexo, TelefoneComercialService telefoneComercial, TelefoneCelularService telefoneCelular)
        {
        ...
        /// <returns></returns>
        public string GerarHashAcessoLoginAutomatico(Usuario objUsuario, string urlDestino)
        {
            if (urlDestino == null)
            ...
            return Utils.ToBase64(json).Replace("/", "_");
        }
        #endregion
