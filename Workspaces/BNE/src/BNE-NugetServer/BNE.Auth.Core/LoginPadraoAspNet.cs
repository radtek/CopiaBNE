...
namespace BNE.Auth.Core
{
    public class LoginPadraoAspNet : ILoginPadraoAspNet
    {
        ...
        public Func<HttpContextBase> _contextAccessor;
        ...
        public void Deslogar(bool abandonarSessao = true, bool clearSession = false)
        {
            ...
            LogoffInternal(context, abandonarSessao, clearSession);
        ...
        protected virtual void LogoffInternal(HttpContextBase context, bool abandonSession, bool clearSession = false)
        {
            try
            {
                ...
                LimparSessao(context.Session, clearSession);
            }
            finally
            {
        ...
        protected virtual void LimparSessao(HttpSessionStateBase session, bool clearSession = false)
        {
            if (session != null)
            {
                if (clearSession)
