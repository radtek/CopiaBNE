            ...
            if (listaEmail != null)
            {
                foreach (MensagemPlugin.MensagemEmail objMensagem in listaEmail)
                {
                    ...
                    if (objMensagem.Arquivo != null)
                        enviado = Core.SendMail(objMensagem.From, objMensagem.To, objMensagem.Assunto, objMensagem.Descricao, objMensagem.Arquivo, objMensagem.Tags);
                    else
                        enviado = Core.SendMail(objMensagem.From, objMensagem.To, objMensagem.Assunto, objMensagem.Descricao, objMensagem.Tags);
