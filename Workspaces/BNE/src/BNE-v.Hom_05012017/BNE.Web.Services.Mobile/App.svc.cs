...
namespace BNE.Web.Services.Mobile
{
    public class App : IApp
    {
        ...
        public OutStatusDTO Candidatar(InCandidatarDTO candidatar)
        {
            ...
            {
                EL.GerenciadorException.GravarExcecao(ex, "erro candidatura App");
        ...
        public OutCandidaturaTanqueDTO CandidatarTanque(InCandidatarDTO candidatar)
        {
            ...
            {
                EL.GerenciadorException.GravarExcecao(ex, "erro candidaturpa Ap");
                dto.Status = (int)Status.ERRO;
                dto.erro = ex.Message;
                return dto;
            }
        ...
        public OutStatusDTO LiberarVIP(int c, int p, string pt, string oid)
        {
            ...
            try
            {
                if (string.IsNullOrEmpty(pt)) return new OutStatusDTO() { Status = (int)Status.INSUCESSO_NAO, erro = "Não existe um transação válida" };
