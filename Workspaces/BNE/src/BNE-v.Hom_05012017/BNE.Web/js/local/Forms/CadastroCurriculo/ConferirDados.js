...
$(document).ready(function () {
    ...
    autocomplete.cidade("txtCidadeFormacao");
    autocomplete.cidade("txtCidadeEspecializacao");
    autocomplete.cidade("txtCidadeComplementar");
...
function ValidarDataDemissao(campoDtaAdmissao, campoDtaDemissao, divAviso) {
    ...
    var dataAtualMais30Dias = new Date(dataAtual.setDate(dataAtual.getDate() + 30));

    var ano = dataAtualMais30Dias.getFullYear();
    var mes = (parseInt(dataAtualMais30Dias.getMonth()) + 1);
    var dia = (dataAtualMais30Dias.getDate().toString() < 10 ? '0' : '') + dataAtualMais30Dias.getDate().toString();
    var data30Dias = ano + (mes < 10 ? '0' : '') + mes + '' + dia;
    ...
    if (dataAdmissao > dataDemissao || dataDemissao > data30Dias) {
