...
<div class="linha">
 ...
 AutoPostBack="true" RepeatColumns="3" runat="server" OnSelectedIndexChanged="rblContrato_SelectedIndexChanged" />
        <%--<asp:CheckBoxList ID="chblContrato" RepeatDirection="Horizontal" AutoPostBack="true"
            RepeatColumns="3" runat="server" OnSelectedIndexChanged="chblContrato_SelectedIndexChanged"  />--%>
    </div>
</div>
