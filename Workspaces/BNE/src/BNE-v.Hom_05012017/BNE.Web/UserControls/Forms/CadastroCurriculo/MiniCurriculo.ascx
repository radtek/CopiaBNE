            ...
            <asp:UpdatePanel ID="upFoto" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <Componentes:SelecionarFoto ID="ucFoto" runat="server" AspectRatio="3:4" InitialSelection="5;5;75;100"
                        ...
                        MaxWidth="1280" OnError="ucFoto_Error" PainelRemoverImagemCssClass="" />
                </ContentTemplate>
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="btlExisteFotoWS" EventName="Click" />
                </Triggers>
            </asp:UpdatePanel>
...
<%--INICIO - MODAL DE CONFIRMAÇÃO DE ENDEREÇO--%>
  <AjaxToolkit:ModalPopupExtender ID="mpeEndereco" runat="server" PopupControlID="pnlModalEndereco"
            TargetControlID="hfModalEndereco" />
  <asp:HiddenField ID="hfModalEndereco" runat="server" />
        <asp:Panel ID="pnlModalEndereco" runat="server" CssClass="modal_confirmacao_registro candidato reduzida"
            Style="display: none; background-color: #ebeff2 !important; height: auto !important;">
            <asp:UpdatePanel ID="upConteudoCep" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <div class="imagem_cadastro_alert_endereco" id="divAlert" runat="server"></div>

                    <div class="container_confirmacao_candidatura">
                        <h2 class="titulo_modal">
                        <asp:Label ID="texto_confirmacao" runat="server" Text=""></asp:Label></h2>
                        <p class="texto_enviado_sucesso">
                            <asp:Label ID="lblTitulo" runat="server" Text="Você ja possui uma cidade de residencia cadastrada."></asp:Label><br />
                             Para continuar confirme o seu cep.
                            <asp:Label ID="lblTextoAuxiliar" runat="server" Visible="false" CssClass="texto_menor" Text="">
                            </asp:Label><br />
                            <div style="text-align:center;">
                                  <uc1:ucEndereco ID="ucEndereco" runat="server" />
                                </div>
                            <div class="btnVoltar" style="text-align:center;">
                            <asp:Button ID="btnConfirmar" runat="server" Text="Confirmar" ValidationGroup="valCep" OnClientClick="return CepRequired();" OnClick="btnSalvarCurriculo_Click" CausesValidation="false"></asp:Button>
                                 </div>
                        </p>
                    </div>
                </ContentTemplate>
