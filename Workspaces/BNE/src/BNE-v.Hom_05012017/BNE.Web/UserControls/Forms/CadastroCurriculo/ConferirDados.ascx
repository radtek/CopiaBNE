                            ...
                            <div class="linha">
                                ...
                                <div class="container_campo">
                                    <componente:ValorDecimal ID="txtUltimoSalario" runat="server" CasasDecimais="0" ValidationGroup="CadastroExperiencia"
                                        ValorMinimo="1" Obrigatorio="false" ValorMaximo="999999" CssClassTextBox="textbox_padrao" MensagemErroObrigatorio="Campo obrigatório" />
                                
                                </div>
                                <label class="decimais">,00</label>
                            </div>
...
<asp:Panel ID="pnlBotoes" runat="server" CssClass="painel_botoes">
    <asp:UpdatePanel ID="upPnlBotoes" runat="server">
        <ContentTemplate>
            <asp:Button ID="btnSalvar" runat="server" Text="Ver Vagas" OnClick="btnSalvar_Click"
            ...
            <asp:Button ID="btnImprimirCurriculo" runat="server" OnClick="btnImprimirCurriculo_Click"
                ...
                Text="Imprimir" />
            <asp:Button ID="btnEnviarCurriculo" runat="server" CssClass="botao_padrao" Text="Enviar por e-mail"
