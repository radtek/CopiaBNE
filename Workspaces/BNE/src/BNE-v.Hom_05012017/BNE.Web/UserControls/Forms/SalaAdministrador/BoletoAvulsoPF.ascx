<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BoletoAvulsoPF.ascx.cs"
    Inherits="BNE.Web.UserControls.Forms.SalaAdministrador.BoletoAvulsoPF" %>
...
<asp:Panel ID="idDadosCliente" runat="server" CssClass="blocodados">
    ...
    <%--Linha Nome Completo----%>
    <div class="linha">
        <asp:Label ID="lblNomeCompletoUsuario" runat="server" Text="Nome Completo" CssClass="label_principal" />
        <span class="container_campo dados_empresa">Fulano de Tal da Silva        </span>
    </div>
    <%--FIM Razão Social--%>
    <%--Linha CPF----%>
    <div class="linha">
        <asp:Label ID="lblCPF" runat="server" Text="CPF" CssClass="label_principal" />
        <span class="container_campo dados_empresa">000000000-00</span>
    </div>
    <%--FIM CPF--%>
    <%--Linha Data de Nascimento----%>
    <div class="linha">
        <asp:Label ID="lblDataNascimento" runat="server" Text="Data de Nascimento" CssClass="label_principal" />
        <span class="container_campo dados_empresa">00/00/0000</span>
    </div>
    <%--FIM Data de Nascimento--%>
    <%--Linha e-mail----%>
    <div class="linha">
        <asp:Label ID="lblEmail" runat="server" Text="E-mail" CssClass="label_principal" />
        <span class="container_campo dados_empresa">emaildofulanodetal@gmail.com</span>
    </div>
    <%--FIM e-mail--%>
    <%--Linha Último Plano----%>
    <div class="linha">
        <asp:Label ID="lblUltimoPlano" runat="server" Text="Último Plano" CssClass="label_principal" />
        <span class="container_campo dados_empresa">VIP - 30 dias</span>
    </div>
    <%--FIM Último Plano--%> 
    <%--Linha Adquirido----%>
    <div class="linha">
        <asp:Label ID="lblAdquirido" runat="server" Text="Adquirido" CssClass="label_principal" />
    ...
    <div class="linha">
        ...
        <div class="container_campo">
            <Employer:ComboCheckbox runat="server" ID="ccFiltrarTipoPlano" EmptyMessage=" " AllowCustomText="false"
                CssClass="checkbox_large  campo_obrigatorio">
...
<asp:UpdatePanel ID="upBoletoAvulsoPF" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
            <telerik:RadGrid ID="gvBoletoAvulsoPF" AllowPaging="True" AllowCustomPaging="true"
                CssClass="gridview_padrao" runat="server" Skin="Office2007" GridLines="None"
                OnPageIndexChanged="gvBoletoAvulsoPF_PageIndexChanged">
                ...
                <MasterTableView>
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Ações" ItemStyle-CssClass="col_action tab_boleto_avulso_pf">
                            <ItemTemplate>
