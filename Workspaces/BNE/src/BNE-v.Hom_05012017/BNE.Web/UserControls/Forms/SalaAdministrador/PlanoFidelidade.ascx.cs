    ...
    public partial class PlanoFidelidade : BaseUserControl
    {
        ...
        private PlanoAdquirido Salvar(Plano objPlano)
        {
            ...
            if (objFilial != null)
            {
                ...
                {
                    objPlanoAdquirido.SalvarPlanoAdquiridoParcelaPagamento(objUsuarioFilialPerfil, objFilial, objPlano, objPlanoAdquiridoDetalhes, null, null, txtDataNFAntecipada.ValorDatetime);
                ...
                {
                    objPlanoAdquirido.SalvarPlanoAdquiridoParcelaPagamento(objUsuarioFilialPerfil, objFilial, objPlano, objPlanoAdquiridoDetalhes, txtDataEnvioBoleto.ValorDatetime.Value, txtDataVencimentoBoleto.ValorDatetime.Value, txtDataNFAntecipada.ValorDatetime);
            ...
            else if (IdPessoaFisica.HasValue)
            {
                ...
                {
                    objUsuarioFilialPerfilOld = objUsuarioFilialPerfil.Clone() as UsuarioFilialPerfil;
                    objPlanoAdquirido.SalvarPlanoAdquiridoParcelaPagamento(objUsuarioFilialPerfil, null, objPlano, objPlanoAdquiridoDetalhes, txtDataEnvioBoleto.ValorDatetime, txtDataVencimentoBoleto.ValorDatetime, null);
                }
        ...
        protected void gvPlanos_ItemCommand(object source, GridCommandEventArgs e)
        {
            ...
            else if (e.CommandName.Equals("GerarPdfBoletos"))
            {
                ...
                if(pagamentos.Count > 0)
                    hlPDF.NavigateUrl = BoletoBancario.RetornarBoleto(BoletoBancario.CriarBoletos(pagamentos), Enumeradores.FormatoBoleto.PDF);
