...
namespace BNE.Web.UserControls.Forms.SalaVip
{
    public partial class JaEnviei : BaseUserControl
    {
        ...
        #region gvOportunidade_PageIndexChanged
        protected void gvOportunidade_PageIndexChanged(object source, GridPageChangedEventArgs e)
        {
            PageIndex = e.NewPageIndex + 1;
            CarregarGridOportunidade();
        }
        ...
        public void Inicializar()
        {
            ...
            gvOportunidade.PageSize = quantidadeitens;
            PageIndex = 1;
        ...
        #region CarregarGridVaga
        private void CarregarGridVaga()
        {
            int totalRegistros = 8;
            UIHelper.CarregarRadGrid(gvJaEnviei, VagaCandidato.CarregarVagaCandidatadaPorCurriculo(base.IdCurriculo.Value, false, PageIndex, gvJaEnviei.PageSize, out totalRegistros), totalRegistros);
        ...
        #region CarregarGridOportunidade
        private void CarregarGridOportunidade()
        {
            int totalRegistros = 8;
            UIHelper.CarregarRadGrid(gvOportunidade, VagaCandidato.CarregarVagaCandidatadaPorCurriculo(base.IdCurriculo.Value, true, PageIndex, gvOportunidade.PageSize, out totalRegistros), totalRegistros);

            gvOportunidade.DataBind();
            upGvOportunidade.Update();
        }
        #endregion
