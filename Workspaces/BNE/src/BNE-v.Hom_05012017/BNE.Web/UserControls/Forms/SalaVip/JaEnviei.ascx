            ...
            <telerik:RadGrid ID="gvJaEnviei" AllowPaging="True" AllowCustomPaging="true" CssClass="gridview_padrao"
                ...
                <MasterTableView DataKeyNames="Idf_Filial,Idf_Vaga,Img_Empresa_Confidencial_Visible ">
                    <Columns>
                       ...
                       <%-- <telerik:GridTemplateColumn HeaderText="Situação da vaga" ItemStyle-CssClass="situacao">
                            <ItemTemplate>
                                <asp:Label ID="lblSituacao" runat="server" Text='<%#  Convert.ToBoolean(Eval("Flg_Inativo")) ? "Fechada" : "Aberta" %>' ></asp:Label>
                            </ItemTemplate>
                       ...
                       <%-- <telerik:GridTemplateColumn HeaderText="Ações" ItemStyle-CssClass="col_action_arq">
                            <ItemTemplate>
                                ...
                                <asp:LinkButton Style="padding:1px;font-size:9px"  ID="btiVerEmpresa" runat="server" ToolTip="Ver Empresa" CommandName="VerEmpresa" AlternateText="Ver Empresa"><small>EMPRESA | </small></asp:LinkButton>
                                <asp:LinkButton Style="padding:1px;font-size:10px" class="fa fa-print espacamento" ID="btiImprimir" runat="server" ToolTip="Imprimir" CommandName="Imprimir" AlternateText="Imprimir"/>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>--%>
                    </Columns>
