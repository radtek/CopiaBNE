    ...
    <asp:Panel CssClass="img_envelope_bne" runat="server" ID="pnlEnvelope">
        <asp:UpdatePanel ID="upCoin" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <asp:Image runat="server" class="coin-icon" ImageUrl="/img/modal_nova/3-candidaturas-coin.png" ID="imgCoin"
                        ...
                        <td style="float: right;">
                            <div class="cancelar">
                                ...
                                <asp:Button runat="server" ID="btnNaoAgora" CausesValidation="False" Visible="False"
                                    ...
                                    <a class="b-close">
                                        <asp:Button runat="server" ID="btnEntendi" OnClick="btnEntendi_Click" Visible="false" Text="OK, ENTENDI!" />
                                    </a>
                            </div>
                        </td>
