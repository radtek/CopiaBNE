                            ...
                            <div class="container_campo">
                                <div>
                                    <asp:RegularExpressionValidator ID="regexSite"
                                        ...
                                        CssClass="validador"
                                        ValidationGroup="SalvarDadosEmpresa"
                                        ValidationExpression="((http|https|ftp)\://|(www))(((25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])|([a-zA-Z0-9_\-\.])+\.(com|net|org|edu|int|mil|gov|arpa|biz|aero|name|inf|coop|info|pro|museum|senac|uk|me|ind|eng|srv))((:[a-zA-Z0-9]*)?/?([a-zA-Z0-9\-\._\?\,\'/\\\+&amp;%\$#\=~])*)">
                                    </asp:RegularExpressionValidator>
                                </div>
