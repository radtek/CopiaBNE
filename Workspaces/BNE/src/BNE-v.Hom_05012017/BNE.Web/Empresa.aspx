...
<body class="homePJ">
    ...
    <form id="form1" runat="server" class="conteudo">
        ...
        <section id="changeUser" class="mdl-grid mdl-grid--no-spacing" name="user">
            <div class="mdl-cell mdl-cell--2-col-phone mdl-cell--4-col-tablet mdl-cell--6-col right"><a href="/"><strong>Sou Candidato</strong></a>&nbsp;&nbsp;|</div>
            <div class="mdl-cell mdl-cell--2-col-phone mdl-cell--4-col-tablet mdl-cell--6-col left">&nbsp;&nbsp;<a href="/empresa"><strong> Sou Empresa</strong></a></div>
        </section>
        <!-- Header-->
            ...
            <div class="mdl-grid container">
                ...
                <div id="homeHeader-nav" class="mdl-cell mdl-cell--1-col-phone mdl-cell--5-col-tablet mdl-cell--9-col">
                    <ul>
                        ...
                        <li>
                            <a href="#Planos">Planos
                            </a>
                        </li>
                        <li>
                            <a href="#Vaga">Anunciar Vaga
                            </a>
                        </li>
                        <li>
                            <a href="#PesquisarCurriculo">Pesquisa Currículos
                            </a>
                        </li>
                        <li>
        ...
        <section id="homeCadastro" class="mdl-grid container" name="CriarConta">
            ...
            <div class="mdl-cell mdl-cell--hide-phone mdl-cell--1-col-tablet mdl-cell--hide-desktop"></div>
            <div class="mdl-cell mdl-cell--4-col-phone mdl-cell--6-col-tablet mdl-cell--3-col">
                <Componentes:ControlCNPJ runat="server" Obrigatorio="true" MensagemErroFormato="CNPJ Inválido" ValidationGroup="vlCadastroGratis" ID="txtCNPJ" />
            </div>
            <div class="mdl-cell mdl-cell--hide-phone mdl-cell--1-col-tablet mdl-cell--hide-desktop"></div>
        ...
        <section id="homeVideo" class="mdl-grid mdl-grid--no-spacing" name="homeVideo">
            ...
            <div class="mdl-cell mdl-cell--12-col">
                <iframe src="https://www.youtube.com/embed/lORLykO6rhU?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen id="BNEEmpresa"></iframe>
            </div>
        </section>
        <!-- Cadastro Vaga -->
        <section id="cadastroVaga" name="Vaga">
            <div class="mdl-grid container">
                ...
                <div class="mdl-cell mdl-cell--5-col mdl-cell--6-col-tablet">
                    ...
                    <asp:TextBox ID="txtFuncaoVaga" runat="server"></asp:TextBox>
                </div>
                <div class="mdl-cell mdl-cell--hide-phone mdl-cell--1-col-tablet mdl-cell--hide-desktop"></div>
                <div class="mdl-cell mdl-cell--hide-phone mdl-cell--1-col-tablet mdl-cell--hide-desktop"></div>
                <div class="mdl-cell mdl-cell--5-col mdl-cell--6-col-tablet">
                    ...
                    <asp:TextBox ID="txtCidadeVaga" runat="server"></asp:TextBox>
                </div>
                <div class="mdl-cell mdl-cell--1-col"></div>
                <div class="mdl-cell mdl-cell--1-col"></div>
                <div class="mdl-cell mdl-cell--5-col mdl-cell--6-col-tablet relative">
                    <componente:ValorDecimal ID="txtSalarioDe" Obrigatorio="false" CssClassTextBox="salario" CssClass="salario"
                        runat="server" CasasDecimais="2" ValidationGroup="SalvarVaga" />
                    ...
                    <div class="mdl-tooltip" for="tt1" style="left: 678.938px; margin-left: -93px; top: 294px;">
                ...
                <div class="mdl-cell mdl-cell--5-col mdl-cell--6-col-tablet relative">
                    ...
                    <asp:TextBox ID="txtEmailVaga" CssClass="textbox_padrao campo_obrigatorio" runat="server"></asp:TextBox>
                    <i class="material-icons intro" id="tt2" tabindex="0"></i>
                    <div class="mdl-tooltip" for="tt2" style="left: 1171.48px; margin-left: -93px; top: 294px;">
        ...
        <section id="homeFooter">
            <div class="mdl-grid container">
                <div id="homeFooter-info" class="mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                    ...
                    CNPJ 82.344.425/0001-82 | 0800 41 2400
                </div>
                <div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--8-col">
                    <ul>
                        <li>
                            <a href="#user" class="backtotop">Voltar para o topo <i class="material-icons">&#xE5C7;</i>
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#CriarConta" class="desktop-links">Criar Conta
                            </a>
                        </li>
                        <li>
                            <a href="#Depoimentos" class="desktop-links">Depoimentos
                            </a>
                        </li>
                        <li>
                            <a href="#Planos" class="desktop-links">Planos
                            </a>
                        </li>
                        <li>
                            <a href="#Vaga" class="desktop-links">Anunciar Vaga
                            </a>
                        </li>
                        <li>
                            <a href="#PesquisarCurriculo" class="desktop-links">Pesquisar Currículos
                            </a>
                        </li>
                        <li>
    ...
    <!-- Hotjar Tracking Code for www.bne.com.br -->
    <script>
        (function (f, b) {
            var c;
            f.hj = f.hj || function () { (f.hj.q = f.hj.q || []).push(arguments) };
            f._hjSettings = { hjid: 41413, hjsv: 4 };
