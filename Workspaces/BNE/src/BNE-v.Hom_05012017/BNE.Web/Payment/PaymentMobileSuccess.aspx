        ...
        <section id="mobile-payment-return" class="container-small ">
            ...
            <div id="payment-return" class="white">
                ...
                <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 payment-return-actions">
                    <asp:Button ID="btnVerVagas" runat="server" CssClass="btn btn-lg btn-info btn-block" OnClick="btnVerVagas_Click" Text="Ver vagas" />
                </div>
                <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 payment-return-actions">
                    <asp:Button ID="btnHome" runat="server" CssClass="btn btn-lg btn-block" OnClick="btnHome_Click" Text="Página inicial" />
                </div>
            </div>
