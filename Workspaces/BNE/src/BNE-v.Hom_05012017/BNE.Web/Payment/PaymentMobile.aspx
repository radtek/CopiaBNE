<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentMobile.aspx.cs" Inherits="BNE.Web.Payment.PaymentMobile" %>
                        ...
                        <ContentTemplate>
                            <h4>
                                <asp:Literal runat="server" ID="litNomeCliente"></asp:Literal>, você está adquirindo o <strong>
                                    <asp:Literal runat="server" ID="ltNomePlano"></asp:Literal></strong>.</h4>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                        ...
                        <asp:UpdatePanel ID="updCartaoDeCredito" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                            <ContentTemplate>
                                <div class="payment-method-type" data-toggle="collapse" href="#credito" data-parent="#accordion">
                                    ...
                                    <img id="visa" src="img/method-visa.png" />
                                    <img id="mastercard" src="img/method-mastercard.png" />
                                </div>
                                <div class="payment-method-desc row panel-collapse collapse" id="credito">
                                    <div class="col-xs-12 form-group" id="campo_cartao_credito">
                                        ...
                                        <asp:TextBox ID="txtNumeroCartao" runat="server" CssClass="form-control input-lg" placeholder="Número do Cartão" MaxLength="16" />
