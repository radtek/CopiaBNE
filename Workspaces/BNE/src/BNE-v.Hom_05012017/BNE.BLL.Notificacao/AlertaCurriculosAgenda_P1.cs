...
namespace BNE.BLL.Notificacao
{
    public partial class AlertaCurriculosAgenda // Tabela alerta.Tab_Alerta_Curriculos_Agenda_Semanal
    {
        ...
        #region Consultas
        private const string SPINSERT = "INSERT INTO alerta.Tab_Alerta_Curriculos_Agenda_Semanal (Idf_Curriculo, Idf_Dia_Da_Semana, Dta_Cadastro) VALUES (@Idf_Curriculo, @Idf_Dia_Da_Semana, @Dta_Cadastro);";
        private const string SPUPDATE = "UPDATE alerta.Tab_Alerta_Curriculos_Agenda_Semanal SET Idf_Curriculo=@Idf_curriculo, Idf_Dia_Da_Semana=@Idf_Dia_Da_Semana, Dta_Cadastro=@Dta_Cadastro WHERE Idf_Curriculo = @Idf_Curriculo AND Idf_Dia_Da_Semana=@Idf_Dia_Da_Semana";
        private const string SPDELETE = "DELETE FROM alerta.Tab_Alerta_Curriculos_Agenda_Semanal WHERE Idf_Curriculo = @Idf_Curriculo AND Idf_Dia_Da_Semana=@Idf_Dia_Da_Semana";
