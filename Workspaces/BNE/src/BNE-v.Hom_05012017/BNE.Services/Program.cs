            ...
            if (args.Length > 0)
            {
                ...
                switch (args[0])
                {
                    ...
                    case "BNE.Services.ControleParcelas":
                        ...
                        break;
                    case "BNE.Services.EmailsInvalidos":
                        servicesToRun = new ServiceBase[] { new EmailsInvalidos() };
                        break;
                    case "BNE.Services.AllInEmailSincronizacaoLista":
                        servicesToRun = new ServiceBase[] { new AllInEmailSincronizacaoLista() };
                        break;
                    ...
                    case "BNE.Services.EnvioSMSEmpresas":
                        ...
                        break;
                    case "BNE.Services.AllinEmailQuemMeViu":
                        servicesToRun = new ServiceBase[] { new AllinEmailQuemMeViu() };
                        break;
                    ...
                    case "BNE.Services.jornalPopup":
                        ...
                        break;
                    case "BNE.Service.BoletosRecorrentesAVencer":
