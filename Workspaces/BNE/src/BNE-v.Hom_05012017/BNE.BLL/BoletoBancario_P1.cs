...
namespace BNE.BLL
{
    public partial class BoletoBancario //BNE_BOLETO_BANCARIO
    {
        ...
        public static IDataReader LoadDataReader(string colunaOrdenacao, string direcaoOrdenacao, int paginaCorrente, int tamanhoPagina, out int totalRegistros)
        {
            ...
            string SPSELECTPAG = "SELECT ROW_NUMBER() OVER (ORDER BY " + colunaOrdenacao + " " + direcaoOrdenacao + ") AS RowID,BB.Idf_Boleto_Bancario, BB.Idf_Pagamento , BB.Idf_Banco , BB.Dta_Emissao , BB.Dta_Vencimento , BB.Cedente_Numero_CNPJCPF , BB.Cedente_Nome , BB.Cedente_Agencia , BB.Cedente_DV_Agencia , BB.Cedente_Numero_Conta , BB.Cedente_DVConta , BB.Cedente_Codigo , BB.Sacado_Numero_CNPJCPF , BB.Sacado_Nome , BB.Sacado_Endereco_Logradouro , BB.Sacado_Endereco_Numero , BB.Sacado_Endereco_Bairro , BB.Sacado_Endereco_Cidade , BB.Sacado_Endereco_CEP , BB.Instrucao_Descricao,BB.Num_Nosso_Numero, BB.Valor_Boleto, BB.Flag_Empresa FROM BNE_Boleto_Bancario BB";
