...
namespace BNE.BLL
{
    public partial class FuncaoPretendida // Tabela: BNE_Funcao_Pretendida
    {
        ...
        public static bool CarregarPorCurriculoFuncao(Curriculo objCurriculo, Funcao objFuncao, out FuncaoPretendida objFuncaoPretendida)
        {
            var parms = new List<SqlParameter>
                {
            ...
            using (IDataReader dr = DataAccessLayer.ExecuteReader(CommandType.Text, Spselectfuncaopretendidaporcurriculofuncao, parms))
            {
                objFuncaoPretendida = new FuncaoPretendida();
        ...
        /// <param name="objCurriculo"></param>
        public static void SalvarFuncaoPretendidaIntegracao(ExperienciaProfissional objExperienciaProfissional, Curriculo objCurriculo)
        {
            ...
            if (!CarregarPorCurriculoFuncao(objCurriculo, objExperienciaProfissional.Funcao, out objFuncaoPretendida))
            {
                objFuncaoPretendida = new FuncaoPretendida
                    {
            ...
            else //Ajustar a quantidade de experiencia
            {
                ...
                List<ExperienciaProfissional> listExperienciaPorFuncao = ExperienciaProfissional.ListarExperienciasProfissinaisPorFuncao(objExperienciaProfissional.PessoaFisica, objExperienciaProfissional.Funcao);
        ...
        public static void SalvarFuncaoPretendidaIntegracao(ExperienciaProfissional objExperienciaProfissional, Curriculo objCurriculo, out FuncaoPretendida objFuncaoPretendida)
        {
            int quantidadeExperiencia;
