...
namespace BNE.BLL
{
	public partial class VagaCandidato // Tabela: BNE_Vaga_Candidato
	{
		...
		#region Consultas
        private const string SPINSERT = "INSERT INTO BNE_Vaga_Candidato (Idf_Curriculo, Idf_Vaga, Dta_Cadastro, Flg_Inativo, Idf_Status_Curriculo_Vaga, Flg_Auto_Candidatura, Idf_Status_Candidatura, Idf_Origem_Candidatura, Dta_Visualizacao) VALUES (@Idf_Curriculo, @Idf_Vaga, GETDATE(), @Flg_Inativo, @Idf_Status_Curriculo_Vaga, @Flg_Auto_Candidatura, @Idf_Status_Candidatura, @Idf_Origem_Candidatura, @Dta_Visualizacao);SET @Idf_Vaga_Candidato = SCOPE_IDENTITY();";
        private const string SPUPDATE = "UPDATE BNE_Vaga_Candidato SET Idf_Curriculo = @Idf_Curriculo, Idf_Vaga = @Idf_Vaga, Flg_Inativo = @Flg_Inativo, Idf_Status_Curriculo_Vaga = @Idf_Status_Curriculo_Vaga, Flg_Auto_Candidatura = @Flg_Auto_Candidatura, Idf_Status_Candidatura = @Idf_Status_Candidatura, Idf_Origem_Candidatura = @Idf_Origem_Candidatura, Dta_Visualizacao = @Dta_Visualizacao WHERE Idf_Vaga_Candidato = @Idf_Vaga_Candidato";
