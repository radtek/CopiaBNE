...
namespace BNE.BLL
{
    public partial class PlanoAdquiridoContrato // Tabela: BNE_Plano_Adquirido_Contrato
    {
        ...
        /// <returns></returns>
        public static Enumeradores.TemplateContrato RetornaTemplateContrato(Plano plano)
        {
            if (plano.FlagBoletoRecorrente)
                return Enumeradores.TemplateContrato.TemplateBoletoRecorrente;

            if (plano.FlagRecorrente)
                return Enumeradores.TemplateContrato.TemplateCartaoRecorrente;

            return Enumeradores.TemplateContrato.TemplateGeral;
        }
                ...
                using (SqlTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        ...
                        try
                        {
                            ...
                            {
                                var contrato = GerarContratoPlano.ContratoPadraoPdf(objPlanoAdquirido.Contrato());
