...
//        public static Dictionary<string, string> BuscaCamposPalavraChave()
//        {
//            var dtnPalavraChave = new Dictionary<string, string>();

//            dtnPalavraChave.Add("Eml_Pessoa", "Email");
//            dtnPalavraChave.Add("Sig_Estado", "Estado");
//            dtnPalavraChave.Add("Des_Bairro", "Bairro");
//            dtnPalavraChave.Add("Des_Logradouro", "Logradouro");
//            // dtnPalavraChave.Add("Obs_Curriculo", "Observação");
//            dtnPalavraChave.Add("Raz_Social", "Razão social");
//            //  dtnPalavraChave.Add("Des_Funcao", "Função");
//            dtnPalavraChave.Add("Des_Atividade", "Atividade");
//            dtnPalavraChave.Add("Des_Curso", "Curso");
         
//            //  dtnPalavraChave.Add("Des_Conhecimento", "Conhecimento");
//            dtnPalavraChave.Add("Num_Telefone", "Telefone");
//            dtnPalavraChave.Add("Num_Celular", "Celular");
//            dtnPalavraChave.Add("Num_DDD_Telefone", "DDD Telefone");
//            dtnPalavraChave.Add("Num_DDD_Celular", "DDD Celular");
//            dtnPalavraChave.Add("Des_Funcao_Exercida", "Função exercida");
//            dtnPalavraChave.Add("Des_Fonte", "Instituição de ensino");


//            return dtnPalavraChave;
//        }
//    }
//}