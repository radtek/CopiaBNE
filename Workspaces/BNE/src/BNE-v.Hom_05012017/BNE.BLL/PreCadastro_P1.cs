...
namespace BNE.BLL
{
    public partial class PreCadastro
    {
        ...
        private const string SPDELETE = "UPDATE BNE.BNE_Pre_Cadastro SET flg_inativo = 1 WHERE Eml_Pessoa = @Eml_Pessoa and Nme_Pessoa = @Nme_Pessoa and idf_Origem_Pre_Cadastro = @idf_Origem";
       // private const string SPSELECTID = "SELECT * FROM plataforma.TAB_Motivo_Rescisao WITH(NOLOCK) WHERE Idf_Motivo_Rescisao = @Idf_Motivo_Rescisao";
        ...
        /// <remarks>Gieyson Stelmak</remarks>
        public static void Delete(String EmlPessoa, String NmePessoa, int idOrigem)
        {
            List<SqlParameter> parms = new List<SqlParameter>();
            parms.Add(new SqlParameter("@Eml_Pessoa", SqlDbType.VarChar, 100));
            parms.Add(new SqlParameter("@Nme_Pessoa", SqlDbType.VarChar, 100));
            ...
            parms[2].Value = idOrigem;

            DataAccessLayer.ExecuteNonQuery(CommandType.Text, SPDELETE, parms);

           // int idPreCadastro = RetornarIdPreCadastro(EmlPessoa, NmePessoa);
            //if(idPreCadastro>0)
               // BufferRemoverPopupAllin.Add(idPreCadastro);
        }
        /// <summary>
        ...
        //{
        //    using (IDataReader dr = LoadDataReader(this._idPreCadastro))
        //    {
        ...
        //{
        //    using (IDataReader dr = LoadDataReader(this._idPreCadastro, trans))
        //    {
        //        return SetInstance(dr, this);
        //    }
        //}
