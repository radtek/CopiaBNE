...
namespace BNE.BLL
{
	public partial class PesquisaCurriculoDeficiencia // Tabela: TAB_Pesquisa_Curriculo_Deficiencia
	{
		...
		#region Consultas
		private const string SPINSERT = "INSERT INTO TAB_Pesquisa_Curriculo_Deficiencia (Idf_Pesquisa_Curriculo, Idf_Deficiencia, Idf_Deficiencia_Detalhe) VALUES (@Idf_Pesquisa_Curriculo, @Idf_Deficiencia, @Idf_Deficiencia_Detalhe);SET @Idf_Pesquisa_Curriculo_Deficiencia = SCOPE_IDENTITY();";
		private const string SPUPDATE = "UPDATE TAB_Pesquisa_Curriculo_Deficiencia SET Idf_Pesquisa_Curriculo = @Idf_Pesquisa_Curriculo, Idf_Deficiencia = @Idf_Deficiencia, Idf_Deficiencia_Detalhe = @Idf_Deficiencia_Detalhe WHERE Idf_Pesquisa_Curriculo_Deficiencia = @Idf_Pesquisa_Curriculo_Deficiencia";
		...
		private void SetParameters(List<SqlParameter> parms)
		{
			...
			if (this._deficienciaDetalhe != null)
				parms[3].Value = this.DeficienciaDetalhe.IdfDeficienciaDetalhe;
			else
		...
		public static IDataReader LoadDataReader(string colunaOrdenacao, string direcaoOrdenacao, int paginaCorrente, int tamanhoPagina, out int totalRegistros)
		{
			...
			string SPSELECTPAG = "SELECT ROW_NUMBER() OVER (ORDER BY " + colunaOrdenacao + " " + direcaoOrdenacao + ") AS RowID, Pes.Idf_Pesquisa_Curriculo_Deficiencia, Pes.Idf_Pesquisa_Curriculo, Pes.Idf_Deficiencia, Pes.Idf_Deficiencia_Detalhe FROM TAB_Pesquisa_Curriculo_Deficiencia Pes";
			...
			try
			{
				if (dr.Read())
				{
					...
					if (dr["Idf_Deficiencia_Detalhe"] != DBNull.Value)
						objPesquisaCurriculoDeficiencia._deficienciaDetalhe = new DeficienciaDetalhe(Convert.ToInt32(dr["Idf_Deficiencia_Detalhe"]));
