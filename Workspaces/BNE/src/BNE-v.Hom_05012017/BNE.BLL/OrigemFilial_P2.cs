...
namespace BNE.BLL
{
    public partial class OrigemFilial // Tabela: TAB_Origem_Filial
    {
        ...
        private const string SPIDORIGEMPORFILIAL = @"
        SELECT  O.Idf_Origem 
        ...
        public static OrigemFilial CarregarPorOrigem(int idOrigem)
        {
            ...
            return null;
            //hrow (new RecordNotFoundException(typeof(OrigemFilial)));
        }
        #endregion
        ...
        #region RecuperarIdOrigemPorFilial
        public static int? RecuperarIdOrigemPorFilial(Filial objFilial)
        {
            var parms = new List<SqlParameter>
				{
            ...
            var res = DataAccessLayer.ExecuteScalar(CommandType.Text, SPIDORIGEMPORFILIAL, parms);
