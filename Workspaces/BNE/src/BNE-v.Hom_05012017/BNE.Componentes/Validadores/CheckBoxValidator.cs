    ...
    public class CheckBoxValidator : BaseValidator
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if (this.RenderUplevel && this.Page != null)
            {
                ...
                if (!this.Page.ClientScript.IsClientScriptIncludeRegistered(typeof(BNE.Componentes.Validadores.CheckBoxValidator), "skmValidators"))
                {
                    var script = this.Page.ClientScript.GetWebResourceUrl(typeof(BNE.Componentes.Validadores.CheckBoxValidator), "BNE.Componentes.Content.js.skmValidators.js");
