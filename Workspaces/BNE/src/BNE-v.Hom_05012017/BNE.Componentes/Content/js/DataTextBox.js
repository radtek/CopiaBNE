...
BNE.Componentes.DataTextBox = function(element) {
    BNE.Componentes.DataTextBox.initializeBase(this, [element]);
    ...
    this.get_TextBox = function() {
        ...
        this.configurarDias = function(date, instance) {
            ...
            if (instance._Feriados != null && instance._Feriados[ano] != null) {
                ...
                for (var i = 0; i < instance._Feriados[ano].length; i++) {
        ...
        this.initialize = function() {
            BNE.Componentes.DataTextBox.callBaseMethod(this, "initialize");
        ...
        this.NextFocus = function(time) {
            if (typeof (BNE_Componentes_AutoTabIndex_NextFocus) != "undefined") {
                if (time)
                    BNE_Componentes_AutoTabIndex_NextFocusTimeout(time);
                else
                    BNE_Componentes_AutoTabIndex_NextFocus();
            } else {
                var inst = this;
        ...
        this.assign = function(callback) {
            ...
            if (this._MostrarCalendario == true) {
                ...
                if (this._element.getAttribute("disabled") != "" && this._element.getAttribute("disabled") != null) {
        ...
        this.dispose = function() {
            ...
            BNE.Componentes.DataTextBox.callBaseMethod(this, "dispose");
        },
        ...
        this.get_OrdemMascara = function() {
            if (this._IndeceOrdem == null) {
                ...
                var ordem = [];
                ordem[0] = m.indexOf("d");
                ordem[1] = m.indexOf("MM");
                ordem[2] = m.indexOf("y");
                this._IndeceOrdem = {
                    Dia: (ordem[0] > ordem[1] && ordem[0] > ordem[2]) ? 2 : (ordem[0] > ordem[1] || ordem[0] > ordem[2]) ? 1 : 0,
                    Mes: (ordem[1] > ordem[0] && ordem[1] > ordem[2]) ? 2 : (ordem[1] > ordem[0] || ordem[1] > ordem[2]) ? 1 : 0,
                    Ano: (ordem[2] > ordem[0] && ordem[2] > ordem[1]) ? 2 : (ordem[2] > ordem[0] || ordem[2] > ordem[1]) ? 1 : 0
                };
            }
...
BNE.Componentes.DataTextBox.prototype = new BNE.Componentes.ControlBaseValidator;

BNE.Componentes.DataTextBox.prototype.GetData = function(sDate) {
...
BNE.Componentes.DataTextBox.prototype.DataFormatar = function(dtVal) {
    var m = this.get_Mascara();
...
BNE.Componentes.DataTextBox.prototype.BuscaDataAtual = function() {
    if (dtAtual == null) {
        dtAtualFormatada = DataTextBox.DataAtual(this.get_Cultura()).value;
        dtAtual = this.GetData(dtAtualFormatada);
    }
};
BNE.Componentes.DataTextBox.prototype.GetDataAtual = function() {
    this.BuscaDataAtual();
    return dtAtual;
};
BNE.Componentes.DataTextBox.prototype.GetDataAtualFormatada = function() {
    this.BuscaDataAtual();
    return dtAtualFormatada;
};
BNE.Componentes.DataTextBox.prototype.GetDataValue = function() {
    return this.GetData(this.get_TextBox().value);
};
BNE.Componentes.DataTextBox.prototype.FormatarData = function (sData) {
...
BNE.Componentes.DataTextBox.prototype.ValidarDataClient = function(sDate) {
    try {
        ...
        m = m.replace("MM", AjaxClientControlBase.padLeft(dtVal.getMonth() + 1, "0", 2));
        m = m.replace("yyyy", dtVal.getFullYear());
        //O javascript troca de mes caso passe os dia válidos de mes.
        return sDate == m;
    } catch (e) {
        return false;
    }
};
BNE.Componentes.DataTextBox.prototype.get_DataMinima = function() {
...
BNE.Componentes.DataTextBox.prototype.ValidarIntervaloMinimo = function() {
...
BNE.Componentes.DataTextBox.prototype.get_DataMaxima = function() {
...
BNE.Componentes.DataTextBox.prototype.ValidarIntervaloMaximo = function() {
    if (this.get_DataMaxima() == null)
        return true;
    var dt = this.get_DataMaxima();
    return this.GetDataValue() <= new Date(dt.getFullYear(), dt.getMonth(), dt.getDate(), 12, 0, 0, 0);
};
BNE.Componentes.DataTextBox.prototype.get_MensagemErroDataMinima = function() {
...
BNE.Componentes.DataTextBox.prototype.get_MensagemErroValorMinimo = function() {
    return this.get_MensagemErroDataMinima();
};
BNE.Componentes.DataTextBox.prototype.get_MensagemErroDataMaxima = function() {
...
BNE.Componentes.DataTextBox.prototype.get_MensagemErroValorMaximo = function() {
    return this.get_MensagemErroDataMaxima();
};
BNE.Componentes.DataTextBox.prototype.Validar = function(arg) {
...
BNE.Componentes.DataTextBox.prototype.MostrarErros = function() {
    this.get_TextBox().value = this.FormatarData(this.get_TextBox().value);
...
BNE.Componentes.DataTextBox.prototype.AtualizarFeriados = function(ano, inst) {
...
BNE.Componentes.DataTextBox.prototype.ValidarBlur = function() {
    var val = $get(this._id + "_cvValor");
    val.isvalid = this.MostrarErros();
    return true;
};
BNE.Componentes.DataTextBox.prototype.Blur = function() {
    this.get_TextBox().value = this.FormatarData(this.get_TextBox().value);
    this.PostPadrao();
    //Atualiza Feriados
    var anoTemp;
...
BNE.Componentes.DataTextBox.prototype.KeyPress = function(e) {
...
BNE.Componentes.DataTextBox.prototype.ValidarSeparador = function() {
...
BNE.Componentes.DataTextBox.prototype.ContarSeparadores = function() {
    var count = 0;
...
BNE.Componentes.DataTextBox.prototype.RemoverMascara = function() {
...
BNE.Componentes.DataTextBox.descriptor = {
    properties: [
...
BNE.Componentes.DataTextBox.registerClass("BNE.Componentes.DataTextBox", Sys.UI.Behavior);
BNE.Componentes.DataTextBox.ValidarTextBox = function(sender, args) {
