...
namespace BNE.Services.CLR
{
    public class StoredProcedures
    {
        private const string CaminhoPadraoQueue = "FormatName:Direct=OS:EMPVW0114202\\private$\\";
        ...
        public static void EnvioSMSQueue(SqlInt32 idMensagem, SqlString numeroDDD, SqlString numeroCelular, SqlString descricaoMensagem)
        {
            ...
            using (var conn = new SqlConnection("context connection=true"))
            {
                ...
                using (var cmd = new SqlCommand(@"INSERT INTO bne.TAB_Atividade (Idf_Plugins_Compatibilidade, Idf_Status_Atividade, Des_Parametros_Entrada, Dta_Cadastro, Dta_Agendamento, Flg_Inativo) VALUES (@Idf_Plugins_Compatibilidade, @Idf_Status_Atividade, @Des_Parametros_Entrada, @Dta_Cadastro, @Dta_Agendamento, 0);SET @Idf_Atividade = SCOPE_IDENTITY();", conn))
                {
        ...
        [SqlProcedure]
        public static void EnvioEmailQueue(SqlInt32 idMensagem, SqlString de, SqlString para, SqlString assunto, [SqlFacet(MaxSize = -1)] SqlString mensagem, SqlString tags)
        {
        ...
        #region EnvioEmailMailingQueue
        [SqlProcedure]
        public static void EnvioEmailMailingQueue(SqlInt32 idMensagem, SqlString de, SqlString para, SqlString assunto, [SqlFacet(MaxSize = -1)] SqlString mensagem, SqlString tags)
        {
        ...
        #region EnvioEmailQueueSMTP
        [SqlProcedure]
        public static void EnvioEmailQueueSMTP(SqlInt32 idMensagem)
        {
            const string queueName = "bne_envioemailsmtp";
            ...
            using (var conn = new SqlConnection("context connection=true"))
            {
                ...
                using (var cmd = new SqlCommand(@"INSERT INTO bne.TAB_Atividade (Idf_Plugins_Compatibilidade, Idf_Status_Atividade, Des_Parametros_Entrada, Dta_Cadastro, Dta_Agendamento, Flg_Inativo) VALUES (@Idf_Plugins_Compatibilidade, @Idf_Status_Atividade, @Des_Parametros_Entrada, @Dta_Cadastro, @Dta_Agendamento, 0);SET @Idf_Atividade = SCOPE_IDENTITY();", conn))
                {
                    ...
                    {
                        new SqlParameter{ ParameterName = "@Idf_Atividade", SqlDbType = SqlDbType.Int, Size = 4, Direction = ParameterDirection.Output},
                        new SqlParameter{ ParameterName = "@Idf_Plugins_Compatibilidade", SqlDbType = SqlDbType.Int, Size = 4, Value = 27},
                        new SqlParameter{ ParameterName = "@Idf_Status_Atividade", SqlDbType = SqlDbType.Int, Size = 4, Value = 1},
                        new SqlParameter{ ParameterName = "@Des_Parametros_Entrada", SqlDbType = SqlDbType.Xml, Value = parametros.ToXML()},
                        new SqlParameter{ ParameterName = "@Dta_Cadastro", SqlDbType = SqlDbType.DateTime, Size = 8, Value = DateTime.Now},
                        new SqlParameter{ ParameterName = "@Dta_Agendamento", SqlDbType = SqlDbType.DateTime, Size = 8, Value = DateTime.Now}
        ...
        #region EnvioEmailQueueSMTPCampanha
        [SqlProcedure]
        public static void EnvioEmailQueueSMTPCampanha(SqlInt32 idMensagem)
        {
            const string queueName = "bne_envioemailsmtpcloudcampanha";
            ...
            using (var conn = new SqlConnection("context connection=true"))
            {
                ...
                using (var cmd = new SqlCommand(@"INSERT INTO bne.TAB_Atividade (Idf_Plugins_Compatibilidade, Idf_Status_Atividade, Des_Parametros_Entrada, Dta_Cadastro, Dta_Agendamento, Flg_Inativo) VALUES (@Idf_Plugins_Compatibilidade, @Idf_Status_Atividade, @Des_Parametros_Entrada, @Dta_Cadastro, @Dta_Agendamento, 0);SET @Idf_Atividade = SCOPE_IDENTITY();", conn))
                {
                    ...
                    {
                        new SqlParameter{ ParameterName = "@Idf_Atividade", SqlDbType = SqlDbType.Int, Size = 4, Direction = ParameterDirection.Output},
                        new SqlParameter{ ParameterName = "@Idf_Plugins_Compatibilidade", SqlDbType = SqlDbType.Int, Size = 4, Value = 33},
                        new SqlParameter{ ParameterName = "@Idf_Status_Atividade", SqlDbType = SqlDbType.Int, Size = 4, Value = 1},
                        new SqlParameter{ ParameterName = "@Des_Parametros_Entrada", SqlDbType = SqlDbType.Xml, Value = parametros.ToXML()},
                        new SqlParameter{ ParameterName = "@Dta_Cadastro", SqlDbType = SqlDbType.DateTime, Size = 8, Value = DateTime.Now},
                        new SqlParameter{ ParameterName = "@Dta_Agendamento", SqlDbType = SqlDbType.DateTime, Size = 8, Value = DateTime.Now}
        ...
        #region EnvioEmailAmazonSES
        [SqlProcedure]
        public static void EnvioEmailAmazonSES(SqlInt32 idMensagem)
        {
            const string queueName = "bne_envioemailamazonses";
            ...
            using (var conn = new SqlConnection("context connection=true"))
            {
                ...
                using (var cmd = new SqlCommand(@"INSERT INTO bne.TAB_Atividade (Idf_Plugins_Compatibilidade, Idf_Status_Atividade, Des_Parametros_Entrada, Dta_Cadastro, Dta_Agendamento, Flg_Inativo) VALUES (@Idf_Plugins_Compatibilidade, @Idf_Status_Atividade, @Des_Parametros_Entrada, @Dta_Cadastro, @Dta_Agendamento, 0);SET @Idf_Atividade = SCOPE_IDENTITY();", conn))
                {
                    ...
                    {
                        new SqlParameter{ ParameterName = "@Idf_Atividade", SqlDbType = SqlDbType.Int, Size = 4, Direction = ParameterDirection.Output},
                        new SqlParameter{ ParameterName = "@Idf_Plugins_Compatibilidade", SqlDbType = SqlDbType.Int, Size = 4, Value = 34},
                        new SqlParameter{ ParameterName = "@Idf_Status_Atividade", SqlDbType = SqlDbType.Int, Size = 4, Value = 1},
                        new SqlParameter{ ParameterName = "@Des_Parametros_Entrada", SqlDbType = SqlDbType.Xml, Value = parametros.ToXML()},
                        new SqlParameter{ ParameterName = "@Dta_Cadastro", SqlDbType = SqlDbType.DateTime, Size = 8, Value = DateTime.Now},
                        new SqlParameter{ ParameterName = "@Dta_Agendamento", SqlDbType = SqlDbType.DateTime, Size = 8, Value = DateTime.Now}
                    ...
                    foreach (SqlParameter sqlParameter in parms)
                    {
                        if (cmd.Parameters.Contains(sqlParameter))
                            cmd.Parameters[sqlParameter.ParameterName] = sqlParameter;
                        else
