...
namespace BNE.Solr
{
    ...
    public class SolrHighlightResponse<T> : Solr //<T>
    {
        ...
        #region EfetuarRequisicao
        public static SolrHighlightResponse<T> EfetuarRequisicao(String url)
        {
            return Requisicao<SolrHighlightResponse<T>>(url);
        }
        #endregion
